...
goog.define = function(a, b) {
  ...
  if (!COMPILED) {
    ...
    d && void 0 === d.nodeType && Object.prototype.hasOwnProperty.call(d, a)
      ? (c = d[a])
      : e &&
        void 0 === e.nodeType &&
...
!COMPILED &&
  ...
  (goog.Es6ModuleDependency.prototype.load = function(a) {
    function b(a, b) {
      ...
      d.write(
        goog.TRUSTED_TYPES_POLICY_
          ? goog.TRUSTED_TYPES_POLICY_.createHTML(c)
          : c
      );
    }
    function c(a, b) {
...
goog.string.internal.compareVersions = function(a, b) {
  for (
    var c = 0,
      d = goog.string.internal.trim(String(a)).split("."),
      e = goog.string.internal.trim(String(b)).split("."),
    ...
    do {
      ...
      c =
        goog.string.internal.compareElements_(c, l) ||
        goog.string.internal.compareElements_(
          0 == h[2].length,
          0 == k[2].length
        ) ||
        goog.string.internal.compareElements_(h[2], k[2]);
      h = h[3];
      k = k[3];
    } while (0 == c);
  }
...
goog.html.TrustedResourceUrl.format = function(a, b) {
  ...
  var d = c.replace(goog.html.TrustedResourceUrl.FORMAT_MARKER_, function(
    a,
    d
  ) {
...
goog.html.SafeStyle.URL_RE_ = RegExp(
  "\\b(url\\([ \t\n]*)('[ -&(-\\[\\]-~]*'|\"[ !#-\\[\\]-~]*\"|[!#-&*-\\[\\]-~]*)([ \t\n]*\\))",
  "g"
);
goog.html.SafeStyle.FUNCTIONS_RE_ = RegExp(
...
goog.html.SafeHtml.createMetaRefresh = function(a, b) {
  ...
  (goog.labs.userAgent.browser.isIE() ||
    goog.labs.userAgent.browser.isEdge()) &&
    goog.string.internal.contains(c, ";") &&
    (c = "'" + c.replace(/'/g, "%27") + "'");
  return goog.html.SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse(
    "meta",
      ...
      goog.isArray(a)
        ...
        : ((a = goog.html.SafeHtml.htmlEscape(a)),
          ...
          d == goog.i18n.bidi.Dir.NEUTRAL
            ? (d = a)
            : a != goog.i18n.bidi.Dir.NEUTRAL && d != a && (d = null));
    };
  goog.array.forEach(b, f);
  return goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(
    e.join(goog.html.SafeHtml.unwrap(c)),
    d
  );
};
...
goog.dom.safe.setFormElementAction = function(a, b) {
  ...
  goog.dom.asserts.assertIsHTMLFormElement(
    a
  ).action = goog.html.SafeUrl.unwrapTrustedURL(c);
};
goog.dom.safe.setButtonFormAction = function(a, b) {
  ...
  goog.dom.asserts.assertIsHTMLButtonElement(
    a
  ).formAction = goog.html.SafeUrl.unwrapTrustedURL(c);
};
        ...
        (b =
          a.constructor && a.constructor instanceof Function
            ? 'Unknown Error of type "' +
              (a.constructor.name
                ? a.constructor.name
                : goog.debug.getFunctionName(a.constructor)) +
              '"'
  ...
  if (a instanceof Error) var c = a;
    ...
    (c = Error(a)),
      Error.captureStackTrace &&
        Error.captureStackTrace(c, goog.debug.enhanceError);
...
goog.events.BrowserEvent.prototype.init = function(a, b) {
  ...
  e
    ...
    ? (e = a.fromElement)
    : c == goog.events.EventType.MOUSEOUT && (e = a.toElement);
  ...
  d
    ...
    : (goog.events.USE_LAYER_XY_AS_OFFSET_XY
        ...
        : ((this.offsetX =
            goog.userAgent.WEBKIT || void 0 !== a.offsetX
              ? a.offsetX
              : a.layerX),
          (this.offsetY =
            goog.userAgent.WEBKIT || void 0 !== a.offsetY
              ? a.offsetY
              : a.layerY)),
...
goog.dom.safeHtmlToNode_ = function(a, b) {
  ...
  goog.dom.BrowserFeature.INNER_HTML_NEEDS_SCOPED_ELEMENT
    ? (goog.dom.safe.setInnerHtml(
      ...
      c.removeChild(goog.asserts.assert(c.firstChild)))
...
goog.style.getFramedPageOffset = function(a, b) {
  ...
  do {
    var f =
      d == b
        ? goog.style.getPageOffset(e)
        : goog.style.getClientPositionForElement_(goog.asserts.assert(e));
    c.x += f.x;
    c.y += f.y;
  } while (
    d &&
...
goog.style.installSafeStyleSheet = function(a, b) {
  ...
  if (goog.userAgent.IE && d.createStyleSheet)
    return (c = d.createStyleSheet()), goog.style.setSafeStyleSheet(c, a), c;
...
goog.style.getIePixelBorder_ = function(a, b) {
  ...
  return c in goog.style.ieBorderWidthKeywords_
    ? goog.style.ieBorderWidthKeywords_[c]
    : goog.style.getIePixelValue_(a, c, "left", "pixelLeft");
};
...
goog.ui.Component.prototype.render_ = function(a, b) {
  ...
  a
    ? a.insertBefore(this.element_, b || null)
...
goog.ui.Component.prototype.decorate = function(a) {
  ...
  if (a && this.canDecorate(a)) {
    ...
    var b = goog.dom.getOwnerDocument(a);
    (this.dom_ && this.dom_.getDocument() == b) ||
      (this.dom_ = goog.dom.getDomHelper(a));
    this.decorateInternal(a);
    (goog.ui.Component.ALLOW_DETACHED_DECORATION && !goog.dom.contains(b, a)) ||
      this.enterDocument();
...
goog.ui.Component.prototype.addChildAt = function(a, b, c) {
  ...
  a.inDocument_ && this.inDocument_ && a.getParent() == this
    ? ((c = this.getContentElement()),
      (b = c.childNodes[b] || null),
      b != a.getElement() && c.insertBefore(a.getElement(), b))
    : c
    ? (this.element_ || this.createDom(),
    ...
    : this.inDocument_ &&
      !a.inDocument_ &&
      a.element_ &&
      a.element_.parentNode &&
      a.element_.parentNode.nodeType == goog.dom.NodeType.ELEMENT &&
      a.enterDocument();
};
...
goog.ui.Component.prototype.getChild = function(a) {
  return this.childIndex_ && a
    ? goog.object.get(this.childIndex_, a) || null
    : null;
};
...
goog.a11y.aria.getStateBoolean = function(a, b) {
  var c = a.getAttribute(goog.a11y.aria.getAriaAttributeName_(b));
  goog.asserts.assert(
    goog.isBoolean(c) || null == c || "true" == c || "false" == c
  );
      ...
      : (a.type == goog.events.EventType.KEYPRESS
          ? (goog.events.KeyHandler.SAVE_ALT_FOR_KEYPRESS_ &&
            ...
            b.keyCode == b.charCode
              ? 32 > b.keyCode
                ? ((d = b.keyCode), (e = 0))
                : ((d = this.keyCode_), (e = b.charCode))
              : ((d = b.keyCode || this.keyCode_), (e = b.charCode || 0)))
          : ((d = b.keyCode || this.keyCode_), (e = b.charCode || 0)),
        goog.userAgent.MAC &&
...
goog.ui.registry.getDecoratorByClassName = function(a) {
  return a in goog.ui.registry.decoratorFunctions_
    ? goog.ui.registry.decoratorFunctions_[a]()
    : null;
};
...
goog.ui.ContainerRenderer.prototype.setStateFromClassName = function(a, b, c) {
  b == c + "-disabled"
    ...
    : b == c + "-vertical" &&
      a.setOrientation(goog.ui.Container.Orientation.VERTICAL);
};
  ...
  if (b) {
    ...
    for (var d; c && c.parentNode == b; ) {
      ...
      if (c.nodeType == goog.dom.NodeType.ELEMENT) {
        ...
        e &&
          (e.setElementInternal(c),
          a.isEnabled() || e.setEnabled(!1),
          a.addChild(e),
          e.decorate(c));
      } else
        (c.nodeValue && "" != goog.string.trim(c.nodeValue)) ||
          b.removeChild(c);
      c = d;
    }
  }
...
goog.ui.ControlRenderer.prototype.createDom = function(a) {
  return a
    .getDomHelper()
    .createDom("DIV", this.getClassNames(a).join(" "), a.getContent());
};
...
goog.ui.ControlRenderer.prototype.enableClassName = function(a, b, c) {
  if ((a = a.getElement ? a.getElement() : a)) {
    ...
    goog.userAgent.IE &&
      ...
      ((d = this.getAppliedCombinedClassNames_(goog.dom.classlist.get(a), b)),
      d.push(b));
...
goog.ui.ControlRenderer.prototype.decorate = function(a, b) {
  ...
  c && c.firstChild
    ? a.setContentInternal(
        c.firstChild.nextSibling ? goog.array.clone(c.childNodes) : c.firstChild
      )
    : a.setContentInternal(null);
  var d = 0,
    e = this.getCssClass(),
  ...
  goog.array.forEach(
    ...
    function(a) {
      g || a != e
        ? h || a != f
          ? (d |= this.getStateFromClass(a))
          : (h = !0)
        : ((g = !0), f == e && (h = !0));
      this.getStateFromClass(a) == goog.ui.Component.State.DISABLED &&
        (goog.asserts.assertElement(c),
        goog.dom.isFocusableTabIndex(c) &&
          goog.dom.setFocusableTabIndex(c, !1));
    },
    this
  );
...
goog.ui.ControlRenderer.prototype.setAriaStates = function(a, b) {
  ...
  a.isVisible() ||
    goog.a11y.aria.setState(b, goog.a11y.aria.State.HIDDEN, !a.isVisible());
  a.isEnabled() ||
    this.updateAriaState(b, goog.ui.Component.State.DISABLED, !a.isEnabled());
  a.isSupportedState(goog.ui.Component.State.SELECTED) &&
    this.updateAriaState(b, goog.ui.Component.State.SELECTED, a.isSelected());
  a.isSupportedState(goog.ui.Component.State.CHECKED) &&
    this.updateAriaState(b, goog.ui.Component.State.CHECKED, a.isChecked());
  a.isSupportedState(goog.ui.Component.State.OPENED) &&
    this.updateAriaState(b, goog.ui.Component.State.OPENED, a.isOpen());
};
...
goog.ui.ControlRenderer.prototype.isFocusable = function(a) {
  var b;
  return a.isSupportedState(goog.ui.Component.State.FOCUSED) &&
    (b = a.getKeyEventTarget())
    ? goog.dom.isFocusableTabIndex(b)
    : !1;
};
goog.ui.ControlRenderer.prototype.setFocusable = function(a, b) {
  var c;
  if (
    a.isSupportedState(goog.ui.Component.State.FOCUSED) &&
    (c = a.getKeyEventTarget())
  ) {
    if (!b && a.isFocused()) {
      try {
        c.blur();
...
goog.ui.ControlRenderer.prototype.updateAriaState = function(a, b, c) {
  ...
  (b = goog.ui.ControlRenderer.getAriaStateForAriaRole_(
    a,
    goog.ui.ControlRenderer.ariaAttributeMap_[b]
  ...
  if (c && (goog.dom.removeChildren(c), b))
    if (goog.isString(b)) goog.dom.setTextContent(c, b);
      ...
      goog.isArray(b)
        ...
        ? d(b)
        : goog.array.forEach(goog.array.clone(b), d);
    }
};
...
goog.ui.ControlRenderer.prototype.getClassNames = function(a) {
  ...
  goog.userAgent.IE &&
    !goog.userAgent.isVersionOrHigher("7") &&
    c.push.apply(c, this.getAppliedCombinedClassNames_(c));
  return c;
};
goog.ui.ControlRenderer.prototype.getAppliedCombinedClassNames_ = function(
  ...
  goog.array.forEach(this.getIe6ClassCombinations(), function(d) {
    !goog.array.every(d, goog.partial(goog.array.contains, a)) ||
      (b && !goog.array.contains(d, b)) ||
      c.push(d.join("_"));
  });
  return c;
};
...
goog.ui.ControlRenderer.prototype.createClassByStateMap_ = function() {
  ...
  goog.asserts.assert(
    b,
    "ControlRenderer has an invalid css class: '" + a + "'"
  );
...
goog.ui.Control.prototype.setHandleMouseEvents = function(a) {
  this.isInDocument() &&
    a != this.handleMouseEvents_ &&
    this.enableMouseEventHandling_(a);
...
goog.ui.Control.prototype.addClassName = function(a) {
  a &&
    (this.extraClassNames_
      ? goog.array.contains(this.extraClassNames_, a) ||
        this.extraClassNames_.push(a)
  ...
  if (
    ...
    if (a) {
      ...
      this.getHandler()
        ...
        .listen(a, goog.events.EventType.FOCUS, this.handleFocus)
...
goog.ui.Control.prototype.enableMouseEventHandling_ = function(a) {
  ...
  a
    ? (c
        .listen(d, b.MOUSEDOWN, this.handleMouseDown)
        .listen(d, [b.MOUSEUP, b.MOUSECANCEL], this.handleMouseUp)
        .listen(d, goog.events.EventType.MOUSEOVER, this.handleMouseOver)
        .listen(d, goog.events.EventType.MOUSEOUT, this.handleMouseOut),
      ...
      this.handleContextMenu != goog.nullFunction &&
        c.listen(d, goog.events.EventType.CONTEXTMENU, this.handleContextMenu),
      goog.userAgent.IE &&
        (goog.userAgent.isVersionOrHigher(9) ||
          c.listen(d, goog.events.EventType.DBLCLICK, this.handleDblClick),
        this.ieMouseEventSequenceSimulator_ ||
          ((this.ieMouseEventSequenceSimulator_ = new goog.ui.Control.IeMouseEventSequenceSimulator_(
            this
          )),
          this.registerDisposable(this.ieMouseEventSequenceSimulator_))))
    : (c
        .unlisten(d, b.MOUSEDOWN, this.handleMouseDown)
        .unlisten(d, [b.MOUSEUP, b.MOUSECANCEL], this.handleMouseUp)
        .unlisten(d, goog.events.EventType.MOUSEOVER, this.handleMouseOver)
        .unlisten(d, goog.events.EventType.MOUSEOUT, this.handleMouseOut),
      this.pointerEventsEnabled() &&
        c.unlisten(
          d,
          goog.events.EventType.GOTPOINTERCAPTURE,
      ...
      goog.userAgent.IE &&
        (goog.userAgent.isVersionOrHigher(9) ||
          c.unlisten(d, goog.events.EventType.DBLCLICK, this.handleDblClick),
...
goog.ui.Control.prototype.getCaption = function() {
  ...
  a = goog.isString(a)
    ? a
    : goog.isArray(a)
    ? goog.array.map(a, goog.dom.getRawTextContent).join("")
    : goog.dom.getTextContent(a);
...
goog.ui.Control.prototype.setVisible = function(a, b) {
  if (
    ...
    (this.visible_ != a &&
      this.dispatchEvent(
        a ? goog.ui.Component.EventType.SHOW : goog.ui.Component.EventType.HIDE
      ))
  ) {
...
goog.ui.Control.prototype.setEnabled = function(a) {
  !this.isParentDisabled_() &&
    this.isTransitionAllowed(goog.ui.Component.State.DISABLED, !a) &&
    (a || (this.setActive(!1), this.setHighlighted(!1)),
...
goog.ui.Control.prototype.setHighlighted = function(a) {
  this.isTransitionAllowed(goog.ui.Component.State.HOVER, a) &&
    this.setState(goog.ui.Component.State.HOVER, a);
};
goog.ui.Control.prototype.isActive = function() {
  return this.hasState(goog.ui.Component.State.ACTIVE);
};
goog.ui.Control.prototype.setActive = function(a) {
  this.isTransitionAllowed(goog.ui.Component.State.ACTIVE, a) &&
    this.setState(goog.ui.Component.State.ACTIVE, a);
};
goog.ui.Control.prototype.isSelected = function() {
  return this.hasState(goog.ui.Component.State.SELECTED);
};
goog.ui.Control.prototype.setSelected = function(a) {
  this.isTransitionAllowed(goog.ui.Component.State.SELECTED, a) &&
    this.setState(goog.ui.Component.State.SELECTED, a);
};
goog.ui.Control.prototype.isChecked = function() {
  return this.hasState(goog.ui.Component.State.CHECKED);
};
goog.ui.Control.prototype.setChecked = function(a) {
  this.isTransitionAllowed(goog.ui.Component.State.CHECKED, a) &&
    this.setState(goog.ui.Component.State.CHECKED, a);
};
goog.ui.Control.prototype.isFocused = function() {
  return this.hasState(goog.ui.Component.State.FOCUSED);
};
goog.ui.Control.prototype.setFocused = function(a) {
  this.isTransitionAllowed(goog.ui.Component.State.FOCUSED, a) &&
    this.setState(goog.ui.Component.State.FOCUSED, a);
};
goog.ui.Control.prototype.isOpen = function() {
  return this.hasState(goog.ui.Component.State.OPENED);
};
goog.ui.Control.prototype.setOpen = function(a) {
  this.isTransitionAllowed(goog.ui.Component.State.OPENED, a) &&
    this.setState(goog.ui.Component.State.OPENED, a);
};
...
goog.ui.Control.prototype.setState = function(a, b, c) {
  c || a != goog.ui.Component.State.DISABLED
    ? this.isSupportedState(a) &&
      b != this.hasState(a) &&
...
goog.ui.Control.prototype.setDispatchTransitionEvents = function(a, b) {
  this.statesWithTransitionEvents_ = b
...
goog.ui.Control.prototype.handleMouseOver = function(a) {
  !goog.ui.Control.isMouseEventWithinElement_(a, this.getElement()) &&
...
goog.ui.Control.prototype.handleKeyEvent = function(a) {
  return this.isVisible() && this.isEnabled() && this.handleKeyEventInternal(a)
    ? (a.preventDefault(), a.stopPropagation(), !0)
    : !1;
};
goog.ui.Control.prototype.handleKeyEventInternal = function(a) {
  return (
    a.keyCode == goog.events.KeyCodes.ENTER && this.performActionInternal(a)
  );
};
...
goog.ui.Control.IeMouseEventSequenceSimulator_ = function(a) {
  ...
  this.handler_
    .listen(a, goog.events.EventType.MOUSEDOWN, this.handleMouseDown_)
    .listen(a, goog.events.EventType.MOUSEUP, this.handleMouseUp_)
    .listen(a, goog.events.EventType.CLICK, this.handleClick_);
};
...
goog.ui.Control.IeMouseEventSequenceSimulator_.makeLeftMouseEvent_ = function(
  ...
  if (!goog.ui.Control.IeMouseEventSequenceSimulator_.SYNTHETIC_EVENTS_)
    return (
      (a.button = goog.events.BrowserEvent.MouseButton.LEFT), (a.type = b), a
    );
...
goog.ui.Control.IeMouseEventSequenceSimulator_.prototype.handleClick_ = function(
  a
) {
  if (this.clickExpected_) this.clickExpected_ = !1;
    ...
    var b = a.getBrowserEvent(),
      c = b.button,
      d = b.type,
      e = goog.ui.Control.IeMouseEventSequenceSimulator_.makeLeftMouseEvent_(
        b,
        goog.events.EventType.MOUSEDOWN
      );
    this.control_.handleMouseDown(
      new goog.events.BrowserEvent(e, a.currentTarget)
    );
    e = goog.ui.Control.IeMouseEventSequenceSimulator_.makeLeftMouseEvent_(
      b,
      goog.events.EventType.MOUSEUP
...
goog.ui.Container.prototype.enterDocument = function() {
  ...
  this.getHandler()
    ...
    .listen(a, b.MOUSEDOWN, this.handleMouseDown)
    .listen(
      goog.dom.getOwnerDocument(a),
      [b.MOUSEUP, b.MOUSECANCEL],
...
goog.ui.Container.prototype.enableFocusHandling_ = function(a) {
  ...
  a
    ? b
        .listen(c, goog.events.EventType.FOCUS, this.handleFocus)
        .listen(c, goog.events.EventType.BLUR, this.handleBlur)
        .listen(
          this.getKeyHandler(),
    ...
    : b
        .unlisten(c, goog.events.EventType.FOCUS, this.handleFocus)
        .unlisten(c, goog.events.EventType.BLUR, this.handleBlur)
        .unlisten(
          this.getKeyHandler(),
          goog.events.KeyHandler.EventType.KEY,
          this.handleKeyEvent
...
goog.ui.Container.prototype.handleHighlightItem = function(a) {
  ...
  if (-1 < b && b != this.highlightedIndex_) {
    ...
    this.openFollowsHighlight_ &&
      this.openItem_ &&
      c != this.openItem_ &&
      (c.isSupportedState(goog.ui.Component.State.OPENED)
        ? c.setOpen(!0)
        : this.openItem_.setOpen(!1));
  }
  b = this.getElement();
  goog.asserts.assert(b, "The DOM element for the container cannot be null.");
  null != a.target.getElement() &&
...
goog.ui.Container.prototype.handleCloseItem = function(a) {
  ...
  b &&
    a.target.isHighlighted() &&
    c &&
    goog.a11y.aria.setActiveDescendant(b, c);
};
...
goog.ui.Container.prototype.handleKeyEvent = function(a) {
  return this.isEnabled() &&
    this.isVisible() &&
    (0 != this.getChildCount() || this.keyEventTarget_) &&
    this.handleKeyEventInternal(a)
    ? (a.preventDefault(), a.stopPropagation(), !0)
    : !1;
};
goog.ui.Container.prototype.handleKeyEventInternal = function(a) {
  ...
  if (
    (b && "function" == typeof b.handleKeyEvent && b.handleKeyEvent(a)) ||
    (this.openItem_ &&
      this.openItem_ != b &&
      "function" == typeof this.openItem_.handleKeyEvent &&
      this.openItem_.handleKeyEvent(a))
  )
    return !0;
...
goog.ui.Container.prototype.addChildAt = function(a, b, c) {
  ...
  (!this.isFocusable() && this.isFocusableChildrenAllowed()) ||
...
goog.ui.Container.prototype.updateHighlightedIndex_ = function(a, b) {
  ...
  a == this.highlightedIndex_
    ? (this.highlightedIndex_ = Math.min(this.getChildCount() - 1, b))
    : a > this.highlightedIndex_ && b <= this.highlightedIndex_
    ? this.highlightedIndex_++
    : a < this.highlightedIndex_ &&
      b > this.highlightedIndex_ &&
      this.highlightedIndex_--;
};
goog.ui.Container.prototype.removeChild = function(a, b) {
  ...
  if (a) {
    ...
    -1 != c &&
      (c == this.highlightedIndex_
        ? (a.setHighlighted(!1), (this.highlightedIndex_ = -1))
        : c < this.highlightedIndex_ && this.highlightedIndex_--);
    (c = a.getElement()) &&
      c.id &&
      this.childElementIdMap_ &&
      goog.object.remove(this.childElementIdMap_, c.id);
  }
...
goog.ui.Container.prototype.setVisible = function(a, b) {
  if (
    ...
    var c = this.getElement();
    c &&
      (goog.style.setElementShown(c, a),
      this.isFocusable() &&
...
goog.ui.Container.prototype.setFocusable = function(a) {
  ...
  this.enabled_ &&
    this.visible_ &&
    this.renderer_.enableTabIndex(this.getKeyEventTarget(), a);
};
...
goog.ui.Container.prototype.canHighlightItem = function(a) {
  return (
    a.isVisible() &&
    a.isEnabled() &&
    a.isSupportedState(goog.ui.Component.State.HOVER)
  );
};
...
goog.ui.MenuHeader = function(a, b, c) {
  goog.ui.Control.call(
    this,
    a,
    c || goog.ui.MenuHeaderRenderer.getInstance(),
    b
  );
...
goog.ui.MenuItemRenderer.prototype.createDom = function(a) {
  var b = a
    ...
    .createDom(
      "DIV",
      this.getClassNames(a).join(" "),
      this.createContent(a.getContent(), a.getDomHelper())
    );
...
goog.ui.MenuItemRenderer.prototype.decorate = function(a, b) {
  goog.asserts.assert(b);
  this.hasContentStructure(b) ||
    b.appendChild(this.createContent(b.childNodes, a.getDomHelper()));
  goog.dom.classlist.contains(b, "goog-option") &&
    (a.setCheckable(!0), this.setCheckable(a, b, !0));
...
goog.ui.MenuItemRenderer.prototype.hasContentStructure = function(a) {
  ...
  var b = this.getCompositeCssClass_(
...
goog.ui.MenuItemRenderer.prototype.createContent = function(a, b) {
  var c = this.getCompositeCssClass_(
    goog.ui.MenuItemRenderer.CompositeCssClassIndex_.CONTENT
  );
...
goog.ui.MenuItemRenderer.prototype.setEnableCheckBoxStructure = function(
  ...
  c != this.hasCheckBoxStructure(b) &&
    (goog.dom.classlist.enable(b, "goog-option", c),
    (b = this.getContentElement(b)),
    c
      ? ((c = this.getCompositeCssClass_(
          goog.ui.MenuItemRenderer.CompositeCssClassIndex_.CHECKBOX
        )),
        b.insertBefore(
          a.getDomHelper().createDom("DIV", c),
          b.firstChild || null
        ))
...
goog.ui.MenuItem.prototype.getCaption = function() {
  ...
  if (goog.isArray(a)) {
    ...
    a = goog.array
      .map(a, function(a) {
        return goog.dom.isElement(a) &&
          (goog.dom.classlist.contains(a, b) ||
            goog.dom.classlist.contains(a, c))
          ? ""
          : goog.dom.getRawTextContent(a);
      })
      .join("");
    return goog.string.collapseBreakingSpaces(a);
  }
...
goog.ui.MenuItem.prototype.getAccelerator = function() {
  var a = this.getDomHelper(),
    b = this.getContent();
  return goog.isArray(b) &&
    (b = goog.array.find(b, function(a) {
...
goog.ui.MenuItem.prototype.handleMouseUp = function(a) {
  ...
  if (b) {
    ...
    if (
      c &&
      goog.isNumber(a.clientX) &&
      ((b = new goog.math.Coordinate(a.clientX, a.clientY)),
...
goog.ui.MenuItem.prototype.handleKeyEventInternal = function(a) {
  return a.keyCode == this.getMnemonic() && this.performActionInternal(a)
    ? !0
    : goog.ui.MenuItem.superClass_.handleKeyEventInternal.call(this, a);
};
...
goog.ui.MenuItem.prototype.getPreferredAriaRole = function() {
  return this.isSupportedState(goog.ui.Component.State.CHECKED)
    ? goog.a11y.aria.Role.MENU_ITEM_CHECKBOX
    : this.isSupportedState(goog.ui.Component.State.SELECTED)
    ? goog.a11y.aria.Role.MENU_ITEM_RADIO
    : goog.ui.MenuItem.superClass_.getPreferredAriaRole.call(this);
};
...
goog.ui.Separator = function(a, b) {
  goog.ui.Control.call(
    this,
    null,
    a || goog.ui.MenuSeparatorRenderer.getInstance(),
    b
  );
  this.setSupportedState(goog.ui.Component.State.DISABLED, !1);
  this.setSupportedState(goog.ui.Component.State.HOVER, !1);
...
goog.ui.MenuRenderer.prototype.getDecoratorForChild = function(a) {
  return "HR" == a.tagName
    ...
    : goog.ui.MenuRenderer.superClass_.getDecoratorForChild.call(this, a);
};
...
goog.ui.Menu = function(a, b) {
  goog.ui.Container.call(
    ...
    b || goog.ui.MenuRenderer.getInstance(),
    a
  );
  this.setFocusable(!1);
};
...
goog.ui.Menu.prototype.setVisible = function(a, b, c) {
  (b = goog.ui.Menu.superClass_.setVisible.call(this, a, b)) &&
    a &&
    this.isInDocument() &&
    this.allowAutoFocus_ &&
    this.getKeyEventTarget().focus();
  a && c && goog.isNumber(c.clientX)
    ? (this.openingCoords = new goog.math.Coordinate(c.clientX, c.clientY))
...
goog.ui.Menu.prototype.canHighlightItem = function(a) {
  return (
    (this.allowHighlightDisabled_ || a.isEnabled()) &&
    a.isVisible() &&
    a.isSupportedState(goog.ui.Component.State.HOVER)
  );
};
...
goog.ui.Menu.prototype.handleKeyEventInternal = function(a) {
  ...
  b ||
    this.forEachChild(function(c) {
      !b &&
        c.getMnemonic &&
        c.getMnemonic() == a.keyCode &&
        (this.isEnabled() && this.setHighlighted(c), (b = c.handleKeyEvent(a)));
    }, this);
  return b;
};
goog.ui.Menu.prototype.setHighlightedIndex = function(a) {
  ...
  (a = this.getChildAt(a)) &&
    goog.style.scrollIntoContainerView(a.getElement(), this.getElement());
};
goog.ui.Menu.prototype.decorateContent = function(a) {
  var b = this.getRenderer();
  a = this.getDomHelper().getElementsByTagNameAndClass(
    "DIV",
    b.getCssClass() + "-content",
    a
  );
...
goog.ui.tree.BaseNode.prototype.initAccessibility = function() {
  ...
  if (a) {
    ...
    (b = this.getExpandIconElement()) &&
      goog.a11y.aria.setRole(b, "presentation");
    if ((b = this.getChildrenElement()))
      if ((goog.a11y.aria.setRole(b, "group"), b.hasChildNodes()))
        for (
          goog.a11y.aria.setState(a, goog.a11y.aria.State.EXPANDED, !1),
  ...
  if ((b = this.getElement()))
    if (
      ...
      d ||
        (c
          ? c.updateExpandIcon()
          : (goog.style.setElementShown(b, !0),
...
goog.ui.tree.BaseNode.prototype.removeChild = function(a, b) {
  ...
  if (d == a || a.contains(d))
    c.hasFocus()
      ? (this.select(), goog.Timer.callOnce(this.onTimeoutSelect_, 10, this))
      : this.select();
  ...
  if (c && (c.removeNode(a), this.isInDocument())) {
    ...
    this.hasChildren() ||
      ...
      this.updateIcon_(),
      (d = this.getElement()) &&
        goog.a11y.aria.removeState(d, goog.a11y.aria.State.EXPANDED));
  }
  return a;
};
...
goog.ui.tree.BaseNode.prototype.setSelectedInternal = function(a) {
  if (this.selected_ != a) {
    ...
    var b = this.getElement();
    b &&
      (goog.a11y.aria.setState(b, "selected", a),
      a &&
        ((a = this.getTree().getElement()),
...
goog.ui.tree.BaseNode.prototype.toSafeHtml = function() {
  var a = this.getTree(),
    b =
      !a.getShowLines() || (a == this.getParent() && !a.getShowRootLines())
        ? this.config_.cssChildrenNoLines
        : this.config_.cssChildren;
  a = this.getExpanded() && this.hasChildren();
  b = { class: b, style: this.getLineStyle() };
  var c = [];
  a &&
    this.forEachChild(function(a) {
      c.push(a.toSafeHtml());
...
goog.ui.tree.BaseNode.prototype.getRowSafeHtml = function() {
  var a = {};
  a["padding-" + (this.isRightToLeft() ? "right" : "left")] =
...
goog.ui.tree.BaseNode.prototype.getLabelSafeHtml = function() {
  var a = goog.html.SafeHtml.create(
    "span",
...
goog.ui.tree.BaseNode.prototype.getExpandIconClass = function() {
  ...
  if (this.hasChildren()) {
    var e = 0;
    a.getShowExpandIcons() &&
      this.isUserCollapsible_ &&
      (e = this.getExpanded() ? 2 : 1);
...
goog.ui.tree.BaseNode.prototype.getElement = function() {
  ...
  a ||
    ((a = this.getDomHelper().getElement(this.getId())),
    this.setElementInternal(a));
  return a;
};
...
goog.ui.tree.BaseNode.prototype.onMouseDown = function(a) {
  "expand" == a.target.getAttribute("type") && this.hasChildren()
...
goog.structs.Trie.prototype.remove = function(a) {
  ...
  for (delete b.value_; 0 < c.length; )
    if (((e = c.pop()), (b = e[0]), (e = e[1]), b.childNodes_[e].isEmpty()))
...
goog.ui.tree.TypeAhead.prototype.handleNavigation = function(a) {
  ...
  switch (a.keyCode) {
    ...
    case goog.events.KeyCodes.UP:
      a.ctrlKey &&
        (this.jumpTo_(
          a.keyCode == goog.events.KeyCodes.DOWN
    ...
    case goog.events.KeyCodes.BACKSPACE:
      ...
      b = !0;
      0 < a
        ? ((this.buffer_ = this.buffer_.substring(0, a)),
...
goog.ui.tree.TypeAhead.prototype.handleTypeAheadChar = function(a) {
  ...
  a.ctrlKey ||
    a.altKey ||
    ((a = String.fromCharCode(a.charCode || a.keyCode).toLowerCase()),
    goog.string.isUnicodeChar(a) &&
      (" " != a || this.buffer_) &&
      ((this.buffer_ += a), (b = this.jumpToLabel_(this.buffer_))));
  return b;
};
...
goog.ui.tree.TypeAhead.prototype.jumpToLabel_ = function(a) {
  var b = !1;
  (a = this.nodeMap_.getKeys(a)) &&
    a.length &&
    ((this.matchingLabelIndex_ = this.matchingNodeIndex_ = 0),
    (b = this.nodeMap_.get(a[0])),
    (b = this.selectMatchingNode_(b))) &&
    (this.matchingLabels_ = a);
  return b;
};
goog.ui.tree.TypeAhead.prototype.jumpTo_ = function(a) {
  ...
  if (c) {
    ...
    if (this.matchingNodes_) {
      ...
      0 <= e && e < this.matchingNodes_.length
        ? ((this.matchingNodeIndex_ = e), (b = this.matchingNodes_))
        : (d = !0);
    }
    b ||
      ((e = this.matchingLabelIndex_ + a),
      0 <= e && e < c.length && (this.matchingLabelIndex_ = e),
      c.length > this.matchingLabelIndex_ &&
        (b = this.nodeMap_.get(c[this.matchingLabelIndex_])),
      b &&
        b.length &&
        d &&
        (this.matchingNodeIndex_ =
          a == goog.ui.tree.TypeAhead.Offset.UP ? b.length - 1 : 0));
...
goog.ui.tree.TreeControl.prototype.setExpanded = function(a) {
  this.showRootNode_
    ? goog.ui.tree.TreeControl.superClass_.setExpanded.call(this, a)
...
goog.ui.tree.TreeControl.prototype.getRowClassName = function() {
  return (
    goog.ui.tree.TreeControl.superClass_.getRowClassName.call(this) +
...
goog.ui.tree.TreeControl.prototype.getCalculatedIconClass = function() {
  ...
  if (!a && b) return b;
  b = this.getConfig();
  return a && b.cssExpandedRootIcon
    ? b.cssTreeIcon + " " + b.cssExpandedRootIcon
    : !a && b.cssCollapsedRootIcon
    ? b.cssTreeIcon + " " + b.cssCollapsedRootIcon
    : "";
};
goog.ui.tree.TreeControl.prototype.setSelectedItem = function(a) {
  if (this.selectedItem_ != a) {
    var b = !1;
    this.selectedItem_ &&
      ((b = this.selectedItem_ == this.focusedNode_),
...
goog.ui.tree.TreeControl.prototype.updateLinesAndExpandIcons_ = function() {
  function a(e) {
    ...
    if (f) {
      var g =
        !c || (b == e.getParent() && !d)
          ? e.getConfig().cssChildrenNoLines
          : e.getConfig().cssChildren;
      f.className = g;
...
goog.ui.tree.TreeControl.prototype.handleKeyEvent = function(a) {
  var b;
  (b =
    this.typeAhead_.handleNavigation(a) ||
    (this.selectedItem_ && this.selectedItem_.onKeyDown(a)) ||
    this.typeAhead_.handleTypeAheadChar(a)) && a.preventDefault();
  return b;
};
...
goog.getMsg.blocklyMsgMap = { Today: "TODAY" };
Blockly.utils = {};
...
Blockly.utils.string.commonWordPrefix = function(a, b) {
  ...
  for (
    var c = 0, d = b || Blockly.utils.string.shortestStringLength(a), e = 0;
    e < d;
    e++
  ) {
...
Blockly.utils.string.wrap = function(a, b) {
  for (var c = a.split("\n"), d = 0; d < c.length; d++)
    c[d] = Blockly.utils.string.wrapLine_(c[d], b);
  return c.join("\n");
};
...
Blockly.utils.string.wrapScore_ = function(a, b, c) {
  for (var d = [0], e = [], f = 0; f < a.length; f++)
    (d[d.length - 1] += a[f].length),
      !0 === b[f]
        ? (d.push(0), e.push(a[f].charAt(a[f].length - 1)))
        : !1 === b[f] && d[d.length - 1]++;
  ...
  for (f = b = 0; f < d.length; f++)
    (b -= 2 * Math.pow(Math.abs(c - d[f]), 1.5)),
      ...
      -1 != ".?!".indexOf(e[f])
        ? (b += c / 3)
        : -1 != ",;)]}".indexOf(e[f]) && (b += c / 4);
  1 < d.length && d[d.length - 1] <= d[d.length - 2] && (b += 0.5);
  return b;
};
Blockly.utils.string.wrapMutate_ = function(a, b, c) {
  for (
    var d = Blockly.utils.string.wrapScore_(a, b, c), e, f = 0;
    f < b.length - 1;
    f++
  )
    if (b[f] != b[f + 1]) {
...
(function(a) {
  ...
  Blockly.utils.userAgent.TABLET =
    Blockly.utils.userAgent.IPAD ||
    (Blockly.utils.userAgent.ANDROID && !b("Mobile")) ||
    b("Silk");
...
Blockly.utils.getRelativeXY = function(a) {
  ...
  if (
    (c =
      ...
      c.match(Blockly.utils.getRelativeXY.XY_REGEX_))
  )
    (b.x += parseFloat(c[1])), c[3] && (b.y += parseFloat(c[3]));
  (a = a.getAttribute("style")) &&
    -1 < a.indexOf("translate") &&
    (a = a.match(Blockly.utils.getRelativeXY.XY_STYLE_REGEX_)) &&
    ((b.x += parseFloat(a[1])), a[3] && (b.y += parseFloat(a[3])));
  return b;
};
...
Blockly.utils.checkMessageReferences = function(a) {
  for (
    var b = !0, c = Blockly.Msg, d = a.match(/%{BKY_[A-Z]\w*}/gi), e = 0;
    e < d.length;
    e++
  ) {
    var f = d[e].toUpperCase();
    void 0 == c[f.slice(6, -1)] &&
...
Blockly.utils.tokenizeInterpolation_ = function(a, b) {
  ...
  for (var e = 0, f = [], g = null, h = 0; h < d.length; h++) {
    ...
    0 == e
      ? "%" == k
        ? ((k = f.join("")) && c.push(k), (f.length = 0), (e = 1))
        : f.push(k)
      : 1 == e
      ? "%" == k
        ? (f.push(k), (e = 0))
        : b && "0" <= k && "9" >= k
        ? ((e = 2), (g = k), (k = f.join("")) && c.push(k), (f.length = 0))
        : "{" == k
        ? (e = 3)
        : (f.push("%", k), (e = 0))
      : 2 == e
      ...
      : 3 == e &&
        ("" == k
          ...
          : ((e = f.join("")),
            /[A-Z]\w*/i.test(e)
              ? ((k = e.toUpperCase()),
                (k = Blockly.utils.string.startsWith(k, "BKY_")
                  ? k.substring(4)
                  : null) && k in Blockly.Msg
                  ? ((e = Blockly.Msg[k]),
                    "string" == typeof e
                      ? Array.prototype.push.apply(
                          c,
                          Blockly.utils.tokenizeInterpolation_(e, b)
                        )
                      : b
                      ? c.push(String(e))
                      : c.push(e))
  ...
  (k = f.join("")) && c.push(k);
  d = [];
  for (h = f.length = 0; h < c.length; ++h)
    "string" == typeof c[h]
      ? f.push(c[h])
      : ((k = f.join("")) && d.push(k), (f.length = 0), d.push(c[h]));
  (k = f.join("")) && d.push(k);
  f.length = 0;
  return d;
};
...
Blockly.utils.getDocumentScroll = function() {
  var a = document.documentElement,
    b = window;
  return Blockly.utils.userAgent.IE && b.pageYOffset != a.scrollTop
    ? new Blockly.utils.Coordinate(a.scrollLeft, a.scrollTop)
...
Blockly.Touch.shouldHandleEvent = function(a) {
  return (
    !Blockly.Touch.isMouseOrTouchEvent(a) ||
    Blockly.Touch.checkTouchIdentifier(a)
  );
};
...
Blockly.Touch.checkTouchIdentifier = function(a) {
  ...
  return void 0 !== Blockly.Touch.touchIdentifier_ &&
    ...
    ? Blockly.Touch.touchIdentifier_ == b
    : "mousedown" == a.type || "touchstart" == a.type || "pointerdown" == a.type
    ? ((Blockly.Touch.touchIdentifier_ = b), !0)
    : !1;
};
...
Blockly.Touch.isMouseOrTouchEvent = function(a) {
  return (
    Blockly.utils.string.startsWith(a.type, "touch") ||
    Blockly.utils.string.startsWith(a.type, "mouse") ||
    Blockly.utils.string.startsWith(a.type, "pointer")
  );
};
...
Blockly.Events.fireNow_ = function() {
  for (
    var a = Blockly.Events.filter(Blockly.Events.FIRE_QUEUE_, !0),
      b = (Blockly.Events.FIRE_QUEUE_.length = 0),
      c;
    (c = a[b]);
    b++
  ) {
  ...
  for (var d = [], e = Object.create(null), f = 0, g; (g = c[f]); f++)
    if (!g.isNull()) {
      var h = [g.type, g.blockId, g.workspaceId].join(" "),
        k = e[h],
        l = k ? k.event : null;
      if (!k) (e[h] = { event: g, index: f }), d.push(g);
      else if (g.type == Blockly.Events.MOVE && k.index == f - 1)
        (l.newParentId = g.newParentId),
          (l.newInputName = g.newInputName),
          (l.newCoordinate = g.newCoordinate),
          (k.index = f);
      else if (
        ...
        l.newValue = g.newValue;
      else if (
        g.type != Blockly.Events.UI ||
        "click" != g.element ||
        ("commentOpen" != l.element &&
          "mutatorOpen" != l.element &&
          "warningOpen" != l.element)
      )
        (e[h] = { event: g, index: 1 }), d.push(g);
    }
...
Blockly.Events.setGroup = function(a) {
  Blockly.Events.group_ =
    "boolean" == typeof a ? (a ? Blockly.utils.genUid() : "") : a;
};
  ...
  if (a.type == Blockly.Events.MOVE || a.type == Blockly.Events.CREATE) {
    ...
    if ((a = b.getBlockById(a.blockId))) {
      ...
      if (c && c.isEnabled())
        ...
        (a.outputConnection || a.previousConnection) &&
        !b.isDragging()
      ) {
        do a.setEnabled(!1), (a = a.getNextBlock());
        while (a);
      }
    }
  }
...
Blockly.Events.VarCreate.prototype.run = function(a) {
  ...
  a
    ? b.createVariable(this.varName, this.varType, this.varId)
    : b.deleteVariableById(this.varId);
};
...
Blockly.Events.VarRename.prototype.run = function(a) {
  var b = this.getEventWorkspace_();
  a
    ? b.renameVariableById(this.varId, this.newName)
...
Blockly.VariableMap.prototype.renameVariable = function(a, b) {
  ...
  try {
    c && c.getId() != a.getId()
      ? this.renameVariableWithConflict_(a, b, c, d)
      : this.renameVariableAndUses_(a, b, d);
  } finally {
...
Blockly.VariableMap.prototype.deleteVariableById = function(a) {
  ...
  if (b) {
    ...
    for (var e; (e = d[a]); a++)
      if (
        "procedures_defnoreturn" == e.type ||
        "procedures_defreturn" == e.type
      ) {
        a = e.getFieldValue("NAME");
        c = Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE.replace(
          "%1",
          c
        ).replace("%2", a);
        Blockly.alert(c);
    ...
    var f = this;
    1 < d.length
      ? ((c = Blockly.Msg.DELETE_VARIABLE_CONFIRMATION.replace(
          "%1",
          String(d.length)
        ).replace("%2", c)),
        Blockly.confirm(c, function(a) {
...
Blockly.VariableMap.prototype.getVariableTypes = function(a) {
  var b = [];
  a &&
    a.getPotentialVariableMap() &&
    (b = Object.keys(a.getPotentialVariableMap().variableMap_));
...
Blockly.VariableMap.prototype.getVariableUsesById = function(a) {
  for (
    var b = [], c = this.workspace.getAllBlocks(!1), d = 0;
    d < c.length;
    d++
  ) {
...
Blockly.Events.Change.prototype.run = function(a) {
  ...
  if (b)
    switch (
      (b.mutator && b.mutator.setVisible(!1),
      (a = a ? this.newValue : this.oldValue),
      this.element)
    ) {
      case "field":
        (b = b.getField(this.name))
          ? (b.callValidator(a), b.setValue(a))
      ...
      case "mutation":
        var c = "";
        b.mutationToDom &&
          (c = (c = b.mutationToDom()) && Blockly.Xml.domToText(c));
        if (b.domToMutation) {
          var d = Blockly.Xml.textToDom(a || "<mutation/>");
          b.domToMutation(d);
        }
        Blockly.Events.fire(
          new Blockly.Events.Change(b, "mutation", null, c, a)
        );
        break;
      default:
...
Blockly.Events.Create = function(a) {
  a &&
    ...
    (this.xml = a.workspace.rendered
      ? Blockly.Xml.blockToDomWithXY(a)
      : Blockly.Xml.blockToDom(a)),
...
Blockly.Events.Delete = function(a) {
  if (a) {
    ...
    this.oldXml = a.workspace.rendered
      ? Blockly.Xml.blockToDomWithXY(a)
      : Blockly.Xml.blockToDom(a);
    this.ids = Blockly.Events.getDescendantIds_(a);
  }
...
Blockly.Events.Move.prototype.currentLocation_ = function() {
  var a = Blockly.Workspace.getById(this.workspaceId).getBlockById(
      this.blockId
    ),
    b = {},
    c = a.getParent();
  if (c) {
    if (((b.parentId = c.id), (a = c.getInputWithBlock(a))))
      b.inputName = a.name;
...
Blockly.Xml.variablesToDom = function(a) {
  for (
    var b = Blockly.utils.xml.createElement("variables"), c = 0, d;
    (d = a[c]);
    c++
  ) {
...
Blockly.Xml.blockToDom = function(a, b) {
  ...
  e &&
    ((d = Blockly.utils.xml.createElement("comment")),
    d.appendChild(Blockly.utils.xml.createTextNode(e)),
    "object" == typeof a.comment &&
    ...
    c.appendChild(d));
  a.data &&
    ((d = Blockly.utils.xml.createElement("data")),
  ...
  for (var f; (f = a.inputList[e]); e++) {
    ...
    if (f.type != Blockly.DUMMY_INPUT) {
      ...
      f.type == Blockly.INPUT_VALUE
        ? (g = Blockly.utils.xml.createElement("value"))
        : f.type == Blockly.NEXT_STATEMENT &&
          (g = Blockly.utils.xml.createElement("statement"));
      d = f.connection.getShadowDom();
      !d ||
        (k && k.isShadow()) ||
        g.appendChild(Blockly.Xml.cloneShadow_(d, b));
      k && (g.appendChild(Blockly.Xml.blockToDom(k, b)), (h = !1));
      g.setAttribute("name", f.name);
      h || c.appendChild(g);
    }
  }
  void 0 != a.inputsInline &&
    a.inputsInline != a.inputsInlineDefault &&
    c.setAttribute("inline", a.inputsInline);
  ...
  if ((e = a.getNextBlock()))
    (g = Blockly.utils.xml.createElement("next")),
      g.appendChild(Blockly.Xml.blockToDom(e, b)),
      c.appendChild(g);
...
Blockly.Xml.cloneShadow_ = function(a, b) {
  for (var c = (a = a.cloneNode(!0)), d; c; )
    if ((b && "shadow" == c.nodeName && c.removeAttribute("id"), c.firstChild))
      c = c.firstChild;
    else {
      for (; c && !c.nextSibling; )
        (d = c),
          ...
          d.nodeType == Node.TEXT_NODE &&
            "" == d.data.trim() &&
            c.firstChild != d &&
            Blockly.utils.dom.removeNode(d);
      c &&
        ((d = c),
        (c = c.nextSibling),
        d.nodeType == Node.TEXT_NODE &&
  ...
  try {
    for (var h = 0; h < e; h++) {
      ...
      if ("block" == l || ("shadow" == l && !Blockly.Events.recordUndo)) {
        ...
        if ("comment" == l)
          b.rendered
            ? Blockly.WorkspaceCommentSvg.fromXml(k, b, d)
            : Blockly.WorkspaceComment.fromXml(k, b);
        else if ("variables" == l) {
...
Blockly.Xml.appendDomToWorkspace = function(a, b) {
  ...
  if (d && d.top != d.bottom) {
    ...
    b.RTL && (l = b.getWidth());
    for (d = 0; d < c.length; d++)
      b.getBlockById(c[d]).moveBy(b.RTL ? l - f : f, e);
  }
  return c;
};
Blockly.Xml.domToBlock = function(a, b) {
  ...
  if (Blockly.Events.isEnabled()) {
    ...
    for (f = 0; f < e.length; f++)
      Blockly.Events.fire(new Blockly.Events.VarCreate(e[f]));
...
Blockly.Xml.domToBlockHeadless_ = function(a, b) {
  ...
  for (var g; (g = a.childNodes[e]); e++)
    if (g.nodeType != Node.TEXT_NODE) {
      for (var h = (f = null), k = 0, l; (l = g.childNodes[k]); k++)
        l.nodeType == Node.ELEMENT_NODE &&
          ("block" == l.nodeName.toLowerCase()
            ? (f = l)
            : "shadow" == l.nodeName.toLowerCase() && (h = l));
      !f && h && (f = h);
      ...
      switch (g.nodeName.toLowerCase()) {
        ...
        case "comment":
          ...
          n &&
            ...
            setTimeout(function() {
              c.comment &&
                c.comment.setVisible &&
                c.comment.setVisible("true" == n);
            }, 1);
        ...
        case "statement":
          ...
          if (f)
            if (
              ((f = Blockly.Xml.domToBlockHeadless_(f, b)), f.outputConnection)
            )
              g.connection.connect(f.outputConnection);
            else if (f.previousConnection)
              g.connection.connect(f.previousConnection);
            else
              throw TypeError(
  ...
  (e = a.getAttribute("disabled")) &&
    c.setEnabled("true" != e && "disabled" != e);
...
Blockly.Events.CommentCreateDeleteHelper = function(a, b) {
  ...
  if (b) {
    ...
    (c = c.getCommentById(a.commentId))
      ? c.dispose(!1, !1)
      : console.warn("Can't uncreate non-existent comment: " + a.commentId);
};
...
Blockly.WorkspaceComment.prototype.setContent = function(a) {
  this.content_ != a &&
    (Blockly.Events.fire(
      new Blockly.Events.CommentChange(this, this.content_, a)
    ),
    (this.content_ = a));
};
...
Blockly.Workspace.prototype.sortObjects_ = function(a, b) {
  ...
  return (
    c.y +
    Blockly.Workspace.prototype.sortObjects_.offset * c.x -
    (d.y + Blockly.Workspace.prototype.sortObjects_.offset * d.x)
  );
};
...
Blockly.Workspace.prototype.getBlocksByType = function(a, b) {
  ...
  b &&
    1 < c.length &&
    ((this.sortObjects_.offset = Math.sign(
      Blockly.utils.math.toRadians(Blockly.Workspace.SCAN_ANGLE)
    )),
    this.RTL && (this.sortObjects_.offset *= -1),
    c.sort(this.sortObjects_));
  return c;
};
Blockly.Workspace.prototype.addTopComment = function(a) {
  this.topComments_.push(a);
  this.commentDB_[a.id] &&
    console.warn(
      'Overriding an existing comment on this workspace, with id "' + a.id + '"'
    );
...
Blockly.Workspace.prototype.getAllBlocks = function(a) {
  if (a) {
    ...
    for (b = this.getTopBlocks(!1), c = 0; c < b.length; c++)
...
Blockly.Workspace.prototype.remainingCapacity = function() {
  return isNaN(this.options.maxBlocks)
    ? Infinity
    : this.options.maxBlocks - this.getAllBlocks().length;
};
Blockly.Workspace.prototype.remainingCapacityOfType = function(a) {
  return this.options.maxInstances
    ? (this.options.maxInstances[a] || Infinity) -
        this.getBlocksByType(a).length
    : Infinity;
};
...
Blockly.Bubble.prototype.createDom_ = function(a, b) {
  ...
  var c = { filter: "url(#" + this.workspace_.options.embossFilterId + ")" };
...
Blockly.Bubble.prototype.promote_ = function() {
  ...
  return a.lastChild !== this.bubbleGroup_
    ? (a.appendChild(this.bubbleGroup_), !0)
    : !1;
};
...
Blockly.Bubble.prototype.layoutBubble_ = function() {
  ...
  var b = this.getOptimalRelativeLeft_(a),
    ...
    e = { x: b, y: -this.height_ - Blockly.BlockSvg.MIN_BLOCK_Y },
  ...
  c == a
    ...
    : g == a
    ? ((this.relativeLeft_ = f.x), (this.relativeTop_ = f.y))
    : h == a
    ? ((this.relativeLeft_ = b.x), (this.relativeTop_ = b.y))
    : ((this.relativeLeft_ = d.x), (this.relativeTop_ = d.y));
};
Blockly.Bubble.prototype.getOverlap_ = function(a, b) {
  var c = this.workspace_.RTL
      ? this.anchorXY_.x - a.x - this.width_
      : a.x + this.anchorXY_.x,
    d = a.y + this.anchorXY_.y;
  return Math.max(
    0,
    Math.min(
      1,
      ((Math.min(c + this.width_, b.viewLeft + b.viewWidth) -
        Math.max(c, b.viewLeft)) *
        (Math.min(d + this.height_, b.viewTop + b.viewHeight) -
          Math.max(d, b.viewTop))) /
...
Blockly.Bubble.prototype.getOptimalRelativeLeft_ = function(a) {
  ...
  this.workspace_.RTL
    ? d < f
      ? (b = -(f - this.anchorXY_.x + this.width_))
      : c > e && (b = -(e - this.anchorXY_.x))
    : d < f
    ? (b = f - this.anchorXY_.x)
    : c > e && (b = e - this.anchorXY_.x - this.width_);
  return b;
};
...
Blockly.Bubble.prototype.positionBubble_ = function() {
  ...
  a = this.workspace_.RTL
    ? a - (this.relativeLeft_ + this.width_)
    : a + this.relativeLeft_;
...
Blockly.Bubble.prototype.moveDuringDrag = function(a, b) {
  ...
  this.relativeLeft_ = this.workspace_.RTL
    ? this.anchorXY_.x - b.x - this.width_
    : b.x - this.anchorXY_.x;
...
Blockly.Icon.prototype.renderIcon = function(a) {
  ...
  return (a = this.block_.RTL
    ? a - Blockly.BlockSvg.SEP_SPACE_X
...
Blockly.Icon.prototype.computeIconLocation = function() {
  ...
  a = new Blockly.utils.Coordinate(
    a.x + b.x + this.SIZE / 2,
    a.y + b.y + this.SIZE / 2
  );
  Blockly.utils.Coordinate.equals(this.getIconLocation(), a) ||
    this.setIconLocation(a);
};
...
Blockly.Comment.prototype.setVisible = function(a) {
  if (a != this.isVisible())
    if (
      (Blockly.Events.fire(
        new Blockly.Events.Ui(this.block_, "commentOpen", !a, a)
      ),
      (!this.block_.isEditable() && !this.textarea_) ||
        Blockly.utils.userAgent.IE)
    )
...
Blockly.Comment.prototype.getBubbleSize = function() {
  return this.isVisible()
    ? this.bubble_.getBubbleSize()
    : { width: this.width_, height: this.height_ };
};
Blockly.Comment.prototype.setBubbleSize = function(a, b) {
  this.textarea_
    ? this.bubble_.setBubbleSize(a, b)
    : ((this.width_ = a), (this.height_ = b));
};
    ...
    if (e.isShadow()) (f = Blockly.Xml.blockToDom(e)), e.dispose(), (e = null);
      ...
      for (g = d; g.nextConnection; ) {
        ...
        if (h && !h.isShadow()) g = h;
          ...
          e.previousConnection.checkType_(g.nextConnection) &&
            (g.nextConnection.connect(e.previousConnection), (e = null));
          break;
        }
      }
    }
    if (e && (b.disconnect(), Blockly.Events.recordUndo)) {
      ...
      setTimeout(function() {
        e.workspace &&
          ...
          e.outputConnection
            ? e.outputConnection.bumpAwayFrom_(b)
            : e.previousConnection && e.previousConnection.bumpAwayFrom_(b),
          Blockly.Events.setGroup(!1));
      }, Blockly.BUMP_DELAY);
    }
    b.setShadowDom(f);
...
Blockly.Connection.prototype.canConnectWithReason_ = function(a) {
  ...
  return b && b == c
    ...
    : a.type != Blockly.OPPOSITE_TYPE[this.type]
    ? Blockly.Connection.REASON_WRONG_TYPE
    : b && c && b.workspace !== c.workspace
    ? Blockly.Connection.REASON_DIFFERENT_WORKSPACES
    : this.checkType_(a)
    ? b.isShadow() && !c.isShadow()
...
Blockly.Connection.prototype.canConnectToPrevious_ = function(a) {
  if (this.targetConnection || -1 != Blockly.draggingConnections_.indexOf(a))
    return !1;
...
Blockly.Connection.prototype.isConnectionAllowed = function(a) {
  if (
    a.sourceBlock_.isInsertionMarker() ||
    this.canConnectWithReason_(a) != Blockly.Connection.CAN_CONNECT
  )
    return !1;
  switch (a.type) {
    ...
    case Blockly.OUTPUT_VALUE:
      if (
        (a.isConnected() && !a.targetBlock().isInsertionMarker()) ||
        this.isConnected()
      )
        return !1;
      break;
...
Blockly.Connection.singleConnection_ = function(a, b) {
  for (var c = !1, d = 0; d < a.inputList.length; d++) {
    ...
    if (
      e &&
      e.type == Blockly.INPUT_VALUE &&
      b.outputConnection.checkType_(e)
    ) {
      if (c) return null;
      c = e;
    }
...
Blockly.Connection.prototype.respawnShadow_ = function() {
  ...
  if (a.workspace && b && Blockly.Events.recordUndo)
    if (((a = Blockly.Xml.domToBlock(b, a.workspace)), a.outputConnection))
...
Blockly.Connection.prototype.setCheck = function(a) {
  a
    ? (Array.isArray(a) || (a = [a]), (this.check_ = a), this.onCheckChanged_())
    : (this.check_ = null);
  return this;
};
...
Blockly.ConnectionDB.prototype.getNeighbours = function(a, b) {
  ...
  for (
    ...
    d[k].y_ < f ? (g = k) : (h = k), (k = Math.floor((g + h) / 2));
  var l = [];
  h = g = k;
  if (d.length) {
    for (; 0 <= g && c(g); ) g--;
...
Blockly.ConnectionDB.prototype.searchForClosest = function(a, b, c) {
  ...
  for (var g = b, h, k = f - 1; 0 <= k && this.isInYRange_(k, a.y_, b); )
    (h = this.connections_[k]),
      a.isConnectionAllowed(h, g) && ((c = h), (g = h.distanceFrom(a))),
      k--;
  for (; f < this.connections_.length && this.isInYRange_(f, a.y_, b); )
...
Blockly.blockAnimations.disposeUiStep_ = function(a, b, c, d) {
  ...
  1 < e
    ...
    : (a.setAttribute(
        "transform",
        "translate(" +
          (a.translateX_ + (((b ? -1 : 1) * a.bBox_.width * d) / 2) * e) +
          "," +
          (a.translateY_ + a.bBox_.height * d * e) +
          ") scale(" +
          (1 - e) * d +
          ")"
      ),
...
Blockly.blockAnimations.connectionUiEffect = function(a) {
  ...
  if (!(1 > c)) {
    ...
    a = Blockly.utils.dom.createSvgElement(
      "circle",
      {
        cx: d.x,
        cy: d.y,
...
Blockly.blockAnimations.disconnectUiStep_ = function(a, b, c) {
  ...
  1 < d
    ? (a.skew_ = "")
    : ((a.skew_ =
        "skewX(" + Math.round(Math.sin(d * Math.PI * 3) * (1 - d) * b) + ")"),
...
Blockly.RenderedConnection.prototype.tighten_ = function() {
  ...
  if (0 != a || 0 != b) {
    ...
    c.getSvgRoot().setAttribute(
      "transform",
      "translate(" + (d.x - a) + "," + (d.y - b) + ")"
    );
...
Blockly.RenderedConnection.prototype.highlight = function() {
  var a =
    this.type == Blockly.INPUT_VALUE || this.type == Blockly.OUTPUT_VALUE
      ? "m 0,0 " + Blockly.BlockSvg.TAB_PATH_DOWN + " v 5"
      : "m -20,0 h 5 " + Blockly.BlockSvg.NOTCH_PATH_LEFT + " h 5";
...
Blockly.RenderedConnection.prototype.setHidden = function(a) {
  (this.hidden_ = a) && this.inDB_
    ? this.db_.removeConnection_(this)
    : a || this.inDB_ || this.db_.addConnection(this);
};
Blockly.RenderedConnection.prototype.hideAll = function() {
  this.setHidden(!0);
  if (this.targetConnection)
    for (
      var a = this.targetBlock().getDescendants(!1), b = 0;
      b < a.length;
      b++
    ) {
...
Blockly.RenderedConnection.prototype.isConnectionAllowed = function(a, b) {
  return this.distanceFrom(a) > b
    ? !1
    : Blockly.RenderedConnection.superClass_.isConnectionAllowed.call(this, a);
};
...
Blockly.InsertionMarkerManager.prototype.dispose = function() {
  ...
  try {
    this.firstMarker_ &&
      (this.firstMarker_.dispose(), (this.firstMarker_ = null)),
      this.lastMarker_ &&
        (this.lastMarker_.dispose(), (this.lastMarker_ = null));
  } finally {
    Blockly.Events.enable();
  }
  this.highlightedBlock_ = null;
...
Blockly.InsertionMarkerManager.prototype.applyConnections = function() {
  if (
    ...
    var a = this.localConnection_.isSuperior()
      ? this.closestConnection_
...
Blockly.InsertionMarkerManager.prototype.update = function(a, b) {
  ...
  if (
    (this.wouldDeleteBlock_ = this.shouldDelete_(c, b)) ||
    this.shouldUpdatePreviews_(c, a)
  )
    Blockly.Events.disable(),
...
Blockly.InsertionMarkerManager.prototype.initAvailableConnections_ = function() {
  ...
  b &&
    b != this.topBlock_.nextConnection &&
    (a.push(b),
    (this.lastOnStack_ = b),
    (this.lastMarker_ = this.createMarkerBlock_(b.sourceBlock_)));
  return a;
};
...
Blockly.InsertionMarkerManager.prototype.getCandidate_ = function(a) {
  for (
    var b = this.getStartRadius_(), c = null, d = null, e = 0;
    e < this.availableConnections_.length;
    e++
  ) {
...
Blockly.InsertionMarkerManager.prototype.shouldReplace_ = function() {
  ...
  return b.type == Blockly.OUTPUT_VALUE
    ? !a.isConnected() ||
      Blockly.Connection.lastConnectionInRow_(
        this.topBlock_,
        a.targetConnection.getSourceBlock()
      )
      ? !1
      : !0
    : b == b.sourceBlock_.getFirstStatementConnection()
    ? !1
...
Blockly.InsertionMarkerManager.prototype.shouldDelete_ = function(a, b) {
  ...
  return (
    !!b && !this.topBlock_.getParent() && this.topBlock_.isDeletable() && !c
  );
};
Blockly.InsertionMarkerManager.prototype.maybeShowPreview_ = function(a) {
  if (!this.wouldDeleteBlock_) {
    ...
    a = a.local;
    b &&
      (b == this.closestConnection_ || b.sourceBlock_.isInsertionMarker()
        ? console.log("trying to connect to an insertion marker")
        : ((this.closestConnection_ = b),
...
Blockly.InsertionMarkerManager.prototype.highlightBlock_ = function() {
  var a = this.closestConnection_,
    b = this.localConnection_;
  a.targetBlock()
    ? ((this.highlightedBlock_ = a.targetBlock()),
      a.targetBlock().highlightForReplacement(!0))
    : b.type == Blockly.OUTPUT_VALUE &&
      ((this.highlightedBlock_ = a.sourceBlock_),
      a.sourceBlock_.highlightShapeForInput(a, !0));
  this.highlightingBlock_ = !0;
};
Blockly.InsertionMarkerManager.prototype.unhighlightBlock_ = function() {
  var a = this.closestConnection_;
  a.type != Blockly.INPUT_VALUE || a.isConnected()
    ? this.highlightedBlock_.highlightForReplacement(!1)
    : this.highlightedBlock_.highlightShapeForInput(a, !1);
  this.highlightedBlock_ = null;
  this.highlightingBlock_ = !1;
};
Blockly.InsertionMarkerManager.prototype.disconnectMarker_ = function() {
  if (this.markerConnection_) {
    ...
    !(a != c || (d && d.targetConnection)) || e
      ? a.targetBlock().unplug(!1)
      : a.type == Blockly.NEXT_STATEMENT && a != c
      ? ((c = a.targetConnection),
        c.sourceBlock_.unplug(!1),
...
Blockly.InsertionMarkerManager.prototype.connectMarker_ = function() {
  var a = this.localConnection_,
    ...
    c =
      this.lastOnStack_ && a == this.lastOnStack_
        ? this.lastMarker_
        : this.firstMarker_;
...
Blockly.BlockDragger.prototype.startBlockDrag = function(a, b) {
  ...
  if ((c = this.workspace_.getToolbox())) {
    var d = this.draggingBlock_.isDeletable()
...
Blockly.BlockDragger.prototype.endBlockDrag = function(a, b) {
  ...
  this.maybeDeleteBlock_() ||
    (this.draggingBlock_.moveConnections_(c.x, c.y),
  ...
  if ((c = this.workspace_.getToolbox()))
    (d = this.draggingBlock_.isDeletable()
      ? "blocklyToolboxDelete"
      : "blocklyToolboxGrab"),
      c.removeStyle(d);
  Blockly.Events.setGroup(!1);
...
Blockly.BlockDragger.prototype.maybeDeleteBlock_ = function() {
  ...
  this.wouldDeleteBlock_
    ? (a && setTimeout(a.close.bind(a), 100),
      this.fireMoveEvent_(),
...
Blockly.BlockDragger.prototype.updateCursorDuringBlockDrag_ = function() {
  ...
  this.wouldDeleteBlock_
    ? (this.draggingBlock_.setDeleteStyle(!0),
      this.deleteArea_ == Blockly.DELETE_AREA_TRASH && a && a.setOpen_(!0))
    : (this.draggingBlock_.setDeleteStyle(!1), a && a.setOpen_(!1));
};
Blockly.BlockDragger.prototype.pixelsToWorkspaceUnits_ = function(a) {
  a = new Blockly.utils.Coordinate(
    a.x / this.workspace_.scale,
    a.y / this.workspace_.scale
  );
  this.workspace_.isMutator &&
    a.scale(1 / this.workspace_.options.parentWorkspace.scale);
  return a;
};
...
Blockly.WorkspaceCommentSvg.prototype.showContextMenu_ = function(a) {
  if (!this.workspace.options.readOnly) {
    ...
    this.isDeletable() &&
      this.isMovable() &&
      (b.push(Blockly.ContextMenu.commentDuplicateOption(this)),
      b.push(Blockly.ContextMenu.commentDeleteOption(this)));
  ...
  if (d) {
    do {
      ...
      this.useDragSurface_ &&
        this.workspace.blockDragSurface_.getCurrentBlock() == d &&
        ((e = this.workspace.blockDragSurface_.getSurfaceTranslation()),
        (a += e.x),
        (b += e.y));
      d = d.parentNode;
...
Blockly.WorkspaceCommentSvg.prototype.moveDuringDrag = function(a, b) {
  a
    ? a.translateSurface(b.x, b.y)
    : ((this.svgGroup_.translate_ = "translate(" + b.x + "," + b.y + ")"),
...
Blockly.BubbleDragger = function(a, b) {
  ...
  this.dragSurface_ =
    Blockly.utils.is3dSupported() && b.getBlockDragSurface()
      ? b.getBlockDragSurface()
      : null;
};
...
Blockly.BubbleDragger.prototype.startBubbleDrag = function() {
  ...
  if (a) {
    var b = this.draggingBubble_.isDeletable()
      ? "blocklyToolboxDelete"
      : "blocklyToolboxGrab";
    a.addStyle(b);
  }
...
Blockly.BubbleDragger.prototype.updateCursorDuringBubbleDrag_ = function() {
  ...
  this.wouldDeleteBubble_
    ? (this.draggingBubble_.setDeleteStyle(!0),
      this.deleteArea_ == Blockly.DELETE_AREA_TRASH && a && a.setOpen_(!0))
    : (this.draggingBubble_.setDeleteStyle(!1), a && a.setOpen_(!1));
};
Blockly.BubbleDragger.prototype.endBubbleDrag = function(a, b) {
  ...
  this.workspace_.toolbox_ &&
    ((c = this.draggingBubble_.isDeletable()
      ? "blocklyToolboxDelete"
      : "blocklyToolboxGrab"),
    this.workspace_.toolbox_.removeStyle(c));
  Blockly.Events.setGroup(!1);
};
...
Blockly.Tooltip.onMouseOver_ = function(a) {
  if (!Blockly.Tooltip.blocked_) {
    for (
      a = a.currentTarget;
      "string" != typeof a.tooltip && "function" != typeof a.tooltip;
...
Blockly.Tooltip.onMouseMove_ = function(a) {
  if (
    ...
    if (Blockly.Tooltip.visible) {
      ...
      Math.sqrt(b * b + a * a) > Blockly.Tooltip.RADIUS_OK &&
        Blockly.Tooltip.hide();
    } else
...
Blockly.Tooltip.show_ = function() {
  if (
    ...
    for (var a = Blockly.Tooltip.element_.tooltip; "function" == typeof a; )
      a = a();
    ...
    d = a
      ? d - (Blockly.Tooltip.OFFSET_X + Blockly.Tooltip.DIV.offsetWidth)
      : d + Blockly.Tooltip.OFFSET_X;
    var e = Blockly.Tooltip.lastY_ + Blockly.Tooltip.OFFSET_Y;
    e + Blockly.Tooltip.DIV.offsetHeight > c + window.scrollY &&
      (e -= Blockly.Tooltip.DIV.offsetHeight + 2 * Blockly.Tooltip.OFFSET_Y);
    a
      ? (d = Math.max(Blockly.Tooltip.MARGINS - window.scrollX, d))
      : d + Blockly.Tooltip.DIV.offsetWidth >
          b + window.scrollX - 2 * Blockly.Tooltip.MARGINS &&
        (d = b - Blockly.Tooltip.DIV.offsetWidth - 2 * Blockly.Tooltip.MARGINS);
...
Blockly.Gesture.prototype.dispose = function() {
  ...
  this.blockDragger_ &&
    (this.blockDragger_.dispose(), (this.blockDragger_ = null));
  this.workspaceDragger_ &&
    (this.workspaceDragger_.dispose(), (this.workspaceDragger_ = null));
  this.bubbleDragger_ &&
    (this.bubbleDragger_.dispose(), (this.bubbleDragger_ = null));
};
...
Blockly.Gesture.prototype.updateIsDraggingFromFlyout_ = function() {
  return this.flyout_.isBlockCreatable_(this.targetBlock_)
...
Blockly.Gesture.prototype.updateIsDraggingBlock_ = function() {
  ...
  this.flyout_
    ...
    : this.targetBlock_.isMovable() && (this.isDraggingBlock_ = !0);
...
Blockly.Gesture.prototype.handleUp = function(a) {
  ...
  this.isEnding_
    ...
    : ((this.isEnding_ = !0),
      this.isDraggingBubble_
        ? this.bubbleDragger_.endBubbleDrag(a, this.currentDragDeltaXY_)
        : this.isDraggingBlock_
        ? this.blockDragger_.endBlockDrag(a, this.currentDragDeltaXY_)
        : this.isDraggingWorkspace_
        ...
        : this.isBlockClick_()
        ? this.doBlockClick_()
        : this.isWorkspaceClick_() && this.doWorkspaceClick_(),
      a.preventDefault(),
      a.stopPropagation(),
      this.dispose());
};
...
Blockly.Gesture.prototype.handleRightClick = function(a) {
  this.targetBlock_
    ? (this.bringBlockToFront_(),
      Blockly.hideChaff(this.flyout_),
      this.targetBlock_.showContextMenu_(a))
    : this.startBubble_
    ? this.startBubble_.showContextMenu_(a)
    : this.startWorkspace_ &&
      !this.flyout_ &&
      (Blockly.hideChaff(), this.startWorkspace_.showContextMenu_(a));
  a.preventDefault();
  a.stopPropagation();
  this.dispose();
};
...
Blockly.Gesture.prototype.isBlockClick_ = function() {
  return (
    !!this.startBlock_ && !this.hasExceededDragRadius_ && !this.isFieldClick_()
  );
};
Blockly.Gesture.prototype.isFieldClick_ = function() {
  return (
    (this.startField_ ? this.startField_.isClickable() : !1) &&
    !this.hasExceededDragRadius_ &&
    (!this.flyout_ || !this.flyout_.autoClose)
  );
};
...
Blockly.Gesture.prototype.isDragging = function() {
  return (
    this.isDraggingWorkspace_ || this.isDraggingBlock_ || this.isDraggingBubble_
  );
};
...
Blockly.Grid.prototype.update = function(a) {
  ...
  b = Math.floor(this.spacing_ / 2) + 0.5;
...
Blockly.Grid.createDom = function(a, b, c) {
  ...
  0 < b.length && 0 < b.spacing
    ? (Blockly.utils.dom.createSvgElement("line", { stroke: b.colour }, a),
      1 < b.length &&
        Blockly.utils.dom.createSvgElement("line", { stroke: b.colour }, a))
    : Blockly.utils.dom.createSvgElement("line", {}, a);
  return a;
};
...
Blockly.Options.parseMoveOptions = function(a, b) {
  var c = a.move || {},
    d = {};
  d.scrollbars =
    void 0 === c.scrollbars && void 0 === a.scrollbars
      ? b
...
Blockly.Options.parseZoomOptions_ = function(a) {
  ...
  b.minScale = void 0 === a.minScale ? 0.3 : parseFloat(a.minScale);
...
Blockly.Options.parseToolboxTree = function(a) {
  if (a) {
    if (
      ("string" != typeof a &&
        (Blockly.utils.userAgent.IE && a.outerHTML
          ? (a = a.outerHTML)
          : a instanceof Element || (a = null)),
      "string" == typeof a &&
        ((a = Blockly.Xml.textToDom(a)), "xml" != a.nodeName.toLowerCase()))
    )
...
Blockly.ScrollbarPair.prototype.resize = function() {
  ...
  if (a) {
    ...
    this.oldHostMetrics_.viewWidth == a.viewWidth &&
    this.oldHostMetrics_.viewHeight == a.viewHeight &&
    this.oldHostMetrics_.absoluteTop == a.absoluteTop &&
    this.oldHostMetrics_.absoluteLeft == a.absoluteLeft
      ? ((this.oldHostMetrics_ &&
          this.oldHostMetrics_.contentWidth == a.contentWidth &&
          this.oldHostMetrics_.viewLeft == a.viewLeft &&
          this.oldHostMetrics_.contentLeft == a.contentLeft) ||
          (b = !0),
        (this.oldHostMetrics_ &&
          this.oldHostMetrics_.contentHeight == a.contentHeight &&
          this.oldHostMetrics_.viewTop == a.viewTop &&
          this.oldHostMetrics_.contentTop == a.contentTop) ||
          (c = !0))
      : (c = b = !0);
...
Blockly.Scrollbar.prototype.resize = function(a) {
  ...
  Blockly.Scrollbar.metricsAreEquivalent_(a, this.oldHostMetrics_) ||
    ((this.oldHostMetrics_ = a),
...
Blockly.Scrollbar.prototype.resizeViewHorizontal = function(a) {
  ...
  b = a.absoluteLeft + 0.5;
  this.pair_ &&
    this.workspace_.RTL &&
    (b += Blockly.Scrollbar.scrollbarThickness);
  this.setPosition_(
    b,
    a.absoluteTop + a.viewHeight - Blockly.Scrollbar.scrollbarThickness - 0.5
  );
...
Blockly.Scrollbar.prototype.resizeContentHorizontal = function(a) {
  ...
  this.setHandlePosition(
    this.constrainHandle_((a.viewLeft - a.contentLeft) * this.ratio_)
  );
};
...
Blockly.Scrollbar.prototype.resizeViewVertical = function(a) {
  ...
  b = a.absoluteLeft + 0.5;
  this.workspace_.RTL ||
    (b += a.viewWidth - Blockly.Scrollbar.scrollbarThickness - 1);
  this.setPosition_(b, a.absoluteTop + 0.5);
...
Blockly.Scrollbar.prototype.onMouseDownBar_ = function(a) {
  ...
  if (Blockly.utils.isRightButton(a)) a.stopPropagation();
    ...
    var b = Blockly.utils.mouseToSvg(
      a,
  ...
  this.setHandlePosition(
    this.constrainHandle_(
      this.startDragHandle +
        ((this.horizontal_ ? a.clientX : a.clientY) - this.startDragMouse_)
    )
  );
  this.onScroll_();
};
...
Blockly.Scrollbar.prototype.constrainHandle_ = function(a) {
  return (a =
    0 >= a || isNaN(a) || this.scrollViewSize_ < this.handleLength_
      ? 0
      : Math.min(a, this.scrollViewSize_ - this.handleLength_));
};
...
Blockly.TouchGesture.prototype.handleStart = function(a) {
  !this.isDragging() &&
    Blockly.Touch.isTouchEvent(a) &&
    (this.handleTouchStart(a), this.isMultiTouch() && Blockly.longStop_());
};
Blockly.TouchGesture.prototype.handleMove = function(a) {
  this.isDragging()
    ? Blockly.Touch.shouldHandleEvent(a) &&
      Blockly.TouchGesture.superClass_.handleMove.call(this, a)
    : this.isMultiTouch()
    ? (Blockly.Touch.isTouchEvent(a) && this.handleTouchMove(a),
      Blockly.longStop_())
    : Blockly.TouchGesture.superClass_.handleMove.call(this, a);
};
Blockly.TouchGesture.prototype.handleUp = function(a) {
  ...
  !this.isMultiTouch() || this.isDragging()
    ? Blockly.Touch.shouldHandleEvent(a) &&
      Blockly.TouchGesture.superClass_.handleUp.call(this, a)
    : (a.preventDefault(), a.stopPropagation(), this.dispose());
};
...
Blockly.TouchGesture.prototype.handleTouchStart = function(a) {
  ...
  2 == b.length &&
    ((this.startDistance_ = Blockly.utils.Coordinate.distance(
      this.cachedPoints_[b[0]],
      this.cachedPoints_[b[1]]
    )),
...
Blockly.TouchGesture.prototype.handleTouchMove = function(a) {
  ...
  if (2 == b.length) {
    ...
    if (0 < this.previousScale_ && Infinity > this.previousScale_) {
      ...
      c =
        0 < c
          ? c * Blockly.TouchGesture.ZOOM_IN_MULTIPLIER
          : c * Blockly.TouchGesture.ZOOM_OUT_MULTIPLIER;
...
Blockly.TouchGesture.prototype.handleTouchEnd = function(a) {
  ...
  2 > Object.keys(this.cachedPoints_).length &&
    ((this.cachedPoints_ = {}), (this.previousScale_ = 0));
};
Blockly.TouchGesture.prototype.getTouchPoint = function(a) {
  return this.startWorkspace_
    ? new Blockly.utils.Coordinate(
        a.pageX ? a.pageX : a.changedTouches[0].pageX,
        a.pageY ? a.pageY : a.changedTouches[0].pageY
      )
    : null;
};
    ...
    this.workspace_.horizontalLayout
      ? ((a.toolboxPosition =
          this.workspace_.toolboxPosition == Blockly.TOOLBOX_AT_TOP
            ? Blockly.TOOLBOX_AT_BOTTOM
            : Blockly.TOOLBOX_AT_TOP),
        (this.flyout_ = new Blockly.HorizontalFlyout(a)))
      : ((a.toolboxPosition =
          this.workspace_.toolboxPosition == Blockly.TOOLBOX_AT_RIGHT
            ? Blockly.TOOLBOX_AT_LEFT
            : Blockly.TOOLBOX_AT_RIGHT),
        (this.flyout_ = new Blockly.VerticalFlyout(a))),
...
Blockly.Trashcan.prototype.createDom = function() {
  ...
  var b = Blockly.utils.dom.createSvgElement(
    "clipPath",
  ...
  var c = Blockly.utils.dom.createSvgElement(
    "image",
    {
...
Blockly.Trashcan.prototype.position = function() {
  if (this.verticalSpacing_) {
    ...
    a &&
      ((this.left_ =
        a.toolboxPosition == Blockly.TOOLBOX_AT_LEFT ||
      ...
      (this.top_ =
        a.toolboxPosition == Blockly.TOOLBOX_AT_BOTTOM
...
Blockly.Trashcan.prototype.getClientRect = function() {
  ...
  return new Blockly.utils.Rect(
    b,
    b + this.LID_HEIGHT_ + this.BODY_HEIGHT_ + 2 * this.MARGIN_HOTSPOT_,
    a,
    a + this.WIDTH_ + 2 * this.MARGIN_HOTSPOT_
  );
};
Blockly.Trashcan.prototype.setOpen_ = function(a) {
  this.isOpen != a &&
    (clearTimeout(this.lidTask_), (this.isOpen = a), this.animateLid_());
};
...
Blockly.Trashcan.prototype.onDelete_ = function() {
  ...
  return function(b) {
    0 >= a.workspace_.options.maxTrashcanContents ||
      b.type != Blockly.Events.BLOCK_DELETE ||
      "shadow" == b.oldXml.tagName.toLowerCase() ||
      ((b = a.cleanBlockXML_(b.oldXml)),
      -1 == a.contents_.indexOf(b) &&
        (a.contents_.unshift(b),
        a.contents_.length > a.workspace_.options.maxTrashcanContents &&
          a.contents_.splice(
            a.workspace_.options.maxTrashcanContents,
            a.contents_.length - a.workspace_.options.maxTrashcanContents
          ),
        (a.hasBlocks_ = !0),
        (a.minOpenness_ = a.HAS_BLOCKS_LID_ANGLE),
...
Blockly.Trashcan.prototype.cleanBlockXML_ = function(a) {
  for (var b = (a = a.cloneNode(!0)); b; ) {
    b.removeAttribute &&
      (b.removeAttribute("x"), b.removeAttribute("y"), b.removeAttribute("id"));
...
Blockly.Variables.allDeveloperVariables = function(a) {
  ...
  for (var b = Object.create(null), c = 0, d; (d = a[c]); c++) {
    ...
    !e &&
      ...
      Blockly.Variables.ALL_DEVELOPER_VARS_WARNINGS_BY_BLOCK_TYPE_[d.type] ||
        (console.warn(
      ...
      Blockly.Variables.promptName(Blockly.Msg.NEW_VARIABLE_TITLE, c, function(
        ...
        if (c) {
          ...
          if (f) {
            var g = c.toLowerCase();
            if (f.type == d)
              var l = Blockly.Msg.VARIABLE_ALREADY_EXISTS.replace("%1", g);
            else
              (l = Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE),
                (l = l.replace("%1", g).replace("%2", f.type));
  ...
  var d = function(e) {
    ...
    Blockly.Variables.promptName(f, e, function(e) {
      if (e) {
        ...
        f
          ? ((f = Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE.replace(
              "%1",
              e.toLowerCase()
            ).replace("%2", f.type)),
            Blockly.alert(f, function() {
              d(e);
            }))
...
Blockly.Variables.promptName = function(a, b, c) {
  Blockly.prompt(a, b, function(a) {
    a &&
      ((a = a.replace(/[\s\xa0]+/g, " ").trim()),
      a == Blockly.Msg.RENAME_VARIABLE || a == Blockly.Msg.NEW_VARIABLE) &&
      (a = null);
    c(a);
  });
};
...
Blockly.Variables.createVariable_ = function(a, b, c, d) {
  var e = a.getPotentialVariableMap();
  c ||
    (c = Blockly.Variables.generateUniqueName(
...
Blockly.WorkspaceAudio.prototype.play = function(a, b) {
  ...
  if (c) {
    var d = new Date();
    (null != this.lastSound_ && d - this.lastSound_ < Blockly.SOUND_LIMIT) ||
      ((this.lastSound_ = d),
      (c =
    ...
    this.parentWorkspace_ && this.parentWorkspace_.getAudioManager().play(a, b);
};
...
Blockly.WorkspaceCommentSvg.prototype.addResizeDom_ = function() {
  ...
  Blockly.utils.dom.createSvgElement(
    "line",
    { class: "blocklyResizeLine", x1: a / 3, y1: a - 1, x2: a - 1, y2: a / 3 },
    this.resizeGroup_
  );
  Blockly.utils.dom.createSvgElement(
    "line",
...
Blockly.WorkspaceCommentSvg.prototype.setSize_ = function(a, b) {
  ...
  this.resizeGroup_ &&
    (this.RTL
      ? (this.resizeGroup_.setAttribute(
          "transform",
          "translate(" + (-a + c) + "," + (b - c) + ") scale(-1 1)"
        ),
        this.deleteGroup_.setAttribute(
          "transform",
          "translate(" + (-a + c) + "," + -c + ") scale(-1 1)"
        ))
      : (this.resizeGroup_.setAttribute(
          "transform",
          "translate(" + (a - c) + "," + (b - c) + ")"
...
Blockly.WorkspaceDragSurfaceSvg.prototype.clearAndHide = function(a) {
  ...
  if (
    !(
      b &&
      c &&
      Blockly.utils.dom.hasClass(b, "blocklyBlockCanvas") &&
      Blockly.utils.dom.hasClass(c, "blocklyBubbleCanvas")
    )
  )
    throw Error(
  ...
  null != this.previousSibling_
    ? Blockly.utils.dom.insertAfter(b, this.previousSibling_)
...
Blockly.ZoomControls.prototype.createZoomOutSvg_ = function(a) {
  ...
  a.setAttributeNS(
    Blockly.utils.dom.XLINK_NS,
    "xlink:href",
    b.options.pathToMedia + Blockly.SPRITE.url
  );
...
Blockly.WorkspaceSvg = function(a, b, c) {
  ...
  this.getMetrics =
    a.getMetrics || Blockly.WorkspaceSvg.getTopLevelWorkspaceMetrics_;
  this.setMetrics =
    a.setMetrics || Blockly.WorkspaceSvg.setTopLevelWorkspaceMetrics_;
  ...
  this.grid_ = this.options.gridPattern
    ? new Blockly.Grid(a.gridPattern, a.gridOptions)
    : null;
  Blockly.Variables &&
...
Blockly.WorkspaceSvg.prototype.getInverseScreenCTM = function() {
  if (this.inverseScreenCTMDirty_) {
    ...
    a &&
      ((this.inverseScreenCTM_ = a.inverse()),
...
Blockly.WorkspaceSvg.prototype.getSvgXY = function(a) {
  var b = 0,
    ...
    d = 1;
  if (
    Blockly.utils.dom.containsNode(this.getCanvas(), a) ||
    Blockly.utils.dom.containsNode(this.getBubbleCanvas(), a)
  )
    d = this.scale;
  do {
...
Blockly.WorkspaceSvg.prototype.addFlyout_ = function(a) {
  ...
  this.flyout_ = this.horizontalLayout
    ? new Blockly.HorizontalFlyout(b)
    : new Blockly.VerticalFlyout(b);
...
Blockly.WorkspaceSvg.prototype.updateScreenCalculationsIfScrolled = function() {
  ...
  Blockly.utils.Coordinate.equals(this.lastRecordedPageScroll_, a) ||
    ((this.lastRecordedPageScroll_ = a), this.updateScreenCalculations_());
};
...
Blockly.WorkspaceSvg.prototype.translate = function(a, b) {
  ...
  this.blockDragSurface_ &&
    this.blockDragSurface_.translateAndScaleGroup(a, b, this.scale);
...
Blockly.WorkspaceSvg.prototype.setVisible = function(a) {
  ...
  a
    ? (this.render(), this.toolbox_ && this.toolbox_.position())
    : Blockly.hideChaff(!0);
  this.isVisible_ = a;
};
Blockly.WorkspaceSvg.prototype.render = function() {
  ...
  if (this.currentGesture_)
    for (
      a = this.currentGesture_.getInsertionMarkers(), b = 0;
      b < a.length;
      b++
    )
      a[b].render(!1);
...
Blockly.WorkspaceSvg.prototype.highlightBlock = function(a, b) {
  ...
  if ((d = a ? this.getBlockById(a) : null))
    (c = void 0 === b || b)
      ? -1 == this.highlightedBlocks_.indexOf(d) &&
        this.highlightedBlocks_.push(d)
      : Blockly.utils.arrayRemove(this.highlightedBlocks_, d),
      d.setHighlighted(c);
};
Blockly.WorkspaceSvg.prototype.paste = function(a) {
  !this.rendered ||
    a.getElementsByTagName("block").length >= this.remainingCapacity() ||
    (this.currentGesture_ && this.currentGesture_.cancel(),
    "comment" == a.tagName.toLowerCase()
      ? this.pasteWorkspaceComment_(a)
      : this.pasteBlock_(a));
};
Blockly.WorkspaceSvg.prototype.pasteBlock_ = function(a) {
    ...
    if (!isNaN(c) && !isNaN(d)) {
      ...
      do {
        ...
        if (!a) {
          ...
          for (var l; (l = k[f]); f++)
            if (
              l.closest(Blockly.SNAP_RADIUS, new Blockly.utils.Coordinate(c, d))
                .connection
            ) {
              a = !0;
              break;
        ...
        a &&
          ((c = this.RTL ? c - Blockly.SNAP_RADIUS : c + Blockly.SNAP_RADIUS),
  ...
  Blockly.Events.isEnabled() &&
    !b.isShadow() &&
    Blockly.Events.fire(new Blockly.Events.BlockCreate(b));
  b.select();
};
...
Blockly.WorkspaceSvg.prototype.isDeleteArea = function(a) {
  return this.deleteAreaTrash_ &&
    this.deleteAreaTrash_.contains(a.clientX, a.clientY)
    ? Blockly.DELETE_AREA_TRASH
    : this.deleteAreaToolbox_ &&
      this.deleteAreaToolbox_.contains(a.clientX, a.clientY)
...
Blockly.WorkspaceSvg.prototype.startDrag = function(a, b) {
  var c = Blockly.utils.mouseToSvg(
    a,
    this.getParentSvg(),
  ...
  if (Blockly.Gesture.inProgress()) a.preventDefault(), a.stopPropagation();
    ...
    if (b || c) {
      ...
      !b || (!a.ctrlKey && c)
        ? ((b = this.scrollX - d.x),
          (c = this.scrollY - d.y),
          a.shiftKey && !d.x && ((b = this.scrollX - d.y), (c = this.scrollY)),
          this.scroll(b, c))
        : ((d = -d.y / 50),
          (b = Blockly.utils.mouseToSvg(
            a,
            this.getParentSvg(),
            this.getInverseScreenCTM()
          )),
...
Blockly.WorkspaceSvg.prototype.cleanUp = function() {
  ...
  for (var a = this.getTopBlocks(!0), b = 0, c = 0, d; (d = a[c]); c++)
    if (d.isMovable()) {
      ...
      d.snapToGrid();
      b =
        d.getRelativeToSurfaceXY().y +
        d.getHeightWidth().height +
...
Blockly.WorkspaceSvg.prototype.showContextMenu_ = function(a) {
  ...
  if (!this.options.readOnly && !this.isFlyout) {
    ...
    this.isMovable() &&
      ((h = {}),
      (h.text = Blockly.Msg.CLEAN_UP),
      (h.enabled = 1 < e.length),
      (h.callback = this.cleanUp.bind(this)),
      d.push(h));
    if (this.options.collapse) {
      for (var k = (h = !1), l = 0; l < e.length; l++)
        for (var n = e[l]; n; )
          n.isCollapsed() ? (h = !0) : (k = !0), (n = n.getNextBlock());
      var m = function(a) {
    ...
    h = {
      text:
        1 == p.length
          ...
          : Blockly.Msg.DELETE_X_BLOCKS.replace("%1", String(p.length)),
      enabled: 0 < p.length,
      callback: function() {
        ...
        2 > p.length
          ? c()
          : Blockly.confirm(
              Blockly.Msg.DELETE_ALL_BLOCKS.replace("%1", p.length),
              function(a) {
                a && c();
              }
            );
    ...
    d &&
      (this.flyout_ &&
        (this.horizontalLayout
          ? ((a += this.flyout_.height_),
            (c += this.flyout_.height_ / this.scale))
          : ((b += this.flyout_.getWidth()),
            (d += this.flyout_.getWidth() / this.scale))),
      this.setScale(Math.min(b / d, a / c)),
      this.scrollCenter());
  } else
    console.warn(
...
Blockly.WorkspaceSvg.prototype.setScale = function(a) {
  this.options.zoomOptions.maxScale && a > this.options.zoomOptions.maxScale
  ...
  this.scrollbar &&
    (this.flyout_
      ? (this.scrollbar.hScroll.resizeViewHorizontal(a),
        this.scrollbar.vScroll.resizeViewVertical(a))
      : (this.scrollbar.hScroll.resizeContentHorizontal(a),
        this.scrollbar.vScroll.resizeContentVertical(a)));
};
Blockly.WorkspaceSvg.prototype.scroll = function(a, b) {
  ...
  this.scrollbar &&
    (this.scrollbar.hScroll.setHandlePosition(
      -(a + c.contentLeft) * this.scrollbar.hScroll.ratio_
    ),
    this.scrollbar.vScroll.setHandlePosition(
      -(b + c.contentTop) * this.scrollbar.vScroll.ratio_
    ));
  a += c.absoluteLeft;
  b += c.absoluteTop;
  this.translate(a, b);
...
Blockly.WorkspaceSvg.getContentDimensions_ = function(a, b) {
  return a.isContentBounded()
    ? Blockly.WorkspaceSvg.getContentDimensionsBounded_(a, b)
    : Blockly.WorkspaceSvg.getContentDimensionsExact_(a);
};
...
Blockly.WorkspaceSvg.setTopLevelWorkspaceMetrics_ = function(a) {
  var b = this.getMetrics();
  "number" == typeof a.x &&
    (this.scrollX = -b.contentWidth * a.x - b.contentLeft);
  "number" == typeof a.y &&
    (this.scrollY = -b.contentHeight * a.y - b.contentTop);
...
Blockly.WorkspaceSvg.prototype.getGesture = function(a) {
  ...
  return c
    ? b && c.hasStarted()
      ...
      : c
    : b
    ? (this.currentGesture_ = new Blockly.TouchGesture(a, this))
    : null;
};
...
Blockly.Mutator.prototype.createEditor_ = function() {
  ...
  if (this.quarkNames_.length)
    for (
      var a = Blockly.utils.xml.createElement("xml"), b = 0, c;
      (c = this.quarkNames_[b]);
      b++
    ) {
      var d = Blockly.utils.xml.createElement("block");
...
Blockly.Mutator.prototype.resizeBubble_ = function() {
  ...
  c += 3 * a;
  if (
    Math.abs(this.workspaceWidth_ - c) > a ||
    Math.abs(this.workspaceHeight_ - b) > a
  )
  ...
  this.block_.RTL &&
    ((a = "translate(" + this.workspaceWidth_ + ",0)"),
...
Blockly.Mutator.prototype.setVisible = function(a) {
  if (a != this.isVisible())
    if (
      (Blockly.Events.fire(
        new Blockly.Events.Ui(this.block_, "mutatorOpen", !a, a)
      ),
      a)
    ) {
      this.bubble_ = new Blockly.Bubble(
      ...
      this.workspace_.flyout_
        ? ((a = 2 * this.workspace_.flyout_.CORNER_RADIUS),
          (b = this.workspace_.getFlyout().getWidth() + a))
        : (b = a = 16);
      this.block_.RTL && (b = -b);
...
Blockly.Mutator.prototype.workspaceChanged_ = function(a) {
  if (
    ...
    (a.type != Blockly.Events.CHANGE || "disabled" != a.element)
  ) {
    ...
    if (this.rootBlock_.workspace == this.workspace_) {
      ...
      if (a != b) {
        Blockly.Events.fire(
          new Blockly.Events.BlockChange(c, "mutation", null, a, b)
        );
...
Blockly.Mutator.reconnect = function(a, b, c) {
  ...
  var d = a.targetBlock();
  return (d && d != b) || c.targetConnection == a
    ? !1
...
Blockly.Mutator.findParentWs = function(a) {
  ...
  if (a && a.options) {
    ...
    a.isFlyout
      ? c && c.options && (b = c.options.parentWorkspace)
      : c && (b = c);
  }
  return b;
};
...
Blockly.Extensions.buildTooltipForDropdown = function(a, b) {
  ...
  return function() {
    this.type &&
      ...
      (Blockly.Extensions.checkDropdownOptionsInTable_(this, a, b),
      c.push(this.type));
    this.setTooltip(
      function() {
        ...
        null == e
          ? -1 === c.indexOf(this.type) &&
            ((d = "No tooltip mapping for value " + d + " of field " + a),
            null != this.type && (d += " of block type " + this.type),
            console.warn(d + "."))
          : (e = Blockly.utils.replaceMessageReferences(e));
        return e;
      }.bind(this)
    );
  };
...
Blockly.Extensions.extensionParentTooltip_ = function() {
  ...
  this.setTooltip(
    function() {
      var a = this.getParent();
      return (
        (a && a.getInputsInline() && a.tooltip) || this.tooltipWhenNotConnected_
      );
    }.bind(this)
  );
};
...
Blockly.Field.register = function(a, b) {
  ...
  if (!b || "function" != typeof b.fromJson)
...
Blockly.Field.prototype.updateEditable = function() {
  ...
  this.EDITABLE &&
    ...
    (this.sourceBlock_.isEditable()
      ? (Blockly.utils.dom.addClass(a, "blocklyEditableText"),
        Blockly.utils.dom.removeClass(a, "blocklyNonEditableText"),
        (a.style.cursor = this.CURSOR))
      : (Blockly.utils.dom.addClass(a, "blocklyNonEditableText"),
...
Blockly.Field.prototype.updateWidth = function() {
  console.warn(
    "Deprecated call to updateWidth, call Blockly.Field.updateSize_ to force an update to the size of the field, or Blockly.Field.getCachedWidth() to check the size of the field."
  );
  this.updateSize_();
};
Blockly.Field.prototype.updateSize_ = function() {
  ...
  this.borderRect_ &&
    this.borderRect_.setAttribute("width", a + Blockly.BlockSvg.SEP_SPACE_X);
  this.size_.width = a;
};
...
Blockly.Field.prototype.getScaledBBox_ = function() {
  ...
  return { top: c.y, bottom: c.y + b, left: c.x, right: c.x + a };
};
...
Blockly.Field.prototype.setText = function(a) {
  null !== a &&
    ((a = String(a)),
    a !== this.text_ && ((this.text_ = a), this.forceRerender()));
};
Blockly.Field.prototype.forceRerender = function() {
  this.isDirty_ = !0;
  this.sourceBlock_ &&
    this.sourceBlock_.rendered &&
    (this.sourceBlock_.render(), this.sourceBlock_.bumpNeighbours_());
};
...
Blockly.Field.prototype.processValidation_ = function(a, b) {
  if (null === b)
    return (
      this.doValueInvalid_(a), this.isDirty_ && this.forceRerender(), Error()
    );
  void 0 !== b && (a = b);
  return a;
};
...
Blockly.Field.prototype.onMouseDown_ = function(a) {
  this.sourceBlock_ &&
    ...
    (a = this.sourceBlock_.workspace.getGesture(a)) &&
    a.setStartField(this);
};
...
Blockly.Input.prototype.setVisible = function(a) {
  ...
  for (
    var c = (this.visible_ = a) ? "block" : "none", d = 0, e;
    (e = this.fieldRow[d]);
    d++
  )
    e.setVisible(a);
  this.connection &&
    (a ? (b = this.connection.unhideAll()) : this.connection.hideAll(),
    (d = this.connection.targetBlock())) &&
    ((d.getSvgRoot().style.display = c), a || (d.rendered = !1));
  return b;
};
...
Blockly.Warning.textToDom_ = function(a) {
  var b = Blockly.utils.dom.createSvgElement(
    "text",
    { class: "blocklyText blocklyBubbleText", y: Blockly.Bubble.BORDER_WIDTH },
    null
  );
  a = a.split("\n");
  for (var c = 0; c < a.length; c++) {
    var d = Blockly.utils.dom.createSvgElement(
        "tspan",
...
Blockly.Warning.prototype.setVisible = function(a) {
  if (a != this.isVisible())
    if (
      (Blockly.Events.fire(
        new Blockly.Events.Ui(this.block_, "warningOpen", !a, a)
      ),
      a)
    ) {
...
Blockly.Warning.prototype.setText = function(a, b) {
  this.text_[b] != a &&
    (a ? (this.text_[b] = a) : delete this.text_[b],
    this.isVisible() && (this.setVisible(!1), this.setVisible(!0)));
};
...
Blockly.Block = function(a, b, c) {
  if ("undefined" !== typeof Blockly.Generator.prototype[b])
    throw Error(
      'Block prototypeName "' +
        b +
...
Blockly.Block.obtain = function(a, b) {
  console.warn(
    "Deprecated call to Blockly.Block.obtain, use workspace.newBlock instead."
  );
  return a.newBlock(b);
};
...
Blockly.Block.prototype.unplugFromRow_ = function(a) {
  ...
  b &&
    a &&
    (a = this.getOnlyValueConnection_()) &&
    a.isConnected() &&
    !a.targetBlock().isShadow() &&
    ((a = a.targetConnection),
    a.checkType_(b) && (a.disconnect(), b.connect(a)));
};
...
Blockly.Block.prototype.getFirstStatementConnection = function() {
  for (var a = 0, b; (b = this.inputList[a]); a++)
    if (b.connection && b.connection.type == Blockly.NEXT_STATEMENT)
      return b.connection;
  return null;
};
...
Blockly.Block.prototype.setConnectionsHidden = function(a) {
  if (!a && this.isCollapsed()) {
    if (
      (this.outputConnection && this.outputConnection.setHidden(a),
...
Blockly.Block.prototype.getColourShadow = function() {
  ...
  return a ? a : Blockly.utils.colour.blend("white", this.getColour(), 0.6);
};
Blockly.Block.prototype.getColourBorder = function() {
  var a = this.getColourTertiary();
  if (a) return { colourBorder: a, colourLight: null, colourDark: null };
  a = this.getColour();
  return {
    colourBorder: null,
    colourLight: Blockly.utils.colour.blend("white", a, 0.3),
    colourDark: Blockly.utils.colour.blend("black", a, 0.2)
  };
};
...
Blockly.Block.prototype.setColour = function(a) {
  ...
  if (!isNaN(c) && 0 <= c && 360 >= c)
    (this.hue_ = c), (this.colour_ = Blockly.hueToHex(c));
  else if ((c = Blockly.utils.colour.parse(b)))
    (this.colour_ = c), (this.hue_ = null);
  else
...
Blockly.Block.prototype.setStyle = function(a) {
  ...
  this.styleName_ = a;
  if (b)
    (this.colourSecondary_ = b.colourSecondary),
      (this.colourTertiary_ = b.colourTertiary),
      (this.hat = b.hat),
      this.setColour(b.colourPrimary);
...
Blockly.Block.prototype.getField = function(a) {
  for (var b = 0, c; (c = this.inputList[b]); b++)
    for (var d = 0, e; (e = c.fieldRow[d]); d++) if (e.name === a) return e;
  return null;
};
  ...
  for (var a = [], b = 0, c; (c = this.inputList[b]); b++)
    for (var d = 0, e; (e = c.fieldRow[d]); d++)
      e.referencesVariables() &&
        (e = this.workspace.getVariableById(e.getValue())) &&
        a.push(e);
  return a;
};
Blockly.Block.prototype.updateVarName = function(a) {
  for (var b = 0, c; (c = this.inputList[b]); b++)
    for (var d = 0, e; (e = c.fieldRow[d]); d++)
      e.referencesVariables() && a.getId() == e.getValue() && e.setText(a.name);
};
...
Blockly.Block.prototype.setInputsInline = function(a) {
  this.inputsInline != a &&
    (Blockly.Events.fire(
      new Blockly.Events.BlockChange(this, "inline", null, this.inputsInline, a)
    ),
    (this.inputsInline = a));
};
Blockly.Block.prototype.getInputsInline = function() {
  ...
  for (var a = 1; a < this.inputList.length; a++)
    if (
      this.inputList[a - 1].type == Blockly.DUMMY_INPUT &&
      this.inputList[a].type == Blockly.DUMMY_INPUT
    )
      return !1;
  for (a = 1; a < this.inputList.length; a++)
    if (
      this.inputList[a - 1].type == Blockly.INPUT_VALUE &&
      this.inputList[a].type == Blockly.DUMMY_INPUT
    )
      return !0;
  return !1;
...
Blockly.Block.prototype.setEnabled = function(a) {
  this.isEnabled() != a &&
    (Blockly.Events.fire(
      new Blockly.Events.BlockChange(this, "disabled", null, this.disabled, !a)
    ),
    (this.disabled = !a));
};
  ...
  if (this.collapsed_)
    ...
    for (var e = 0, f; (f = this.inputList[e]); e++) {
      for (var g = 0, h; (h = f.fieldRow[g]); g++)
        h instanceof Blockly.FieldDropdown && !h.getValue()
          ? c.push(d)
          : c.push(h.getText());
      f.connection &&
        ((f = f.connection.targetBlock())
          ? c.push(f.toString(void 0, b))
          : c.push(d));
    }
  c = c.join(" ").trim() || "???";
...
Blockly.Block.prototype.jsonInit = function(a) {
  ...
  void 0 !== a.previousStatement &&
    this.setPreviousStatement(!0, a.previousStatement);
  ...
  void 0 !== a.enableContextMenu &&
    ((c = a.enableContextMenu), (this.contextMenu = !!c));
  void 0 !== a.helpUrl &&
    ((c = a.helpUrl),
    (c = Blockly.utils.replaceMessageReferences(c)),
    this.setHelpUrl(c));
  ...
  if (Array.isArray(a.extensions))
    for (a = a.extensions, b = 0; b < a.length; ++b)
...
Blockly.Block.prototype.interpolate_ = function(a, b, c) {
  ...
  for (var g = 0; g < d.length; g++) {
    ...
    if ("number" == typeof h) {
      if (0 >= h || h > b.length)
        throw Error(
          'Block "' + this.type + '": Message index %' + h + " out of range."
        );
      if (e[h])
        throw Error(
          'Block "' + this.type + '": Message index %' + h + " duplicated."
        );
      e[h] = !0;
      f++;
      a.push(b[h - 1]);
  ...
  a.length &&
    ("string" == typeof a[a.length - 1] ||
      Blockly.utils.string.startsWith(a[a.length - 1].type, "field_")) &&
    ((g = { type: "input_dummy" }), c && (g.align = c), a.push(g));
  c = {
...
Blockly.Block.prototype.moveInputBefore = function(a, b) {
  if (a != b) {
    for (
      var c = -1, d = b ? -1 : this.inputList.length, e = 0, f;
      (f = this.inputList[e]);
      e++
    )
      if (f.name == a) {
...
Blockly.Block.prototype.allInputsFilled = function(a) {
  ...
  for (var b = 0, c; (c = this.inputList[b]); b++)
    if (
      c.connection &&
      ((c = c.connection.targetBlock()), !c || !c.allInputsFilled(a))
    )
      return !1;
...
Blockly.BlockDragSurfaceSvg.prototype.clearAndHide = function(a) {
  a
    ? a.appendChild(this.getCurrentBlock())
...
Blockly.ContextMenu.populate_ = function(a, b) {
  ...
  for (var d = 0, e; (e = a[d]); d++) {
    ...
    e.enabled &&
      (goog.events.listen(f, goog.ui.Component.EventType.ACTION, e.callback),
      (f.handleContextMenu = function() {
...
Blockly.ContextMenu.blockDeleteOption = function(a) {
  ...
  return {
    text:
      1 == b
        ? Blockly.Msg.DELETE_BLOCK
        : Blockly.Msg.DELETE_X_BLOCKS.replace("%1", String(b)),
    enabled: !0,
    callback: function() {
      Blockly.Events.setGroup(!0);
      a.dispose(!0, !0);
...
Blockly.ContextMenu.workspaceCommentOption = function(a, b) {
  ...
  c.callback = function() {
    var c = new Blockly.WorkspaceCommentSvg(
        a,
...
Blockly.BlockSvg = function(a, b, c) {
  this.svgGroup_ = Blockly.utils.dom.createSvgElement("g", {}, null);
  this.svgGroup_.translate_ = "";
  this.svgPathDark_ = Blockly.utils.dom.createSvgElement(
    "path",
    { class: "blocklyPathDark", transform: "translate(1,1)" },
    this.svgGroup_
  );
  this.svgPath_ = Blockly.utils.dom.createSvgElement(
    "path",
    { class: "blocklyPath" },
    this.svgGroup_
  );
  this.svgPathLight_ = Blockly.utils.dom.createSvgElement(
    "path",
    ...
    if (!this.workspace.isClearing && c) {
      ...
      a
        ? (a.getSvgRoot().appendChild(c),
          ...
          this.moveConnections_(a.x - d.x, a.y - d.y))
        : b &&
          (this.workspace.getCanvas().appendChild(c), this.translate(d.x, d.y));
    }
  }
};
...
Blockly.BlockSvg.prototype.moveDuringDrag = function(a) {
  this.useDragSurface_
    ? this.workspace.blockDragSurface_.translateSurface(a.x, a.y)
    : ((this.svgGroup_.translate_ = "translate(" + a.x + "," + a.y + ")"),
      this.svgGroup_.setAttribute(
        "transform",
        this.svgGroup_.translate_ + this.svgGroup_.skew_
      ));
...
Blockly.BlockSvg.prototype.setCollapsed = function(a) {
  if (this.collapsed_ != a) {
    ...
    if (a) {
      ...
      this.appendDummyInput("_TEMP_COLLAPSED_INPUT")
        .appendField(c)
        .init();
      d = this.getDescendants(!0);
      if ((c = this.getNextBlock()))
        (c = d.indexOf(c)), d.splice(c, d.length - c);
      c = 1;
      for (var e; (e = d[c]); c++)
        if (e.warning) {
          this.setWarningText(
      ...
      this.removeInput("_TEMP_COLLAPSED_INPUT"),
        this.warning &&
          ...
          Object.keys(this.warning.text_).length || this.setWarningText(null));
...
Blockly.BlockSvg.prototype.tab = function(a, b) {
  ...
  -1 == d && (d = b ? -1 : c.length);
  (c = c[b ? d + 1 : d - 1])
    ? c instanceof Blockly.Field
      ? c.showEditor_()
      : c.tab(null, b)
    : (c = this.getParent()) && c.tab(this, b);
};
Blockly.BlockSvg.prototype.createTabList_ = function() {
  for (var a = [], b = 0, c; (c = this.inputList[b]); b++) {
    for (var d = 0, e; (e = c.fieldRow[d]); d++)
      e instanceof Blockly.FieldTextInput && a.push(e);
    c.connection && (c = c.connection.targetBlock()) && a.push(c);
  }
  return a;
};
...
Blockly.BlockSvg.prototype.generateContextMenu = function() {
  ...
  if (!this.isInFlyout) {
    this.isDeletable() &&
      this.isMovable() &&
      b.push(Blockly.ContextMenu.blockDuplicateOption(a));
    this.workspace.options.comments &&
      !this.collapsed_ &&
      this.isEditable() &&
      b.push(Blockly.ContextMenu.blockCommentOption(a));
    if (this.isMovable())
      if (this.collapsed_)
        this.workspace.options.collapse &&
          ((c = { enabled: !0 }),
          (c.text = Blockly.Msg.EXPAND_BLOCK),
          (c.callback = function() {
            a.setCollapsed(!1);
          }),
          b.push(c));
        ...
        for (var c = 1; c < this.inputList.length; c++)
          if (
            this.inputList[c - 1].type != Blockly.NEXT_STATEMENT &&
            this.inputList[c].type != Blockly.NEXT_STATEMENT
          ) {
            c = { enabled: !0 };
...
Blockly.BlockSvg.prototype.setDragging = function(a) {
  if (a) {
    ...
    b.translate_ = "";
    b.skew_ = "";
    Blockly.draggingConnections_ = Blockly.draggingConnections_.concat(
...
Blockly.BlockSvg.prototype.dispose = function(a, b) {
  if (this.workspace) {
    ...
    b &&
      this.rendered &&
      (this.unplug(a), Blockly.blockAnimations.disposeUiEffect(this));
    this.rendered = !1;
...
Blockly.BlockSvg.prototype.setBorderColour_ = function() {
  ...
  a.colourBorder
    ? ((this.svgPathLight_.style.display = "none"),
      ...
      this.svgPath_.setAttribute("stroke", a.colourBorder))
    : ((this.svgPathLight_.style.display = ""),
      (this.svgPathDark_.style.display = ""),
      this.svgPath_.setAttribute("stroke", "none"),
      this.svgPathLight_.setAttribute("stroke", a.colourLight),
      this.svgPathDark_.setAttribute("fill", a.colourDark));
};
...
Blockly.BlockSvg.prototype.updateDisabled = function() {
  !this.isEnabled() || this.getInheritedDisabled()
    ...
    : Blockly.utils.dom.removeClass(this.svgGroup_, "blocklyDisabled") &&
      this.updateColour();
  for (var a = this.getChildren(!1), b = 0, c; (c = a[b]); b++)
    c.updateDisabled();
};
...
Blockly.BlockSvg.prototype.setCommentText = function(a) {
  var b = !1;
  "string" == typeof a
    ? (this.comment || ((this.comment = new Blockly.Comment(this)), (b = !0)),
      this.comment.setText(a))
    : this.comment && (this.comment.dispose(), (b = !0));
...
Blockly.BlockSvg.prototype.setWarningText = function(a, b) {
  ...
  var c = b || "";
  if (c)
    this.warningTextDb_[c] &&
      (clearTimeout(this.warningTextDb_[c]), delete this.warningTextDb_[c]);
  else
  ...
  if (this.workspace.isDragging()) {
    ...
    d = !1;
    "string" == typeof a
      ? (this.warning || ((this.warning = new Blockly.Warning(this)), (d = !0)),
        this.warning.setText(a, c))
      : this.warning && !c
      ? (this.warning.dispose(), (d = !0))
      : this.warning &&
        ((d = this.warning.getText()),
...
Blockly.BlockSvg.prototype.setEnabled = function(a) {
  this.isEnabled() != a &&
    (Blockly.BlockSvg.superClass_.setEnabled.call(this, a),
  ...
  if (this.workspace && !this.workspace.isDragging()) {
    ...
    if (!a.isInFlyout)
      for (var b = this.getConnections_(!1), c = 0, d; (d = b[c]); c++) {
        ...
        for (
          var e = d.neighbours_(Blockly.SNAP_RADIUS), f = 0, g;
          (g = e[f]);
          f++
        )
          (d.isConnected() && g.isConnected()) ||
            (g.getSourceBlock().getRootBlock() != a &&
              (d.isSuperior() ? g.bumpAwayFrom_(d) : d.bumpAwayFrom_(g)));
      }
  }
};
...
Blockly.BlockSvg.START_HAT_PATH =
  "c 30,-" +
  Blockly.BlockSvg.START_HAT_HEIGHT +
  " 70,-" +
  Blockly.BlockSvg.START_HAT_HEIGHT +
  " 100,0";
...
Blockly.BlockSvg.DISTANCE_45_INSIDE =
  (1 - Math.SQRT1_2) * (Blockly.BlockSvg.CORNER_RADIUS - 0.5) + 0.5;
...
Blockly.BlockSvg.TAB_PATH_DOWN =
  "v 5 c 0,10 -" +
...
Blockly.BlockSvg.TAB_PATH_DOWN_HIGHLIGHT_RTL =
  "v 6.5 m -" +
  0.97 * Blockly.BlockSvg.TAB_WIDTH +
  ",3 q -" +
  0.05 * Blockly.BlockSvg.TAB_WIDTH +
  ",10 " +
  0.3 * Blockly.BlockSvg.TAB_WIDTH +
  ",9.5 m " +
  0.67 * Blockly.BlockSvg.TAB_WIDTH +
  ",-1.9 v 1.4";
...
Blockly.BlockSvg.INNER_TOP_LEFT_CORNER_HIGHLIGHT_RTL =
  ...
  "," +
  (Blockly.BlockSvg.CORNER_RADIUS - Blockly.BlockSvg.DISTANCE_45_OUTSIDE);
...
Blockly.BlockSvg.prototype.getHeightWidth = function() {
  ...
  c
    ...
    : this.nextConnection || this.outputConnection || (a += 2);
...
Blockly.BlockSvg.prototype.render = function(a) {
  ...
  !1 !== a &&
    ((a = this.getParent()) ? a.render(!0) : this.workspace.resizeContents());
  Blockly.Field.stopCache();
};
  ...
  for (var d = 0, e; (e = a[d]); d++) {
    ...
    if (f) {
      ...
      if (this.RTL) {
        ...
        (h = b + e.renderSep),
          e.renderWidth &&
            (b += e.renderSep + e.renderWidth + Blockly.BlockSvg.SEP_SPACE_X);
      this.RTL &&
        e instanceof Blockly.FieldImage &&
        e.getFlipRtl() &&
        ((g = "scale(-1 1)"), (h += e.renderWidth));
...
Blockly.BlockSvg.prototype.renderCompute_ = function(a) {
  ...
  for (
    var d = 0,
      ...
      h = !1,
      k = void 0,
      l = this.getInputsInline() && !this.isCollapsed(),
      n = 0,
      m;
    (m = b[n]);
    n++
    ...
    if (m.isVisible()) {
      if (
        l &&
        k &&
        k != Blockly.NEXT_STATEMENT &&
        m.type != Blockly.NEXT_STATEMENT
      )
        var p = c[c.length - 1];
      else
        (k = m.type),
          (p = []),
          (p.type =
            l && m.type != Blockly.NEXT_STATEMENT
      ...
      m.renderWidth =
        l && m.type == Blockly.INPUT_VALUE
          ? Blockly.BlockSvg.TAB_WIDTH + 1.25 * Blockly.BlockSvg.SEP_SPACE_X
          : 0;
      ...
      l || n != b.length - 1
        ? !l &&
          m.type == Blockly.INPUT_VALUE &&
          b[n + 1] &&
          b[n + 1].type == Blockly.NEXT_STATEMENT &&
          m.renderHeight--
        : m.renderHeight--;
      ...
      p.type != Blockly.BlockSvg.INLINE &&
        (p.type == Blockly.NEXT_STATEMENT
          ? ((g = !0), (e = Math.max(e, m.fieldWidth)))
          : (p.type == Blockly.INPUT_VALUE
              ? (f = !0)
              : p.type == Blockly.DUMMY_INPUT && (h = !0),
            (d = Math.max(d, m.fieldWidth))));
    }
  for (a = 0; (p = c[a]); a++)
  ...
  g &&
    (c.rightEdge = Math.max(
      c.rightEdge,
      c.statementEdge + Blockly.BlockSvg.NOTCH_WIDTH
    ));
  f
    ? (c.rightEdge = Math.max(
        c.rightEdge,
        d + 2 * Blockly.BlockSvg.SEP_SPACE_X + Blockly.BlockSvg.TAB_WIDTH
      ))
    : h &&
      (c.rightEdge = Math.max(
        c.rightEdge,
...
Blockly.BlockSvg.prototype.renderDraw_ = function(a, b) {
  ...
  if (this.outputConnection)
    ...
    this.previousConnection
      ? (c = this.previousConnection.targetBlock()) &&
        c.getNextBlock() == this &&
        (this.squareTopLeftCorner_ = !0)
      : c &&
        ((this.startHat_ = this.squareTopLeftCorner_ = !0),
...
Blockly.BlockSvg.prototype.renderDrawTop_ = function(a, b) {
  ...
  this.squareTopLeftCorner_
    ...
    : (c.push(Blockly.BlockSvg.TOP_LEFT_CORNER_START),
      ...
      c.push(Blockly.BlockSvg.TOP_LEFT_CORNER),
      d.push(Blockly.BlockSvg.TOP_LEFT_CORNER_HIGHLIGHT));
  this.previousConnection &&
    (c.push("H", Blockly.BlockSvg.NOTCH_WIDTH - 15),
    d.push("H", Blockly.BlockSvg.NOTCH_WIDTH - 15),
    c.push(Blockly.BlockSvg.NOTCH_PATH_LEFT),
    d.push(Blockly.BlockSvg.NOTCH_PATH_LEFT_HIGHLIGHT),
    this.previousConnection.setOffsetInBlock(
      this.RTL ? -Blockly.BlockSvg.NOTCH_WIDTH : Blockly.BlockSvg.NOTCH_WIDTH,
      0
    ));
  c.push("H", b);
  d.push("H", b - 0.5);
...
Blockly.BlockSvg.prototype.renderDrawRight_ = function(a, b, c) {
  for (var d = { x: 0, y: 0 }, e = { x: 0, y: 0 }, f = 0, g; (g = b[f]); f++)
    (d.x = Blockly.BlockSvg.SEP_SPACE_X),
      0 == f && (d.x += this.RTL ? -c : c),
      a.highlightSteps.push("M", b.rightEdge - 0.5 + "," + (d.y + 0.5)),
      this.isCollapsed()
        ? this.renderJaggedEdge_(a, g, d)
        : g.type == Blockly.BlockSvg.INLINE
        ? this.renderInlineRow_(a, g, d, e, b.rightEdge)
        : g.type == Blockly.INPUT_VALUE
        ? this.renderExternalValueInput_(a, g, d, e, b.rightEdge)
        : g.type == Blockly.DUMMY_INPUT
        ? this.renderDummyInput_(a, g, d, b.rightEdge, b.hasValue)
        : g.type == Blockly.NEXT_STATEMENT &&
          this.renderStatementInput_(a, g, d, e, b, f),
      (d.y += g.height);
  b.length ||
    ((d.y = Blockly.BlockSvg.MIN_BLOCK_Y),
    a.steps.push("V", d.y),
    this.RTL && a.highlightSteps.push("V", d.y - 1));
  return d.y;
};
Blockly.BlockSvg.prototype.renderDrawBottom_ = function(a, b) {
  ...
  this.nextConnection &&
    ...
    this.nextConnection.setOffsetInBlock(
      this.RTL ? -Blockly.BlockSvg.NOTCH_WIDTH : Blockly.BlockSvg.NOTCH_WIDTH,
      b + 1
    ),
    (this.height += 4));
  this.squareBottomLeftCorner_
    ? (c.push("H 0"), this.RTL || d.push("M", "0.5," + (b - 0.5)))
    : (c.push("H", Blockly.BlockSvg.CORNER_RADIUS),
      c.push(
        "a",
        Blockly.BlockSvg.CORNER_RADIUS +
          "," +
      ...
      this.RTL ||
        ...
        d.push(
          ...
          Blockly.BlockSvg.CORNER_RADIUS -
            ...
            (Blockly.BlockSvg.CORNER_RADIUS - 0.5) +
            " 0 0,1 0.5," +
            (b - Blockly.BlockSvg.CORNER_RADIUS)
        )));
};
Blockly.BlockSvg.prototype.renderDrawLeft_ = function(a) {
  ...
  this.outputConnection
    ? (this.outputConnection.setOffsetInBlock(0, 0),
      b.push("V", Blockly.BlockSvg.TAB_HEIGHT),
      b.push(
        "c 0,-10 -" +
          Blockly.BlockSvg.TAB_WIDTH +
          ",8 -" +
      ...
      this.RTL
        ? (a.push("M", -0.25 * Blockly.BlockSvg.TAB_WIDTH + ",8.4"),
          a.push("l", -0.45 * Blockly.BlockSvg.TAB_WIDTH + ",-2.1"))
        : (a.push("V", Blockly.BlockSvg.TAB_HEIGHT - 1.5),
          a.push(
            "m",
            -0.92 * Blockly.BlockSvg.TAB_WIDTH +
              ",-0.5 q " +
              -0.19 * Blockly.BlockSvg.TAB_WIDTH +
              ",-5.5 0,-11"
          ),
          a.push("m", 0.92 * Blockly.BlockSvg.TAB_WIDTH + ",1 V 0.5 H 1")),
      (this.width += Blockly.BlockSvg.TAB_WIDTH))
    : this.RTL ||
      (this.squareTopLeftCorner_
        ? a.push("V", 0.5)
        : a.push("V", Blockly.BlockSvg.CORNER_RADIUS));
  b.push("z");
};
Blockly.BlockSvg.prototype.renderJaggedEdge_ = function(a, b, c) {
  ...
  d.push("v", b);
  this.RTL &&
    (a.push("v 3.9 l 7.2,3.4 m -14.5,8.9 l 7.3,3.5"), a.push("v", b - 0.7));
...
Blockly.BlockSvg.prototype.renderInlineRow_ = function(a, b, c, d, e) {
  ...
  for (var k = 0, l; (l = b[k]); k++) {
    ...
    l.type != Blockly.DUMMY_INPUT &&
      (c.x += l.renderWidth + Blockly.BlockSvg.SEP_SPACE_X);
    l.type == Blockly.INPUT_VALUE &&
      ...
      f.push("h", Blockly.BlockSvg.TAB_WIDTH - 2 - l.renderWidth),
      f.push(Blockly.BlockSvg.TAB_PATH_DOWN),
      f.push("v", l.renderHeight + 1 - Blockly.BlockSvg.TAB_HEIGHT),
      ...
      this.RTL
        ? (g.push(
            ...
            c.x -
              ...
              l.renderWidth +
              "," +
              (c.y + Blockly.BlockSvg.INLINE_PADDING_Y + 0.5)
          ),
          g.push(Blockly.BlockSvg.TAB_PATH_DOWN_HIGHLIGHT_RTL),
          g.push("v", l.renderHeight - Blockly.BlockSvg.TAB_HEIGHT + 2.5),
          g.push("h", l.renderWidth - Blockly.BlockSvg.TAB_WIDTH + 2))
        : (g.push(
            "M",
            c.x -
              Blockly.BlockSvg.SEP_SPACE_X +
          ...
          g.push("v", l.renderHeight + 1),
          g.push("h", Blockly.BlockSvg.TAB_WIDTH - 2 - l.renderWidth),
          g.push(
            "M",
            c.x -
              l.renderWidth -
          ...
          g.push("l", 0.46 * Blockly.BlockSvg.TAB_WIDTH + ",-2.1")),
      (d.x = this.RTL
        ? -c.x -
          Blockly.BlockSvg.TAB_WIDTH +
          Blockly.BlockSvg.SEP_SPACE_X +
        ...
        : c.x +
          ...
          l.renderWidth -
          1),
      (d.y = c.y + Blockly.BlockSvg.INLINE_PADDING_Y + 1),
...
Blockly.BlockSvg.prototype.renderExternalValueInput_ = function(a, b, c, d, e) {
  ...
  if (g.align != Blockly.ALIGN_LEFT) {
    ...
    g.align == Blockly.ALIGN_RIGHT
      ? (h += l)
      : g.align == Blockly.ALIGN_CENTRE && (h += l / 2);
  }
  ...
  f.push("v", b);
  this.RTL
    ? (a.push(Blockly.BlockSvg.TAB_PATH_DOWN_HIGHLIGHT_RTL),
      a.push("v", b + 0.5))
    : (a.push("M", e - 5 + "," + (c.y + Blockly.BlockSvg.TAB_HEIGHT - 0.7)),
      a.push("l", 0.46 * Blockly.BlockSvg.TAB_WIDTH + ",-2.1"));
  d.x = this.RTL ? -e - 1 : e + 1;
  g.connection.setOffsetInBlock(d.x, c.y);
  g.connection.isConnected() &&
    (this.width = Math.max(
      this.width,
      e +
        g.connection.targetBlock().getHeightWidth().width -
        Blockly.BlockSvg.TAB_WIDTH +
        1
    ));
};
Blockly.BlockSvg.prototype.renderDummyInput_ = function(a, b, c, d, e) {
  ...
  var g = b[0],
    h = c.x;
  c = c.y;
  g.align != Blockly.ALIGN_LEFT &&
    ((d = d - g.fieldWidth - 2 * Blockly.BlockSvg.SEP_SPACE_X),
    e && (d -= Blockly.BlockSvg.TAB_WIDTH),
    g.align == Blockly.ALIGN_RIGHT
      ? (h += d)
      : g.align == Blockly.ALIGN_CENTRE && (h += d / 2));
...
Blockly.BlockSvg.prototype.renderStatementInput_ = function(a, b, c, d, e, f) {
  ...
  var h = b[0];
  0 == f &&
    (g.push("v", Blockly.BlockSvg.SEP_SPACE_Y),
    this.RTL && a.push("v", Blockly.BlockSvg.SEP_SPACE_Y - 1),
    (c.y += Blockly.BlockSvg.SEP_SPACE_Y));
  var k = c.x,
    l = c.y;
  if (h.align != Blockly.ALIGN_LEFT) {
    var n = e.statementEdge - h.fieldWidth - 2 * Blockly.BlockSvg.SEP_SPACE_X;
    h.align == Blockly.ALIGN_RIGHT
      ? (k += n)
      : h.align == Blockly.ALIGN_CENTRE && (k += n / 2);
  }
  ...
  this.RTL
    ? (a.push(
        ...
        c.x -
          ...
          Blockly.BlockSvg.DISTANCE_45_OUTSIDE +
          "," +
          (c.y + Blockly.BlockSvg.DISTANCE_45_OUTSIDE)
      ),
      a.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER_HIGHLIGHT_RTL),
      a.push("v", b.height - 2 * Blockly.BlockSvg.CORNER_RADIUS),
      a.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_RTL))
    : (a.push(
        "M",
        c.x -
          Blockly.BlockSvg.NOTCH_WIDTH +
          Blockly.BlockSvg.DISTANCE_45_OUTSIDE +
          "," +
          (c.y + b.height - Blockly.BlockSvg.DISTANCE_45_OUTSIDE)
      ),
      a.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_LTR));
  a.push("H", e.rightEdge - 0.5);
  d.x = this.RTL ? -c.x : c.x + 1;
  h.connection.setOffsetInBlock(d.x, c.y + 1);
  h.connection.isConnected() &&
    (this.width = Math.max(
      this.width,
      e.statementEdge + h.connection.targetBlock().getHeightWidth().width
    ));
  if (f == e.length - 1 || e[f + 1].type == Blockly.NEXT_STATEMENT)
    g.push("v", Blockly.BlockSvg.SEP_SPACE_Y),
      this.RTL && a.push("v", Blockly.BlockSvg.SEP_SPACE_Y - 1),
      (c.y += Blockly.BlockSvg.SEP_SPACE_Y);
};
Blockly.BlockSvg.prototype.positionNewBlock = function(a, b, c) {
  (b.type != Blockly.NEXT_STATEMENT && b.type != Blockly.INPUT_VALUE) ||
    a.moveBy(c.x_ - b.x_, c.y_ - b.y_);
};
Blockly.BlockSvg.prototype.highlightForReplacement = function(a) {
  a
    ? Blockly.utils.dom.addClass(this.svgGroup_, "blocklyReplaceable")
    : Blockly.utils.dom.removeClass(this.svgGroup_, "blocklyReplaceable");
};
...
Blockly.DropDownDiv.showPositionedByField = function(a, b, c) {
  ...
  Blockly.DropDownDiv.setBoundsElement(
    a.getSourceBlock().workspace.getParentSvg().parentNode
  );
...
Blockly.DropDownDiv.show = function(a, b, c, d, e, f) {
  ...
  Blockly.DropDownDiv.arrow_.style.transform =
    "translate(" + a.arrowX + "px," + a.arrowY + "px) rotate(45deg)";
...
Blockly.DropDownDiv.getPositionMetrics = function(a, b, c, d) {
  ...
  if (b + f.height > e.bottom)
    if (d - f.height < e.top) {
      ...
      (a = c), (c = d - f.height - Blockly.DropDownDiv.PADDING_Y), (g = !0);
...
Blockly.DropDownDiv.hideIfOwner = function(a) {
  return Blockly.DropDownDiv.owner_ === a
    ? (Blockly.DropDownDiv.hide(), !0)
    : !1;
};
...
Blockly.DropDownDiv.repositionForWindowResize = function() {
  if (Blockly.DropDownDiv.owner_) {
    var a = Blockly.DropDownDiv.owner_.getSourceBlock(),
      b = a.workspace.scale,
      c = Blockly.DropDownDiv.positionToField_
        ? Blockly.DropDownDiv.owner_.size_.width
        : a.width,
      d = Blockly.DropDownDiv.positionToField_
        ? Blockly.DropDownDiv.owner_.size_.height
        : a.height;
    c *= b;
    d *= b;
    a = Blockly.DropDownDiv.positionToField_
      ? Blockly.DropDownDiv.owner_.fieldGroup_.getBoundingClientRect()
      : a.getSvgRoot().getBoundingClientRect();
    c = a.left + c / 2;
...
Blockly.FieldTextInput.prototype.bindInputEvents_ = function(a) {
  ...
  this.onKeyUpWrapper_ = Blockly.bindEventWithChecks_(
    a,
    "keyup",
    this,
    this.onHtmlInputChange_
  );
  this.onKeyPressWrapper_ = Blockly.bindEventWithChecks_(
    a,
    "keypress",
    this,
    this.onHtmlInputChange_
...
Blockly.FieldTextInput.prototype.onHtmlInputChange_ = function(a) {
  ...
  a !== this.htmlInput_.oldValue_ &&
    ((this.htmlInput_.oldValue_ = a),
    Blockly.Events.setGroup(!0),
    this.setValue(a),
...
Blockly.FieldTextInput.prototype.resizeEditor_ = function() {
  ...
  b = new Blockly.utils.Coordinate(
    this.sourceBlock_.RTL ? b.right - a.offsetWidth : b.left,
    b.top
  );
  b.y += 1;
  Blockly.utils.userAgent.GECKO &&
...
Blockly.FieldTextInput.nonnegativeIntegerValidator = function(a) {
  (a = Blockly.FieldTextInput.numberValidator(a)) &&
    (a = String(Math.max(0, Math.floor(a))));
  return a;
};
...
Blockly.FieldAngle.prototype.dropdownCreate_ = function() {
  var a = Blockly.utils.dom.createSvgElement(
      "svg",
      {
        xmlns: Blockly.utils.dom.SVG_NS,
        "xmlns:html": Blockly.utils.dom.HTML_NS,
...
Blockly.FieldAngle.prototype.onMouseMove = function(a) {
  ...
  a = Math.atan(-b / c);
  isNaN(a) ||
    ((a = Blockly.utils.math.toDegrees(a)),
    0 > c ? (a += 180) : 0 < b && (a += 360),
    (a = Blockly.FieldAngle.CLOCKWISE
      ? Blockly.FieldAngle.OFFSET + 360 - a
      : 360 - (Blockly.FieldAngle.OFFSET - a)),
    360 < a && (a -= 360),
    Blockly.FieldAngle.ROUND &&
      (a = Math.round(a / Blockly.FieldAngle.ROUND) * Blockly.FieldAngle.ROUND),
    a > Blockly.FieldAngle.WRAP && (a -= 360),
    (c = String(a)),
    c != this.text_ &&
      ((this.htmlInput_.value = a),
      this.setValue(a),
      (this.text_ = c),
      this.forceRerender()));
};
  ...
  if (this.gauge_) {
    ...
    if (!isNaN(b)) {
      ...
      a.push(
        ...
        b,
        " ",
        Number(Blockly.FieldAngle.CLOCKWISE),
        " ",
        c,
        ",",
        d,
...
Blockly.utils.colour.parse = function(a) {
  ...
  return c &&
    ...
    (b = Number(c[2])),
    (c = Number(c[3])),
    0 <= a && 256 > a && 0 <= b && 256 > b && 0 <= c && 256 > c)
    ? Blockly.utils.colour.rgbToHex(a, b, c)
    : null;
};
Blockly.utils.colour.rgbToHex = function(a, b, c) {
  b = (a << 16) | (b << 8) | c;
  return 16 > a
    ? "#" + (16777216 | b).toString(16).substr(1)
    : "#" + b.toString(16);
};
...
Blockly.FieldColour.prototype.showEditor_ = function() {
  ...
  Blockly.DropDownDiv.setColour(
    this.DROPDOWN_BACKGROUND_COLOUR,
    this.DROPDOWN_BORDER_COLOUR
  );
  Blockly.DropDownDiv.showPositionedByField(
    this,
    this.dropdownDispose_.bind(this)
...
Blockly.FieldDropdown.prototype.getAnchorDimensions_ = function() {
  ...
  this.sourceBlock_.RTL
    ? (a.right += Blockly.FieldDropdown.CHECKMARK_OVERHANG)
    : (a.left -= Blockly.FieldDropdown.CHECKMARK_OVERHANG);
  return a;
};
...
Blockly.FieldDropdown.prototype.trimOptions_ = function() {
  ...
  if (Array.isArray(a)) {
    for (var b = !1, c = 0; c < a.length; c++) {
      var d = a[c][0];
      "string" == typeof d
        ? (a[c][0] = Blockly.utils.replaceMessageReferences(d))
        : (null != d.alt &&
            (a[c][0].alt = Blockly.utils.replaceMessageReferences(d.alt)),
          (b = !0));
    }
    if (!(b || 2 > a.length)) {
      b = [];
...
Blockly.FieldDropdown.prototype.doClassValidation_ = function(a) {
  for (var b = !1, c = this.getOptions(), d = 0, e; (e = c[d]); d++)
    if (e[1] == a) {
      b = !0;
      break;
    }
...
Blockly.FieldDropdown.prototype.doValueUpdate_ = function(a) {
  ...
  for (var b = 0, c; (c = a[b]); b++)
    c[1] == this.value_ &&
      ((c = c[0]),
      "object" == typeof c
        ? ((this.imageJson_ = c), (this.text_ = c.alt))
        : ((this.imageJson_ = null), (this.text_ = c)));
};
...
Blockly.FieldDropdown.prototype.renderSelectedImage_ = function() {
  ...
  this.sourceBlock_.RTL
    ? (this.imageElement_.setAttribute("x", a),
...
Blockly.FieldImage = function(a, b, c, d, e, f) {
  ...
  if (0 >= this.height_ || 0 >= this.width_)
    throw Error(
...
Blockly.FieldImage.prototype.initView = function() {
  this.imageElement_ = Blockly.utils.dom.createSvgElement(
    "image",
    { height: this.height_ + "px", width: this.width_ + "px", alt: this.text_ },
    this.fieldGroup_
  );
  this.imageElement_.setAttributeNS(
    Blockly.utils.dom.XLINK_NS,
...
Blockly.FieldImage.prototype.setText = function(a) {
  null !== a &&
    ((this.text_ = a),
    this.imageElement_ && this.imageElement_.setAttribute("alt", a || ""));
};
...
Blockly.FieldNumber.prototype.doClassValidation_ = function(a) {
  ...
  return (a =
    -1 == this.fractionalDigits_
      ? a
      : Number(a.toFixed(this.fractionalDigits_)));
};
...
Blockly.FieldVariable.prototype.initModel = function() {
  if (!this.variable_) {
    var a = Blockly.Variables.getOrCreateVariablePackage(
      this.workspace_,
      null,
...
Blockly.FieldVariable.prototype.doClassValidation_ = function(a) {
  ...
  b = b.type;
  return this.typeIsAllowed_(b)
    ? a
    : (console.warn("Variable type doesn't match this field!  Type was " + b),
      null);
};
...
Blockly.FieldVariable.prototype.setTypes_ = function(a, b) {
  ...
  if (null == a || void 0 == a) var d = null;
    ...
    if (!e)
      throw Error(
        "Invalid default type '" + c + "' in the definition of a FieldVariable"
      );
  } else
    throw Error(
...
Blockly.FieldVariable.dropdownCreate = function() {
  ...
  Blockly.Msg.DELETE_VARIABLE &&
    c.push([
      Blockly.Msg.DELETE_VARIABLE.replace("%1", a),
...
Blockly.Generator.prototype.statementToCode = function(a, b) {
  ...
  if ("string" != typeof d)
    throw TypeError("Expecting code from statement block: " + (c && c.type));
...
Blockly.Generator.prototype.addLoopTrap = function(a, b) {
  this.INFINITE_LOOP_TRAP &&
    (a =
      this.prefixLines(this.injectId(this.INFINITE_LOOP_TRAP, b), this.INDENT) +
      a);
  this.STATEMENT_SUFFIX &&
    !b.suppressPrefixSuffix &&
    (a =
      this.prefixLines(this.injectId(this.STATEMENT_SUFFIX, b), this.INDENT) +
      a);
  this.STATEMENT_PREFIX &&
    !b.suppressPrefixSuffix &&
    (a += this.prefixLines(
...
Blockly.Names.prototype.getNameForUserVariable_ = function(a) {
  return this.variableMap_
    ? (a = this.variableMap_.getVariableById(a))
      ? a.name
      : null
    : (console.log(
...
Blockly.Names.prototype.getName = function(a, b) {
  ...
  var d =
    ...
    b == Blockly.Names.DEVELOPER_VARIABLE_TYPE
...
Blockly.Names.prototype.getDistinctName = function(a, b) {
  for (
    var c = this.safeName_(a), d = "";
    this.dbReverse_[c + d] || c + d in this.reservedDict_;
...
Blockly.Procedures.mutateCallers = function(a) {
  ...
  for (var e; (e = a[c]); c++) {
    ...
    f != g &&
      ((Blockly.Events.recordUndo = !1),
      Blockly.Events.fire(
        new Blockly.Events.BlockChange(e, "mutation", null, f, g)
      ),
...
Blockly.Flyout.prototype.show = function(a) {
  ...
  for (
    var d = this.horizontalLayout_ ? this.GAP_X : this.GAP_Y, e = 0, f;
    (f = a[e]);
    e++
  )
    if (f.tagName)
  ...
  this.listeners_.push(
    Blockly.bindEventWithChecks_(
      ...
      function() {
        for (
          var a = this.workspace_.getTopBlocks(!1), b = 0, c;
          (c = a[b]);
          b++
        )
          c.removeSelect();
...
Blockly.Flyout.prototype.clearOldBlocks_ = function() {
  ...
  for (b = 0; b < this.mats_.length; b++)
    (a = this.mats_[b]) && Blockly.utils.dom.removeNode(a);
...
Blockly.Flyout.prototype.addBlockListeners_ = function(a, b, c) {
  this.listeners_.push(
    Blockly.bindEventWithChecks_(a, "mousedown", null, this.blockMouseDown_(b))
  );
  this.listeners_.push(
    Blockly.bindEventWithChecks_(c, "mousedown", null, this.blockMouseDown_(b))
  );
...
Blockly.Flyout.prototype.createBlock = function(a) {
  ...
  if (Blockly.Events.isEnabled())
    for (
      Blockly.Events.setGroup(!0),
        Blockly.Events.fire(new Blockly.Events.Create(b)),
        c = 0;
      c < a.length;
      c++
    )
...
Blockly.Flyout.prototype.initFlyoutButton_ = function(a, b, c) {
  ...
  a.show();
  this.listeners_.push(
    Blockly.bindEventWithChecks_(d, "mousedown", this, this.onMouseDown_)
  );
...
Blockly.Flyout.prototype.createRect_ = function(a, b, c, d, e) {
  b = Blockly.utils.dom.createSvgElement(
    "rect",
    { "fill-opacity": 0, x: b, y: c, height: d.height, width: d.width },
    null
  );
  b.tooltip = a;
...
Blockly.Flyout.prototype.filterForCapacity_ = function() {
  for (var a = this.workspace_.getTopBlocks(!1), b = 0, c; (c = a[b]); b++)
    if (-1 == this.permanentlyDisabled_.indexOf(c))
      for (
        var d = this.targetWorkspace_.isCapacityAvailable(
          Blockly.utils.getBlockTypeCounts(c)
        );
        c;
  ...
  if (this.isVisible()) {
    ...
    a &&
      ...
      this.setBackgroundPath_(
        a.viewWidth - 2 * this.CORNER_RADIUS,
      ...
      this.positionAt_(
        ...
        this.targetWorkspace_.toolboxPosition == this.toolboxPosition_
          ? a.toolboxHeight
            ? this.toolboxPosition_ == Blockly.TOOLBOX_AT_TOP
              ? a.toolboxHeight
              : a.viewHeight - this.height_
            : this.toolboxPosition_ == Blockly.TOOLBOX_AT_TOP
            ? 0
            : a.viewHeight
          : this.toolboxPosition_ == Blockly.TOOLBOX_AT_TOP
          ? 0
          : a.viewHeight + a.absoluteTop - this.height_
      ));
  }
};
...
Blockly.HorizontalFlyout.prototype.wheel_ = function(a) {
  ...
  c &&
    ((b = this.getMetrics_()),
    (c = b.viewLeft + c),
    (c = Math.min(c, b.contentWidth - b.viewWidth)),
    (c = Math.max(c, 0)),
    this.scrollbar_.set(c),
    Blockly.WidgetDiv.hide());
  a.preventDefault();
  a.stopPropagation();
};
Blockly.HorizontalFlyout.prototype.layout_ = function(a, b) {
  ...
  for (var e = 0, f; (f = a[e]); e++)
    if ("block" == f.type) {
      ...
      "button" == f.type &&
        (this.initFlyoutButton_(f.button, d, c), (d += f.button.width + b[e]));
};
...
Blockly.HorizontalFlyout.prototype.getClientRect = function() {
  ...
  return this.toolboxPosition_ == Blockly.TOOLBOX_AT_TOP
    ? new Blockly.utils.Rect(-1e9, b + a.height, -1e9, 1e9)
    : new Blockly.utils.Rect(b, -1e9, -1e9, 1e9);
};
Blockly.HorizontalFlyout.prototype.reflowInternal_ = function() {
  this.workspace_.scale = this.targetWorkspace_.scale;
  for (
    var a = 0, b = this.workspace_.getTopBlocks(!1), c = 0, d;
    (d = b[c]);
    c++
  )
...
Blockly.VerticalFlyout.prototype.setMetrics_ = function(a) {
  ...
  b &&
    ("number" == typeof a.y &&
      (this.workspace_.scrollY = -b.contentHeight * a.y),
    this.workspace_.translate(
      this.workspace_.scrollX + b.absoluteLeft,
      this.workspace_.scrollY + b.absoluteTop
    ));
  ...
  if (this.isVisible()) {
    ...
    a &&
      ...
      this.setBackgroundPath_(
        ...
        a.viewHeight - 2 * this.CORNER_RADIUS
      ),
      this.positionAt_(
        this.width_,
        this.height_,
        this.targetWorkspace_.toolboxPosition == this.toolboxPosition_
          ? a.toolboxWidth
            ? this.toolboxPosition_ == Blockly.TOOLBOX_AT_LEFT
              ? a.toolboxWidth
              : a.viewWidth - this.width_
            : this.toolboxPosition_ == Blockly.TOOLBOX_AT_LEFT
            ? 0
            : a.viewWidth
          : this.toolboxPosition_ == Blockly.TOOLBOX_AT_LEFT
          ? 0
          : a.viewWidth + a.absoluteLeft - this.width_,
        0
      ));
  }
};
...
Blockly.VerticalFlyout.prototype.layout_ = function(a, b) {
  ...
  for (
    ...
    if ("block" == f.type) {
      ...
      "button" == f.type &&
        (this.initFlyoutButton_(f.button, d, c), (c += f.button.height + b[e]));
};
...
Blockly.VerticalFlyout.prototype.getClientRect = function() {
  ...
  if (this.toolboxPosition_ == Blockly.TOOLBOX_AT_LEFT)
    return new Blockly.utils.Rect(-1e9, 1e9, -1e9, b + a.width);
  Blockly.utils.userAgent.GECKO &&
    this.targetWorkspace_ &&
    this.targetWorkspace_.isMutator &&
    ((a = this.targetWorkspace_.svgGroup_.getBoundingClientRect().x),
    10 > Math.abs(a - b) &&
      (b +=
        this.leftEdge_ * this.targetWorkspace_.options.parentWorkspace.scale));
...
Blockly.Toolbox = function(a) {
  ...
  this.horizontalLayout_ &&
    ((this.config_.cssTreeRow += a.RTL
      ? " blocklyHorizontalTreeRtl"
      : " blocklyHorizontalTree"),
    (this.treeSeparatorConfig_.cssTreeRow =
      "blocklyTreeSeparatorHorizontal " +
      (a.RTL ? "blocklyHorizontalTreeRtl" : "blocklyHorizontalTree")),
...
Blockly.Toolbox.prototype.init = function() {
  ...
  Blockly.bindEventWithChecks_(
    ...
    this,
    function(a) {
      Blockly.utils.isRightButton(a) || a.target == this.HtmlDiv
        ? Blockly.hideChaff(!1)
        : Blockly.hideChaff(!0);
      Blockly.Touch.clearTouchIdentifier();
    },
  ...
  this.flyout_ = null;
  this.flyout_ = a.horizontalLayout
    ? new Blockly.HorizontalFlyout(b)
    : new Blockly.VerticalFlyout(b);
  Blockly.utils.dom.insertAfter(
    this.flyout_.createDom("svg"),
  ...
  this.config_.cssCollapsedFolderIcon =
    "blocklyTreeIconClosed" + (a.RTL ? "Rtl" : "Ltr");
      ...
      switch (g.tagName.toUpperCase()) {
        case "CATEGORY":
          ...
          l && k
            ...
            : k
            ? this.setColourFromStyle_(k, h, e)
            : this.setColour_(l, h, e);
          "true" == g.getAttribute("expanded")
            ? (h.blocks.length && (d = h), h.setExpanded(!0))
            : h.setExpanded(!1);
          e = g;
          break;
        case "SEP":
...
Blockly.Toolbox.prototype.setColour_ = function(a, b, c) {
  ...
  if (null === a || "" === a) b.hexColour = "";
    ...
    var d = Number(a);
    isNaN(d)
      ? (d = Blockly.utils.colour.parse(a))
        ? ((b.hexColour = d), (this.hasColours_ = !0))
        : ((b.hexColour = ""),
          console.warn(
            'Toolbox category "' +
              c +
      ...
      : ((b.hexColour = Blockly.hueToHex(d)), (this.hasColours_ = !0));
  }
};
...
Blockly.Toolbox.prototype.updateColourFromTheme_ = function(a) {
  if ((a = a || this.tree_)) {
    ...
    for (var b = 0, c; (c = a[b]); b++)
      c.styleName &&
        (this.setColourFromStyle_(c.styleName, c, ""), this.addColour_()),
        this.updateColourFromTheme_(c);
  }
};
...
Blockly.Toolbox.prototype.addColour_ = function(a) {
  ...
  for (var b = 0, c; (c = a[b]); b++) {
    ...
    if (d) {
      var e = this.hasColours_
        ? "8px solid " + (c.hexColour || "#ddd")
        : "none";
      this.workspace_.RTL
        ? (d.style.borderRight = e)
        : (d.style.borderLeft = e);
    }
    this.addColour_(c);
  }
};
...
Blockly.Toolbox.prototype.getClientRect = function() {
  ...
  var a = this.HtmlDiv.getBoundingClientRect(),
    ...
    d = a.left;
  a = d + a.width;
  return this.toolboxPosition == Blockly.TOOLBOX_AT_TOP
    ? new Blockly.utils.Rect(-1e7, c, -1e7, 1e7)
    : this.toolboxPosition == Blockly.TOOLBOX_AT_BOTTOM
    ? new Blockly.utils.Rect(b, 1e7, -1e7, 1e7)
    : this.toolboxPosition == Blockly.TOOLBOX_AT_LEFT
    ? new Blockly.utils.Rect(-1e7, 1e7, -1e7, a)
    : new Blockly.utils.Rect(-1e7, 1e7, d, 1e7);
};
...
Blockly.Toolbox.TreeControl.prototype.handleTouchEvent_ = function(a) {
  var b = this.getNodeFromEvent_(a);
  b &&
    a.type === goog.events.EventType.TOUCHEND &&
    setTimeout(function() {
      b.onClick_(a);
    }, 1);
};
...
Blockly.Toolbox.TreeControl.prototype.setSelectedItem = function(a) {
  ...
  if (a != this.selectedItem_ && a != b.tree_) {
    b.lastCategory_ &&
      (b.lastCategory_.getRowElement().style.backgroundColor = "");
    if (a) {
    ...
    a && a.blocks && a.blocks.length
      ? (b.flyout_.show(a.blocks),
        b.lastCategory_ != a && b.flyout_.scrollToStart())
      : b.flyout_.hide();
    c != a &&
      c != this &&
      ((c = new Blockly.Events.Ui(
        null,
        "category",
        c && c.getHtml(),
        a && a.getHtml()
...
Blockly.Toolbox.TreeNode.prototype.onClick_ = function(a) {
  this.hasChildren() && this.isUserCollapsible_
...
Blockly.Css.inject = function(a, b) {
  if (!Blockly.Css.injected_) {
    ...
    a &&
      ((c += Blockly.Css.CONTENT.join("\n")),
      (Blockly.Css.CONTENT = null),
...
Blockly.WidgetDiv.positionWithAnchor = function(a, b, c, d) {
  ...
  0 > e
    ? Blockly.WidgetDiv.positionInternal_(a, 0, c.height + e)
...
Blockly.createDom_ = function(a, b) {
  ...
  var c = Blockly.utils.dom.createSvgElement(
    ...
    f = Blockly.utils.dom.createSvgElement(
      "filter",
  ...
  var g = Blockly.utils.dom.createSvgElement(
    "feSpecularLighting",
    {
      in: "blur",
      surfaceScale: 1,
...
Blockly.createMainWorkspace_ = function(a, b, c, d) {
  ...
  !b.hasCategories &&
    b.languageTree &&
    ((c = e.addFlyout_("svg")), Blockly.utils.dom.insertAfter(c, a));
  ...
  b.readOnly ||
    ...
    e.addChangeListener(function(a) {
      if (
        !e.isDragging() &&
        !e.isMovable() &&
        -1 != Blockly.Events.BUMP_EVENTS.indexOf(a.type)
      ) {
        ...
        e.isContentBounded()
          ? ((c = e.getBlocksBoundingBox()),
            (b.contentLeft = c.left),
            (b.contentTop = c.top),
            (b.contentRight = c.right),
            (b.contentBottom = c.bottom))
          : ((b.contentLeft = c.contentLeft / d),
            (b.contentTop = c.contentTop / d),
            (b.contentRight = (c.contentLeft + c.contentWidth) / d),
            (b.contentBottom = (c.contentTop + c.contentHeight) / d));
        if (
          b.contentTop < b.viewTop ||
          b.contentBottom > b.viewBottom ||
          b.contentLeft < b.viewLeft ||
          b.contentRight > b.viewRight
        ) {
          c = null;
          a &&
            ((c = Blockly.Events.getGroup()), Blockly.Events.setGroup(a.group));
          switch (a.type) {
...
Blockly.init_ = function(a) {
  ...
  b.moveOptions && b.moveOptions.scrollbars
    ? ((a.scrollbar = new Blockly.ScrollbarPair(a)), a.scrollbar.resize())
...
Blockly.svgSize = function(a) {
  return { width: a.cachedWidth_, height: a.cachedHeight_ };
};
...
Blockly.svgResize = function(a) {
  ...
  if (c) {
    ...
    b.cachedHeight_ != c &&
      (b.setAttribute("height", c + "px"), (b.cachedHeight_ = c));
    a.resize();
  }
};
      ...
      Blockly.selected &&
        ...
        (67 == a.keyCode
          ...
          : 88 != a.keyCode ||
            ...
            (Blockly.copy_(Blockly.selected), (c = !0)));
      86 == a.keyCode
        ? Blockly.clipboardXml_ &&
          ((a = Blockly.clipboardSource_),
          a.isFlyout && (a = a.targetWorkspace),
          Blockly.clipboardTypeCounts_ &&
            a.isCapacityAvailable(Blockly.clipboardTypeCounts_) &&
            (Blockly.Events.setGroup(!0),
            a.paste(Blockly.clipboardXml_),
            Blockly.Events.setGroup(!1)))
        : 90 == a.keyCode && (Blockly.hideChaff(), b.undo(a.shiftKey));
    }
    c &&
      !Blockly.selected.workspace.isFlyout &&
      (Blockly.Events.setGroup(!0),
...
Blockly.copy_ = function(a) {
  ...
  Blockly.clipboardTypeCounts_ = a.isComment
    ? null
    : Blockly.utils.getBlockTypeCounts(a, !0);
};
...
Blockly.hideChaff = function(a) {
  ...
  a ||
    (b.toolbox_ &&
      b.toolbox_.flyout_ &&
      b.toolbox_.flyout_.autoClose &&
      b.toolbox_.clearSelection());
};
    ...
    if (c) {
      ...
      null == d || "" === d
        ...
        : (Blockly.Blocks[d] &&
          ...
          (Blockly.Blocks[d] = { init: Blockly.jsonInitFactory_(c) }));
    } else
      console.warn(
...
Blockly.bindEventWithChecks_ = function(a, b, c, d, e, f) {
  ...
  if (Blockly.utils.global.PointerEvent && b in Blockly.Touch.TOUCH_MAP)
    for (var l = 0, n; (n = Blockly.Touch.TOUCH_MAP[b][l]); l++)
      a.addEventListener(n, h, !1), k.push([a, n, h]);
  else if (
    ...
    for (l = 0; (n = Blockly.Touch.TOUCH_MAP[b][l]); l++)
      a.addEventListener(n, m, !1), k.push([a, n, m]);
  }
  return k;
};
...
Blockly.refreshTheme_ = function(a) {
  Blockly.updateBlockStyles_(
    a.getAllBlocks().filter(function(a) {
      return void 0 !== a.getStyleName();
    })
  );
  !a.toolbox_ && a.flyout_ && a.flyout_.workspace_
    ? Blockly.updateBlockStyles_(a.flyout_.workspace_.getAllBlocks())
