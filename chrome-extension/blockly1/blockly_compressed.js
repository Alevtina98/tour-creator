...
goog.loadModule = function (a) {
    ...
    try {
        ...
        if (goog.isString(d) && d) goog.moduleLoaderState_.declareLegacyNamespace ? goog.constructNamespace_(d,
...
goog.dom.safe.setLinkHrefAndRel = function (a, b, c) {
    ...
    a.rel = c;
    goog.string.internal.caseInsensitiveContains(c, "stylesheet") ? (goog.asserts.assert(b instanceof goog.html.TrustedResourceUrl, 'URL must be TrustedResourceUrl because "rel" contains "stylesheet"'), a.href = goog.html.TrustedResourceUrl.unwrapTrustedURL(b)) : a.href = b instanceof goog.html.TrustedResourceUrl ? goog.html.TrustedResourceUrl.unwrapTrustedURL(b) : b instanceof goog.html.SafeUrl ? goog.html.SafeUrl.unwrapTrustedURL(b) :
        goog.html.SafeUrl.unwrapTrustedURL(goog.html.SafeUrl.sanitizeAssertUnchanged(b))
};
...
goog.dom.safe.openInWindow = function (a, b, c, d, e) {
    ...
    return (b || window).open(goog.html.SafeUrl.unwrapTrustedURL(a), c ? goog.string.Const.unwrap(c) : "", d, e)
};
...
goog.events.KeyCodes.firesKeyPressEvent = function (a, b, c, d, e, f) {
    ...
    if (!goog.userAgent.GECKO) {
        ...
        if ((!c || goog.userAgent.MAC) && g ||
            goog.userAgent.MAC && h) return !1
    }
...
goog.ui.ContainerRenderer.prototype.getClassNames = function (a) {
    var b = this.getCssClass(), c = a.getOrientation() == goog.ui.Container.Orientation.HORIZONTAL;
...
goog.ui.ControlRenderer.prototype.decorate = function (a, b) {
    ...
    var d = 0, e = this.getCssClass(), f = this.getStructuralCssClass(), g = !1, h = !1, k = !1,
...
goog.ui.Control.IeMouseEventSequenceSimulator_.prototype.handleClick_ = function (a) {
    if (this.clickExpected_) this.clickExpected_ = !1; else {
        var b = a.getBrowserEvent(), c = b.button, d = b.type,
...
goog.ui.Container.prototype.handleChildMouseEvents = function (a) {
    var b = goog.ui.ComponentUtil.getMouseEventType(this), c = this.getOwnerControl(a.target);
    if (c) switch (a.type) {
        case b.MOUSEDOWN:
            c.handleMouseDown(a);
            break;
...
goog.ui.MenuItem.prototype.getCaption = function () {
    var a = this.getContent();
    if (goog.isArray(a)) {
        var b = goog.ui.MenuItem.ACCELERATOR_CLASS, c = goog.ui.MenuItem.MNEMONIC_WRAPPER_CLASS_;
...
goog.ui.MenuItem.prototype.getAccelerator = function () {
    var a = this.getDomHelper(), b = this.getContent();
...
goog.ui.tree.BaseNode.prototype.initAccessibility = function () {
    ...
    if (a) {
        ...
        if (b = this.getChildrenElement()) if (goog.a11y.aria.setRole(b,
            "group"), b.hasChildNodes()) for (goog.a11y.aria.setState(a, goog.a11y.aria.State.EXPANDED, !1), a = this.getChildCount(), b = 1; b <= a; b++) {
...
goog.ui.tree.BaseNode.prototype.addChildAt = function (a, b, c) {
    ...
    if (b = this.getElement()) if (this.updateExpandIcon(), goog.a11y.aria.setState(b,
    ...
    if (!b || this.dispatchEvent(a ? goog.ui.tree.BaseNode.EventType.BEFORE_EXPAND : goog.ui.tree.BaseNode.EventType.BEFORE_COLLAPSE)) {
        ...
        if (this.hasChildren()) {
            if (!a && c && this.contains(c.getSelectedItem()) && this.select(), d) {
                if (c = this.getChildrenElement()) if (goog.style.setElementShown(c, a), goog.a11y.aria.setState(d, goog.a11y.aria.State.EXPANDED, a), a && this.isInDocument() &&
                !c.hasChildNodes()) {
                    var e = [];
                    this.forEachChild(function (a) {
                        e.push(a.toSafeHtml())
...
goog.ui.tree.BaseNode.prototype.getIconSafeHtml = function () {
    return goog.html.SafeHtml.create("span", {style: {display: "inline-block"}, "class": this.getCalculatedIconClass()})
};
...
goog.ui.tree.BaseNode.prototype.getExpandIconClass = function () {
    var a = this.getTree(), b = !a.getShowLines() || a == this.getParent() && !a.getShowRootLines(), c = this.config_,
...
goog.ui.tree.BaseNode.prototype.getLineStyle = function () {
    ...
    return goog.html.SafeStyle.create({"background-position": this.getBackgroundPosition(), display: a ? null : "none"})
};
...
goog.ui.tree.TreeNode.prototype.getCalculatedIconClass = function () {
    var a = this.getExpanded(), b = this.getExpandedIconClass();
    if (a && b) return b;
    b = this.getIconClass();
    if (!a && b) return b;
    b = this.getConfig();
...
Blockly.utils.removeNode = function (a) {
    return a && a.parentNode ? a.parentNode.removeChild(a) : null
};
...
Blockly.utils.getRelativeXY = function (a) {
    var b = new goog.math.Coordinate(0, 0), c = a.getAttribute("x");
    c && (b.x = parseInt(c, 10));
...
Blockly.utils.checkMessageReferences = function (a) {
    for (var b = !0, c = Blockly.Msg, d = /%{(BKY_[A-Z][A-Z0-9_]*)}/gi, e = d.exec(a); e;) {
        var f = e[1];
        f = f.toUpperCase();
...
Blockly.utils.tokenizeInterpolation_ = function (a, b) {
    ...
    for (var e = 0, f = [], g = null, h = 0; h < d.length; h++) {
        ...
        0 == e ? "%" == k ? ((k = f.join("")) && c.push(k), f.length = 0, e = 1) : f.push(k) : 1 == e ? "%" == k ? (f.push(k), e = 0) : b && "0" <= k && "9" >= k ? (e = 2, g = k, (k = f.join("")) && c.push(k), f.length = 0) : "{" == k ? e = 3 : (f.push("%", k), e = 0) : 2 == e ? "0" <= k && "9" >= k ? g += k : (c.push(parseInt(g, 10)), h--, e = 0) : 3 == e && ("" == k ? (f.splice(0, 0, "%{"), h--, e = 0) : "}" != k ? f.push(k) : (e = f.join(""), /[a-zA-Z][a-zA-Z0-9_]*/.test(e) ? (k = e.toUpperCase(),
            (k = Blockly.utils.startsWith(k, "BKY_") ? k.substring(4) : null) && k in Blockly.Msg ? (e = Blockly.Msg[k], "string" == typeof e ? Array.prototype.push.apply(c, Blockly.utils.tokenizeInterpolation_(e, b)) : b ? c.push(String(e)) : c.push(e)) : c.push("%{" + e + "}")) : c.push("%{" + e + "}"), e = f.length = 0))
    }
    (k = f.join("")) && c.push(k);
    d = [];
...
Blockly.utils.wrapMutate_ = function (a, b, c) {
    for (var d = Blockly.utils.wrapScore_(a, b, c), e, f = 0; f < b.length - 1; f++) if (b[f] != b[f + 1]) {
        var g = [].concat(b);
        g[f] = !g[f];
        g[f + 1] = !g[f + 1];
...
Blockly.utils.is3dSupported = function () {
    ...
    var a = document.createElement("p"), b = "none", c = {
...
Blockly.utils.insertAfter = function (a, b) {
...
Blockly.utils.getViewportBBox = function () {
    var a = goog.dom.getViewportSize(), b = goog.style.getViewportPageOffset(document);
    return {right: a.width + b.x, bottom: a.height + b.y, top: b.y, left: b.x}
};
Blockly.utils.startsWith = function (a, b) {
    return 0 == a.lastIndexOf(b, 0)
};
...
Blockly.utils.toRadians = function (a) {
    return a * Math.PI / 180
};
Blockly.utils.toDegrees = function (a) {
    return 180 * a / Math.PI
};
Blockly.utils.containsNode = function (a, b) {
    return !!(a.compareDocumentPosition(b) & Node.DOCUMENT_POSITION_CONTAINED_BY)
};
Blockly.utils.getBlockTypeCounts = function (a, b) {
    var c = Object.create(null), d = a.getDescendants(!0);
    if (b) {
...
Blockly.utils.clampNumber = function (a, b, c) {
    if (c < a) {
        var d = c;
        c = a;
        a = d
...
Blockly.Touch.setClientFromTouch = function (a) {
    if (Blockly.utils.startsWith(a.type, "touch")) {
...
Blockly.Touch.isMouseOrTouchEvent = function (a) {
    return Blockly.utils.startsWith(a.type, "touch") || Blockly.utils.startsWith(a.type, "mouse") || Blockly.utils.startsWith(a.type, "pointer")
};
Blockly.Touch.isTouchEvent = function (a) {
    return Blockly.utils.startsWith(a.type, "touch") || Blockly.utils.startsWith(a.type, "pointer")
};
...
Blockly.Events.filter = function (a, b) {
    ...
    for (var d = [], e = Object.create(null), f = 0, g; g = c[f]; f++) if (!g.isNull()) {
        var h = [g.type, g.blockId, g.workspaceId].join(" "), k = e[h], l = k ? k.event : null;
        if (!k) e[h] = {
            event: g,
            index: f
        }, d.push(g); else if (g.type == Blockly.Events.MOVE && k.index == f - 1) l.newParentId = g.newParentId, l.newInputName = g.newInputName, l.newCoordinate = g.newCoordinate, k.index = f; else if (g.type == Blockly.Events.CHANGE && g.element == l.element && g.name == l.name) l.newValue = g.newValue; else if (g.type !=
            Blockly.Events.UI || "click" != g.element || "commentOpen" != l.element && "mutatorOpen" != l.element && "warningOpen" != l.element) e[h] = {
            event: g,
            index: 1
        }, d.push(g)
    }
...
Blockly.Events.disableOrphans = function (a) {
    if (a.type == Blockly.Events.MOVE || a.type == Blockly.Events.CREATE) {
        ...
        if (a = b.getBlockById(a.blockId)) if (a.getParent() && !a.getParent().disabled) {
            b = a.getDescendants(!1);
            a = 0;
...
Blockly.VariableMap.prototype.renameVariable = function (a, b) {
    var c = this.getVariable(b, a.type), d = this.workspace.getAllBlocks(!1);
...
Blockly.VariableMap.prototype.deleteVariableById = function (a) {
    ...
    if (b) {
        var c = b.name, d = this.getVariableUsesById(a);
        a = 0;
...
Blockly.Xml = {};
Blockly.Xml.utils = {};
Blockly.Xml.utils.createElement = function (a) {
    return document.createElement(a)
};
Blockly.Xml.utils.createTextNode = function (a) {
    return document.createTextNode(a)
};
Blockly.Xml.utils.textToDomDocument = function (a) {
    return (new DOMParser).parseFromString(a, "text/xml")
};
Blockly.Xml.utils.domToText = function (a) {
...
Blockly.Events.Create.prototype.run = function (a) {
    var b = this.getEventWorkspace_();
    if (a) a = Blockly.Xml.utils.createElement("xml"), a.appendChild(this.xml), Blockly.Xml.domToWorkspace(a, b); else {
        a = 0;
...
Blockly.Events.Delete.prototype.run = function (a) {
    ...
    } else a = Blockly.Xml.utils.createElement("xml"), a.appendChild(this.oldXml), Blockly.Xml.domToWorkspace(a, b)
};
...
Blockly.Events.Move.prototype.currentLocation_ = function () {
    var a = Blockly.Workspace.getById(this.workspaceId).getBlockById(this.blockId), b = {}, c = a.getParent();
    if (c) {
...
Blockly.Events.Move.prototype.run = function (a) {
    var b = this.getEventWorkspace_(), c = b.getBlockById(this.blockId);
    if (c) {
...
Blockly.Xml.workspaceToDom = function (a, b) {
    var c = Blockly.Xml.utils.createElement("xml"),
...
Blockly.Xml.variablesToDom = function (a) {
    for (var b = Blockly.Xml.utils.createElement("variables"), c = 0, d; d = a[c]; c++) {
        var e = Blockly.Xml.utils.createElement("variable");
        e.appendChild(Blockly.Xml.utils.createTextNode(d.name));
...
Blockly.Xml.fieldToDomVariable_ = function (a) {
    ...
    var c = Blockly.Xml.utils.createElement("field");
    c.appendChild(Blockly.Xml.utils.createTextNode(b.name));
...
Blockly.Xml.fieldToDom_ = function (a) {
    if (a.name && a.EDITABLE) {
        if (a.referencesVariables()) return Blockly.Xml.fieldToDomVariable_(a);
        var b = Blockly.Xml.utils.createElement("field");
        b.appendChild(Blockly.Xml.utils.createTextNode(a.getValue()));
...
Blockly.Xml.blockToDom = function (a, b) {
    var c = Blockly.Xml.utils.createElement(a.isShadow() ? "shadow" : "block");
    ...
    e && (d = Blockly.Xml.utils.createElement("comment"), d.appendChild(Blockly.Xml.utils.createTextNode(e)), "object" == typeof a.comment && (d.setAttribute("pinned", a.comment.isVisible()),
        e = a.comment.getBubbleSize(), d.setAttribute("h", e.height), d.setAttribute("w", e.width)), c.appendChild(d));
    a.data && (d = Blockly.Xml.utils.createElement("data"), d.appendChild(Blockly.Xml.utils.createTextNode(a.data)), c.appendChild(d));
    e = 0;
    for (var f; f = a.inputList[e]; e++) {
        var g, h = !0;
        if (f.type != Blockly.DUMMY_INPUT) {
            var k = f.connection.targetBlock();
            f.type == Blockly.INPUT_VALUE ? g = Blockly.Xml.utils.createElement("value") : f.type == Blockly.NEXT_STATEMENT && (g = Blockly.Xml.utils.createElement("statement"));
    ...
    if (e = a.getNextBlock()) g = Blockly.Xml.utils.createElement("next"), g.appendChild(Blockly.Xml.blockToDom(e, b)), c.appendChild(g);
...
Blockly.Xml.cloneShadow_ = function (a) {
    for (var b = a = a.cloneNode(!0), c; b;) if (b.firstChild) b = b.firstChild; else {
        for (; b && !b.nextSibling;) c = b, b = b.parentNode, 3 == c.nodeType && "" == c.data.trim() && b.firstChild != c && Blockly.utils.removeNode(c);
        b && (c = b, b = b.nextSibling, 3 == c.nodeType && "" == c.data.trim() && Blockly.utils.removeNode(c))
    }
    return a
};
Blockly.Xml.domToText = function (a) {
    return Blockly.Xml.utils.domToText(a)
};
...
Blockly.Xml.textToDom = function (a) {
    a = Blockly.Xml.utils.textToDomDocument(a);
    if (!a || !a.documentElement || "xml" != a.documentElement.nodeName.toLowerCase()) throw TypeError("Blockly.Xml.textToDom expected an <xml> document.");
...
Blockly.Xml.domToWorkspace = function (a, b) {
    ...
    var e = a.childNodes.length, f = Blockly.Events.getGroup();
    f || Blockly.Events.setGroup(!0);
    b.setResizesEnabled && b.setResizesEnabled(!1);
    var g = !0;
    try {
        for (var h = 0; h < e; h++) {
            var k = a.childNodes[h], l = k.nodeName.toLowerCase();
...
Blockly.Xml.appendDomToWorkspace = function (a, b) {
    ...
    if (d && d.height) {
        ...
        b.RTL && (l = b.getWidth());
        for (d = 0; d <
        c.length; d++) b.getBlockById(c[d]).moveBy(b.RTL ? l - f : f, e)
    }
    return c
};
Blockly.Xml.domToBlock = function (a, b) {
    ...
    c = b.getAllVariables();
    try {
        var d = Blockly.Xml.domToBlockHeadless_(a, b), e = d.getDescendants(!1);
        if (b.rendered) {
...
Blockly.Xml.domToVariables = function (a, b) {
    for (var c = 0, d; d = a.childNodes[c]; c++) if (d.nodeType == Element.ELEMENT_NODE) {
...
Blockly.Xml.domToBlockHeadless_ = function (a, b) {
    ...
    (e = a.getAttribute("disabled")) && c.setDisabled("true" == e || "disabled" == e);
...
Blockly.Xml.domToField_ = function (a, b, c) {
    var d = a.getField(b);
    d ? (a = a.workspace, b = c.textContent, d.referencesVariables() ? Blockly.Xml.domToFieldVariable_(a, c, b, d) : d.setValue(b)) : console.warn("Ignoring non-existent field " + b + " in block " + a.type)
};
...
Blockly.Events.CommentCreateDeleteHelper = function (a, b) {
    ...
    if (b) {
        var d = Blockly.Xml.utils.createElement("xml");
        d.appendChild(a.xml);
...
Blockly.Events.CommentMove.prototype.fromJson = function (a) {
    ...
    a.newCoordinate && (a = a.newCoordinate.split(","), this.newCoordinate_ = new goog.math.Coordinate(parseFloat(a[0]), parseFloat(a[1])))
};
...
Blockly.WorkspaceComment.prototype.toXml = function (a) {
    var b = Blockly.Xml.utils.createElement("comment");
    a || b.setAttribute("id", this.id);
...
Blockly.WorkspaceComment.fromXml = function (a, b) {
    ...
    var d = parseInt(a.getAttribute("x"), 10), e = parseInt(a.getAttribute("y"), 10);
...
Blockly.WorkspaceComment.parseAttributes = function (a) {
    var b = a.getAttribute("h"), c = a.getAttribute("w");
    return {
...
Blockly.Workspace.prototype.sortObjects_ = function (a, b) {
    var c = a.getRelativeToSurfaceXY(), d = b.getRelativeToSurfaceXY();
...
Blockly.Workspace.prototype.getTopBlocks = function (a) {
    ...
    a && 1 < b.length && (this.sortObjects_.offset = Math.sin(Blockly.utils.toRadians(Blockly.Workspace.SCAN_ANGLE)), this.RTL && (this.sortObjects_.offset *= -1), b.sort(this.sortObjects_));
    return b
};
...
Blockly.Workspace.prototype.getBlocksByType = function (a, b) {
    ...
    b && 1 < c.length && (this.sortObjects_.offset = Math.sign(Blockly.utils.toRadians(Blockly.Workspace.SCAN_ANGLE)), this.RTL && (this.sortObjects_.offset *= -1), c.sort(this.sortObjects_));
    return c
};
...
Blockly.Workspace.prototype.undo = function (a) {
    var b = a ? this.redoStack_ : this.undoStack_, c = a ? this.undoStack_ : this.redoStack_, d = b.pop();
    if (d) {
...
Blockly.Bubble = function (a, b, c, d, e, f) {
    ...
    this.arrow_radians_ = Blockly.utils.toRadians(c);
...
Blockly.Bubble.prototype.layoutBubble_ = function () {
    ...
    var b = this.getOptimalRelativeLeft_(a), c = this.getOptimalRelativeTop_(a), d = this.shape_.getBBox(),
        e = {x: b, y: -this.height_ - Blockly.BlockSvg.MIN_BLOCK_Y}, f = {x: -this.width_ - 30, y: c};
    c = {x: d.width, y: c};
...
Blockly.Bubble.prototype.getOptimalRelativeLeft_ = function (a) {
    ...
    if (this.workspace_.RTL) var c = this.anchorXY_.x - b, d = c - this.width_, e = a.viewLeft + a.viewWidth,
...
Blockly.Bubble.prototype.getOptimalRelativeTop_ = function (a) {
    ...
    var c = this.anchorXY_.y + b, d = c + this.height_, e = a.viewTop;
...
Blockly.Bubble.prototype.renderArrow_ = function () {
    ...
    if (b == d && c == e) a.push("M " + b + "," + c); else {
        ...
        var k = Math.sin(h), l = Math.cos(h), n = this.getBubbleSize();
...
Blockly.Icon.prototype.createIcon = function () {
    this.iconGroup_ || (this.iconGroup_ = Blockly.utils.createSvgElement("g", {"class": "blocklyIconGroup"}, null), this.block_.isInFlyout && Blockly.utils.addClass(this.iconGroup_, "blocklyIconGroupReadonly"), this.drawIcon_(this.iconGroup_), this.block_.getSvgRoot().appendChild(this.iconGroup_), Blockly.bindEventWithChecks_(this.iconGroup_, "mouseup", this, this.iconClick_), this.updateEditable())
};
...
Blockly.Icon.prototype.computeIconLocation = function () {
    var a = this.block_.getRelativeToSurfaceXY(), b = Blockly.utils.getRelativeXY(this.iconGroup_);
...
Blockly.Comment.prototype.drawIcon_ = function (a) {
    Blockly.utils.createSvgElement("circle", {"class": "blocklyIconShape", r: "8", cx: "8", cy: "8"}, a);
...
Blockly.Comment.prototype.setVisible = function (a) {
    if (a != this.isVisible()) if (Blockly.Events.fire(new Blockly.Events.Ui(this.block_, "commentOpen", !a, a)), !this.block_.isEditable() && !this.textarea_ || goog.userAgent.IE) Blockly.Warning.prototype.setVisible.call(this, a); else {
        var b = this.getText(), c = this.getBubbleSize();
        a ? (this.bubble_ = new Blockly.Bubble(this.block_.workspace, this.createEditor_(), this.block_.svgPath_, this.iconXY_, this.width_, this.height_), this.bubble_.setSvgId(this.block_.id), this.bubble_.registerResizeEvent(this.resizeBubble_.bind(this)),
...
Blockly.Connection.prototype.connect_ = function (a) {
    var b = this, c = b.getSourceBlock(), d = a.getSourceBlock();
    a.isConnected() && a.disconnect();
    if (b.isConnected()) {
        var e = b.targetBlock(), f = b.getShadowDom();
        b.setShadowDom(null);
...
Blockly.Connection.prototype.respawnShadow_ = function () {
    var a = this.getSourceBlock(), b = this.getShadowDom();
...
Blockly.Connection.prototype.toString = function () {
    ...
    if (a) if (a.outputConnection == this) var b = "Output Connection of "; else if (a.previousConnection == this) b = "Previous Connection of "; else if (a.nextConnection == this) b = "Next Connection of "; else {
        b = null;
...
Blockly.BlockAnimations.disposeUiStep_ = function (a, b, c, d) {
    ...
    1 < e ? Blockly.utils.removeNode(a) : (a.setAttribute("transform", "translate(" + (a.translateX_ + (b ? -1 : 1) * a.bBox_.width * d / 2 * e) + "," + (a.translateY_ + a.bBox_.height * d * e) + ") scale(" + (1 - e) * d + ")"), setTimeout(Blockly.BlockAnimations.disposeUiStep_, 10, a, b, c, d))
};
Blockly.BlockAnimations.connectionUiEffect = function (a) {
    var b = a.workspace, c = b.scale;
...
Blockly.BlockAnimations.connectionUiStep_ = function (a, b, c) {
    ...
    1 < d ? Blockly.utils.removeNode(a) : (a.setAttribute("r", 25 * d * c), a.style.opacity = 1 - d, Blockly.BlockAnimations.disconnectPid_ = setTimeout(Blockly.BlockAnimations.connectionUiStep_, 10, a, b, c))
};
...
Blockly.RenderedConnection.prototype.bumpAwayFrom_ = function (a) {
    if (!this.sourceBlock_.workspace.isDragging()) {
        ...
        if (!b.isInFlyout) {
            ...
            c && (f = -f);
            b.RTL &&
            (e = a.x_ - Blockly.SNAP_RADIUS - Math.floor(Math.random() * Blockly.BUMP_RANDOMNESS) - this.x_);
            b.moveBy(e, f);
            d || b.removeSelect()
        }
    }
...
Blockly.RenderedConnection.prototype.tighten_ = function () {
    var a = this.targetConnection.x_ - this.x_, b = this.targetConnection.y_ - this.y_;
    if (0 != a || 0 != b) {
...
Blockly.InsertionMarkerManager.prototype.initAvailableConnections_ = function () {
    var a = this.topBlock_.getConnections_(!1), b = this.topBlock_.lastConnectionInStack();
...
Blockly.InsertionMarkerManager.prototype.shouldUpdatePreviews_ = function (a, b) {
    var c = a.local, d = a.closest, e = a.radius;
    if (c && d) {
...
Blockly.InsertionMarkerManager.prototype.getCandidate_ = function (a) {
    for (var b = this.getStartRadius_(), c = null, d = null, e = 0; e < this.availableConnections_.length; e++) {
        var f = this.availableConnections_[e], g = f.closest(b, a);
...
Blockly.InsertionMarkerManager.prototype.shouldReplace_ = function () {
    var a = this.closestConnection_, b = this.localConnection_;
...
Blockly.InsertionMarkerManager.prototype.disconnectMarker_ = function () {
    if (this.markerConnection_) {
        var a = this.markerConnection_, b = a.sourceBlock_, c = b.nextConnection, d = b.previousConnection,
        ...
        if (a.targetConnection) throw"markerConnection_ still connected at the end of disconnectInsertionMarker";
        this.markerConnection_ = null;
...
Blockly.InsertionMarkerManager.prototype.connectMarker_ = function () {
    var a = this.localConnection_, b = this.closestConnection_,
        c = this.lastOnStack_ && a == this.lastOnStack_ ? this.lastMarker_ : this.firstMarker_;
    a = c.getMatchingConnection(a.sourceBlock_, a);
    goog.asserts.assert(a != this.markerConnection_, "Made it to connectMarker_ even though the marker isn't changing");
    c.render();
    c.rendered = !0;
...
Blockly.BlockDragger.prototype.startBlockDrag = function (a, b) {
    ...
    if (this.draggingBlock_.getParent() || b && this.draggingBlock_.nextConnection && this.draggingBlock_.nextConnection.targetBlock()) {
        ...
        c = goog.math.Coordinate.sum(this.startXY_,
            c);
...
Blockly.WorkspaceCommentSvg = function (a, b, c, d, e) {
    this.svgGroup_ = Blockly.utils.createSvgElement("g", {"class": "blocklyComment"}, null);
...
Blockly.WorkspaceCommentSvg.prototype.getRelativeToSurfaceXY = function () {
    var a = 0, b = 0, c = this.useDragSurface_ ? this.workspace.blockDragSurface_.getGroup() : null,
        d = this.getSvgRoot();
    if (d) {
        do {
    ...
    return this.xy_ = new goog.math.Coordinate(a, b)
};
Blockly.WorkspaceCommentSvg.prototype.moveBy = function (a, b) {
    var c = new Blockly.Events.CommentMove(this), d = this.getRelativeToSurfaceXY();
    this.translate(d.x + a, d.y + b);
    this.xy_ = new goog.math.Coordinate(d.x + a, d.y + b);
    c.recordNew();
    Blockly.Events.fire(c);
    this.workspace.resizeContents()
};
Blockly.WorkspaceCommentSvg.prototype.translate = function (a, b) {
    this.xy_ = new goog.math.Coordinate(a, b);
...
Blockly.WorkspaceCommentSvg.prototype.getBoundingRectangle = function () {
    var a = this.getRelativeToSurfaceXY(), b = this.getHeightWidth();
    if (this.RTL) {
        var c = new goog.math.Coordinate(a.x - b.width, a.y);
        a = new goog.math.Coordinate(a.x, a.y + b.height)
    } else c = new goog.math.Coordinate(a.x, a.y), a = new goog.math.Coordinate(a.x + b.width, a.y + b.height);
    return {topLeft: c, bottomRight: a}
};
...
Blockly.WorkspaceCommentSvg.prototype.setDragging = function (a) {
    a ? (a = this.getSvgRoot(), a.translate_ = "", a.skew_ = "", Blockly.utils.addClass(this.svgGroup_, "blocklyDragging")) : Blockly.utils.removeClass(this.svgGroup_, "blocklyDragging")
};
...
Blockly.WorkspaceDragger.prototype.drag = function (a) {
    a = goog.math.Coordinate.sum(this.startScrollXY_, a);
...
Blockly.Tooltip.onMouseOver_ = function (a) {
    if (!Blockly.Tooltip.blocked_) {
        for (a = a.target; "string" != typeof a.tooltip && "function" != typeof a.tooltip;) a = a.tooltip;
...
Blockly.Tooltip.onMouseMove_ = function (a) {
    if (Blockly.Tooltip.element_ && Blockly.Tooltip.element_.tooltip && !Blockly.WidgetDiv.isVisible() && !Blockly.Tooltip.blocked_) if (Blockly.Tooltip.visible) {
...
Blockly.Grid.prototype.update = function (a) {
    ...
    var c = b - this.length_ / 2, d = b + this.length_ / 2;
    b *= a;
    c *= a;
    d *= a;
...
Blockly.Grid.createDom = function (a, b, c) {
    a = Blockly.utils.createSvgElement("pattern", {id: "blocklyGridPattern" + a, patternUnits: "userSpaceOnUse"}, c);
    0 < b.length && 0 < b.spacing ? (Blockly.utils.createSvgElement("line", {stroke: b.colour}, a), 1 < b.length && Blockly.utils.createSvgElement("line", {stroke: b.colour}, a)) : Blockly.utils.createSvgElement("line", {}, a);
    return a
};
...
Blockly.Options = function (a) {
    var b = !!a.readOnly;
    if (b) var c = null, d = !1, e = !1, f = !1, g = !1, h = !1, k = !1; else {
    ...
    var n = !!a.rtl, m = a.horizontalLayout;
    void 0 === m && (m = !1);
    var p = a.toolboxPosition;
    p = "end" === p ? !1 : !0;
    p = m ?
        p ? Blockly.TOOLBOX_AT_TOP : Blockly.TOOLBOX_AT_BOTTOM : p == n ? Blockly.TOOLBOX_AT_RIGHT : Blockly.TOOLBOX_AT_LEFT;
    var r = a.css;
    void 0 === r && (r = !0);
    var t = "https://blockly-demo.appspot.com/static/media/";
    a.media ? t = a.media : a.path && (t = a.path + "media/");
    var q = void 0 === a.oneBasedIndex ? !0 : !!a.oneBasedIndex, u = a.theme || Blockly.Themes.Classic;
    this.RTL = n;
...
Blockly.ScrollbarPair = function (a) {
    ...
    Blockly.utils.insertAfter(this.corner_, a.getBubbleCanvas())
};
...
Blockly.Scrollbar.prototype.createDom_ = function (a) {
    ...
    a && (b += " " + a);
    this.outerSvg_ = Blockly.utils.createSvgElement("svg", {"class": b}, null);
...
Blockly.Scrollbar.prototype.onMouseDownBar_ = function (a) {
    ...
    if (Blockly.utils.isRightButton(a)) a.stopPropagation(); else {
        ...
        var d = this.handlePosition_, e = .95 * this.handleLength_;
...
Blockly.TouchGesture.prototype.handleTouchStart = function (a) {
    ...
    2 == b.length && (this.startDistance_ = goog.math.Coordinate.distance(this.cachedPoints_[b[0]], this.cachedPoints_[b[1]]), this.isMultiTouch_ = !0, a.preventDefault())
};
Blockly.TouchGesture.prototype.handleTouchMove = function (a) {
    ...
    b = Object.keys(this.cachedPoints_);
    if (2 == b.length) {
        b = this.touchScale_ = goog.math.Coordinate.distance(this.cachedPoints_[b[0]], this.cachedPoints_[b[1]]) / this.startDistance_;
        if (0 < this.previousScale_ && Infinity > this.previousScale_) {
            ...
            var d =
                this.startWorkspace_, e = Blockly.utils.mouseToSvg(a, d.getParentSvg(), d.getInverseScreenCTM());
            d.zoom(e.x, e.y, c)
        }
...
Blockly.TouchGesture.prototype.getTouchPoint = function (a) {
    return this.startWorkspace_ ? new goog.math.Coordinate(a.pageX ? a.pageX : a.changedTouches[0].pageX, a.pageY ? a.pageY : a.changedTouches[0].pageY) : null
};
Blockly.Trashcan = function (a) {
    ...
    }, this.workspace_.horizontalLayout ? (a.toolboxPosition = this.workspace_.toolboxPosition == Blockly.TOOLBOX_AT_TOP ? Blockly.TOOLBOX_AT_BOTTOM : Blockly.TOOLBOX_AT_TOP, this.flyout_ = new Blockly.HorizontalFlyout(a)) :
        (a.toolboxPosition = this.workspace_.toolboxPosition == Blockly.TOOLBOX_AT_RIGHT ? Blockly.TOOLBOX_AT_LEFT : Blockly.TOOLBOX_AT_RIGHT, this.flyout_ = new Blockly.VerticalFlyout(a)), this.workspace_.addChangeListener(this.onDelete_()))
};
...
Blockly.Trashcan.prototype.createDom = function () {
    ...
    var b = Blockly.utils.createSvgElement("clipPath", {id: "blocklyTrashBodyClipPath" + a}, this.svgGroup_);
    Blockly.utils.createSvgElement("rect", {width: this.WIDTH_, height: this.BODY_HEIGHT_, y: this.LID_HEIGHT_}, b);
    var c = Blockly.utils.createSvgElement("image", {
        width: Blockly.SPRITE.width, x: -this.SPRITE_LEFT_, height: Blockly.SPRITE.height, y: -this.SPRITE_TOP_,
        "clip-path": "url(#blocklyTrashBodyClipPath" + a + ")"
    }, this.svgGroup_);
    c.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", this.workspace_.options.pathToMedia + Blockly.SPRITE.url);
    b = Blockly.utils.createSvgElement("clipPath", {id: "blocklyTrashLidClipPath" + a}, this.svgGroup_);
    Blockly.utils.createSvgElement("rect", {width: this.WIDTH_, height: this.LID_HEIGHT_}, b);
...
Blockly.Trashcan.prototype.init = function (a) {
    0 < this.workspace_.options.maxTrashcanContents && (Blockly.utils.insertAfter(this.flyout_.createDom("svg"), this.workspace_.getParentSvg()), this.flyout_.init(this.workspace_), this.flyout_.isBlockCreatable_ = function () {
        return !0
    });
...
Blockly.Trashcan.prototype.dispose = function () {
    this.svgGroup_ && (Blockly.utils.removeNode(this.svgGroup_), this.svgGroup_ = null);
...
Blockly.Trashcan.prototype.click = function () {
    if (this.hasBlocks_) {
        for (var a = [], b = 0, c; c = this.contents_[b]; b++) a[b] = Blockly.Xml.textToDom(c).firstChild;
        this.flyout_.show(a)
    }
};
...
Blockly.Trashcan.prototype.cleanBlockXML_ = function (a) {
    ...
    return "<xml>" + Blockly.Xml.domToText(a) + "</xml>"
};
...
Blockly.Variables.flyoutCategoryBlocks = function (a) {
    ...
    var b = [];
    if (0 < a.length) {
        var c = Blockly.Variables.generateVariableFieldXmlString(a[a.length - 1]);
        if (Blockly.Blocks.variables_set) {
            var d = Blockly.Blocks.math_change ? 8 : 24;
            d = Blockly.Xml.textToDom('<xml><block type="variables_set" gap="' + d + '">' + c + "</block></xml>").firstChild;
            b.push(d)
        }
        Blockly.Blocks.math_change && (d = Blockly.Blocks.variables_get ? 20 : 8, d = Blockly.Xml.textToDom('<xml><block type="math_change" gap="' + d + '">' + c + '<value name="DELTA"><shadow type="math_number"><field name="NUM">1</field></shadow></value></block></xml>').firstChild,
            b.push(d));
        if (Blockly.Blocks.variables_get) for (a.sort(Blockly.VariableModel.compareByName), c = 0; d = a[c]; c++) d = '<xml><block type="variables_get" gap="8">' + Blockly.Variables.generateVariableFieldXmlString(d) + "</block></xml>", d = Blockly.Xml.textToDom(d).firstChild, b.push(d)
    }
    return b
};
...
Blockly.Variables.generateVariableFieldXmlString = function (a) {
    var b = a.type;
    "" == b && (b = "''");
...
Blockly.Variables.generateVariableFieldDom = function (a) {
    a = Blockly.Variables.generateVariableFieldXmlString(a);
    return Blockly.Xml.textToDom("<xml>" + a + "</xml>").firstChild
};
...
Blockly.VariablesDynamic.flyoutCategoryBlocks = function (a) {
    ...
    if (0 < a.length) {
        if (Blockly.Blocks.variables_set_dynamic) {
            var c = '<xml><block type="variables_set_dynamic" gap="24">' + Blockly.Variables.generateVariableFieldXmlString(a[a.length - 1]) + "</block></xml>";
            c = Blockly.Xml.textToDom(c).firstChild;
            b.push(c)
        }
        if (Blockly.Blocks.variables_get_dynamic) {
            a.sort(Blockly.VariableModel.compareByName);
            for (var d = 0; c = a[d]; d++) c = '<xml><block type="variables_get_dynamic" gap="8">' + Blockly.Variables.generateVariableFieldXmlString(c) +
...
Blockly.WorkspaceCommentSvg.prototype.render = function () {
    if (!this.rendered_) {
        ...
        this.isDeletable() && (Blockly.bindEventWithChecks_(this.deleteGroup_, "mousedown", this, this.deleteMouseDown_), Blockly.bindEventWithChecks_(this.deleteGroup_, "mouseout", this, this.deleteMouseOut_), Blockly.bindEventWithChecks_(this.deleteGroup_,
...
Blockly.WorkspaceCommentSvg.prototype.addResizeDom_ = function () {
    this.resizeGroup_ = Blockly.utils.createSvgElement("g", {"class": this.RTL ? "blocklyResizeSW" : "blocklyResizeSE"}, this.svgGroup_);
    var a = Blockly.WorkspaceCommentSvg.RESIZE_SIZE;
    Blockly.utils.createSvgElement("polygon", {points: "0,x x,x x,0".replace(/x/g, a.toString())}, this.resizeGroup_);
    ...
    Blockly.utils.createSvgElement("line", {
        "class": "blocklyResizeLine",
        x1: 2 * a / 3, y1: a - 1, x2: a - 1, y2: 2 * a / 3
    }, this.resizeGroup_)
};
Blockly.WorkspaceCommentSvg.prototype.addDeleteDom_ = function () {
    this.deleteGroup_ = Blockly.utils.createSvgElement("g", {"class": "blocklyCommentDeleteIcon"}, this.svgGroup_);
...
Blockly.WorkspaceCommentSvg.prototype.resizeMouseDown_ = function (a) {
    ...
    Blockly.utils.isRightButton(a) || (this.workspace.startDrag(a, new goog.math.Coordinate(this.workspace.RTL ? -this.width_ : this.width_, this.height_)), this.onMouseUpWrapper_ = Blockly.bindEventWithChecks_(document, "mouseup", this, this.resizeMouseUp_), this.onMouseMoveWrapper_ = Blockly.bindEventWithChecks_(document, "mousemove", this, this.resizeMouseMove_), Blockly.hideChaff());
    a.stopPropagation()
};
...
Blockly.WorkspaceCommentSvg.prototype.resizeComment_ = function () {
    var a = this.getHeightWidth(), b = Blockly.WorkspaceCommentSvg.TOP_OFFSET,
...
Blockly.WorkspaceCommentSvg.prototype.setSize_ = function (a, b) {
    ...
    this.RTL && (this.svgRect_.setAttribute("transform",
        "scale(-1 1)"), this.svgRectTarget_.setAttribute("transform", "scale(-1 1)"));
...
Blockly.WorkspaceCommentSvg.prototype.setFocus = function () {
    ...
    this.focused_ = !0;
    setTimeout(function () {
        a.disposed_ || (a.textarea_.focus(), a.addFocus(), Blockly.utils.addClass(a.svgRectTarget_, "blocklyCommentTargetFocused"), Blockly.utils.addClass(a.svgHandleTarget_, "blocklyCommentHandleTargetFocused"))
    }, 0)
};
Blockly.WorkspaceCommentSvg.prototype.blurFocus = function () {
    ...
    this.focused_ = !1;
    setTimeout(function () {
        a.disposed_ || (a.textarea_.blur(), a.removeFocus(), Blockly.utils.removeClass(a.svgRectTarget_, "blocklyCommentTargetFocused"), Blockly.utils.removeClass(a.svgHandleTarget_, "blocklyCommentHandleTargetFocused"))
    }, 0)
};
...
Blockly.WorkspaceDragSurfaceSvg.prototype.translateSurface = function (a, b) {
    var c = a.toFixed(0), d = b.toFixed(0);
    this.SVG_.style.display = "block";
    Blockly.utils.setCssTransform(this.SVG_, "translate3d(" + c + "px, " + d + "px, 0px)")
};
...
Blockly.WorkspaceDragSurfaceSvg.prototype.clearAndHide = function (a) {
    ...
    var b = this.SVG_.childNodes[0], c = this.SVG_.childNodes[1];
    if (!(b && c && Blockly.utils.hasClass(b, "blocklyBlockCanvas") && Blockly.utils.hasClass(c, "blocklyBubbleCanvas"))) throw Error("Couldn't clear and hide the drag surface. A node was missing.");
    null != this.previousSibling_ ? Blockly.utils.insertAfter(b, this.previousSibling_) : a.insertBefore(b, a.firstChild);
    Blockly.utils.insertAfter(c, b);
...
Blockly.ZoomControls.prototype.createZoomOutSvg_ = function (a) {
    ...
    this.zoomOutGroup_ = Blockly.utils.createSvgElement("g", {"class": "blocklyZoom"}, this.svgGroup_);
    var c = Blockly.utils.createSvgElement("clipPath", {id: "blocklyZoomoutClipPath" + a}, this.zoomOutGroup_);
    Blockly.utils.createSvgElement("rect", {width: 32, height: 32}, c);
    a = Blockly.utils.createSvgElement("image", {
    ...
    a.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", b.options.pathToMedia + Blockly.SPRITE.url);
...
Blockly.ZoomControls.prototype.createZoomInSvg_ = function (a) {
    var b = this.workspace_;
    this.zoomInGroup_ = Blockly.utils.createSvgElement("g", {"class": "blocklyZoom"}, this.svgGroup_);
    var c = Blockly.utils.createSvgElement("clipPath", {id: "blocklyZoominClipPath" + a}, this.zoomInGroup_);
    Blockly.utils.createSvgElement("rect", {width: 32, height: 32}, c);
    a = Blockly.utils.createSvgElement("image", {
        width: Blockly.SPRITE.width,
        height: Blockly.SPRITE.height,
...
Blockly.ZoomControls.prototype.createZoomResetSvg_ = function (a) {
    var b = this.workspace_;
    this.zoomResetGroup_ = Blockly.utils.createSvgElement("g", {"class": "blocklyZoom"}, this.svgGroup_);
    var c = Blockly.utils.createSvgElement("clipPath", {id: "blocklyZoomresetClipPath" + a}, this.zoomResetGroup_);
    Blockly.utils.createSvgElement("rect", {width: 32, height: 32}, c);
    a = Blockly.utils.createSvgElement("image", {
            width: Blockly.SPRITE.width,
            height: Blockly.SPRITE.height,
...
Blockly.WorkspaceSvg.prototype.getSvgXY = function (a) {
    var b = 0, c = 0, d = 1;
    if (Blockly.utils.containsNode(this.getCanvas(), a) || Blockly.utils.containsNode(this.getBubbleCanvas(), a)) d = this.scale;
    do {
...
Blockly.WorkspaceSvg.prototype.dispose = function () {
    ...
    this.flyoutButtonCallbacks_ = this.toolboxCategoryCallbacks_ = null;
    if (!this.options.parentWorkspace) {
        var a = this.getParentSvg().parentNode;
        a && Blockly.utils.removeNode(a)
    }
...
Blockly.WorkspaceSvg.prototype.setupDragSurface = function () {
    if (this.useWorkspaceDragSurface_ && !this.isDragSurfaceActive_) {
        ...
        var a = this.svgBlockCanvas_.previousSibling, b = parseInt(this.getParentSvg().getAttribute("width"), 10),
...
Blockly.WorkspaceSvg.prototype.pasteBlock_ = function (a) {
    Blockly.Events.disable();
    try {
        var b = Blockly.Xml.domToBlock(a, this), c = parseInt(a.getAttribute("x"), 10),
        ...
        if (!isNaN(c) && !isNaN(d)) {
            ...
            do {
                ...
                if (!a) {
                    ...
                    f = 0;
                    for (var l; l = k[f]; f++) if (l.closest(Blockly.SNAP_RADIUS, new goog.math.Coordinate(c, d)).connection) {
                        a =
                            !0;
                        break
                    }
...
Blockly.WorkspaceSvg.prototype.pasteWorkspaceComment_ = function (a) {
    Blockly.Events.disable();
    try {
        var b = Blockly.WorkspaceCommentSvg.fromXml(a, this), c = parseInt(a.getAttribute("x"), 10),
            d = parseInt(a.getAttribute("y"), 10);
...
Blockly.WorkspaceSvg.prototype.getBlocksBoundingBox = function () {
    var a = this.getTopBlocks(!1), b = this.getTopComments(!1);
    a = a.concat(b);
    if (!a.length) return {x: 0, y: 0, width: 0, height: 0};
    ...
    return {
        x: b.topLeft.x,
        y: b.topLeft.y, width: b.bottomRight.x - b.topLeft.x, height: b.bottomRight.y - b.topLeft.y
    }
};
...
Blockly.WorkspaceSvg.prototype.showContextMenu_ = function (a) {
    ...
    if (!this.options.readOnly && !this.isFlyout) {
        var d = [], e = this.getTopBlocks(!0), f = Blockly.utils.genUid(), g = this, h = {};
...
Blockly.WorkspaceSvg.prototype.zoomToFit = function () {
    if (this.isMovable()) {
        ...
        a = a.viewHeight;
        var c = this.getBlocksBoundingBox(), d = c.width;
        c = c.height;
...
Blockly.WorkspaceSvg.prototype.scrollCenter = function () {
    if (this.isMovable()) {
        var a = this.getMetrics(), b = (a.contentWidth - a.viewWidth) / 2, c = (a.contentHeight - a.viewHeight) / 2;
        b = -b - a.contentLeft;
        c = -c - a.contentTop;
        this.scroll(b, c)
    } else console.warn("Tried to move a non-movable workspace. This could result in blocks becoming inaccessible.")
...
Blockly.WorkspaceSvg.prototype.centerOnBlock = function (a) {
    if (this.isMovable()) {
        if (a = this.getBlockById(a)) {
            var b = a.getRelativeToSurfaceXY(), c = a.getHeightWidth(), d = this.scale;
...
Blockly.WorkspaceSvg.prototype.scroll = function (a, b) {
    var c = this.getMetrics(), d = c.contentWidth + c.contentLeft - c.viewWidth,
...
Blockly.WorkspaceSvg.getContentDimensionsExact_ = function (a) {
    var b = a.getBlocksBoundingBox(), c = a.scale;
    a = b.width * c;
    var d = b.height * c, e = b.x * c;
    b = b.y * c;
...
Blockly.WorkspaceSvg.getTopLevelWorkspaceMetrics_ = function () {
    var a = Blockly.WorkspaceSvg.getDimensionsPx_(this.toolbox_),
        b = Blockly.WorkspaceSvg.getDimensionsPx_(this.flyout_), c = Blockly.svgSize(this.getParentSvg()),
        d = {height: c.height, width: c.width};
    if (this.toolbox_) if (this.toolboxPosition == Blockly.TOOLBOX_AT_TOP || this.toolboxPosition == Blockly.TOOLBOX_AT_BOTTOM) d.height -= a.height; else {
        if (this.toolboxPosition == Blockly.TOOLBOX_AT_LEFT || this.toolboxPosition == Blockly.TOOLBOX_AT_RIGHT) d.width -= a.width
    } else if (this.flyout_) if (this.toolboxPosition ==
        Blockly.TOOLBOX_AT_TOP || this.toolboxPosition == Blockly.TOOLBOX_AT_BOTTOM) d.height -= b.height; else if (this.toolboxPosition == Blockly.TOOLBOX_AT_LEFT || this.toolboxPosition == Blockly.TOOLBOX_AT_RIGHT) d.width -= b.width;
    var e = Blockly.WorkspaceSvg.getContentDimensions_(this, d), f = 0;
...
Blockly.WorkspaceSvg.prototype.getGesture = function (a) {
    var b = "mousedown" == a.type || "touchstart" == a.type || "pointerdown" == a.type, c = this.currentGesture_;
...
Blockly.Mutator.prototype.drawIcon_ = function (a) {
    ...
    Blockly.utils.createSvgElement("circle", {"class": "blocklyIconShape", r: "2.7", cx: "8", cy: "8"}, a)
};
...
Blockly.Mutator.prototype.createEditor_ = function () {
    ...
    if (this.quarkNames_.length) for (var a = Blockly.Xml.utils.createElement("xml"), b = 0, c; c = this.quarkNames_[b]; b++) {
        var d = Blockly.Xml.utils.createElement("block");
...
Blockly.Mutator.prototype.resizeBubble_ = function () {
    var a = 2 * Blockly.Bubble.BORDER_WIDTH, b = this.workspace_.getCanvas().getBBox();
...
Blockly.Extensions.checkMutatorDialog_ = function (a, b) {
    var c = void 0 !== a.compose, d = void 0 !== a.decompose;
    if (c && d) {
...
Blockly.Extensions.buildTooltipForDropdown = function (a, b) {
    ...
    return function () {
        ...
        this.setTooltip(function () {
            var d = this.getFieldValue(a), e = b[d];
...
Blockly.Field.prototype.init = function () {
    ...
    }, this.fieldGroup_), this.updateEditable(), this.clickTarget_ = this.getSvgRoot(), this.sourceBlock_.getSvgRoot().appendChild(this.fieldGroup_),
        this.mouseDownWrapper_ = Blockly.bindEventWithChecks_(this.clickTarget_, "mousedown", this, this.onMouseDown_))
};
...
Blockly.Field.prototype.dispose = function () {
    ...
    this.fieldGroup_ && (Blockly.utils.removeNode(this.fieldGroup_), this.fieldGroup_ = null);
    this.validator_ = this.borderRect_ = this.textElement_ = null
};
Blockly.Field.prototype.updateEditable = function () {
    var a = this.getClickTarget_();
    this.EDITABLE && a && (this.sourceBlock_.isEditable() ? (Blockly.utils.addClass(a, "blocklyEditableText"), Blockly.utils.removeClass(a, "blocklyNonEditableText"), a.style.cursor = this.CURSOR) : (Blockly.utils.addClass(a, "blocklyNonEditableText"), Blockly.utils.removeClass(a, "blocklyEditableText"), a.style.cursor = ""))
};
...
Blockly.Field.prototype.getScaledBBox_ = function () {
    var a = this.borderRect_.getBBox(), b = a.height * this.sourceBlock_.workspace.scale;
...
Blockly.FieldLabel.prototype.dispose = function () {
    this.textElement_ && (Blockly.utils.removeNode(this.textElement_), this.textElement_ = null)
};
...
Blockly.FieldLabel.prototype.setTooltip = function (a) {
    this.tooltip_ = a;
    this.textElement_ && (this.textElement_.tooltip = a)
};
...
Blockly.Warning.prototype.drawIcon_ = function (a) {
    ...
    Blockly.utils.createSvgElement("rect", {"class": "blocklyIconSymbol", x: "7", y: "11", height: "2", width: "2"}, a)
};
Blockly.Warning.textToDom_ = function (a) {
    ...
    for (var c = 0; c < a.length; c++) {
        var d = Blockly.utils.createSvgElement("tspan", {dy: "1em", x: Blockly.Bubble.BORDER_WIDTH}, b),
...
Blockly.Block = function (a, b, c) {
    ...
    this.childBlocks_ = [];
    this.editable_ = this.movable_ = this.deletable_ =
        !0;
...
Blockly.Block.prototype.getMatchingConnection = function (a, b) {
    var c = this.getConnections_(!0), d = a.getConnections_(!0);
...
Blockly.Block.prototype.setColour = function (a) {
    var b = "string" == typeof a ? Blockly.utils.replaceMessageReferences(a) : a, c = Number(b);
    if (!isNaN(c) && 0 <= c && 360 >= c) this.hue_ = c, this.colour_ = Blockly.hueToRgb(c); else if ("string" == typeof b && /^#[0-9a-fA-F]{6}$/.test(b)) this.colour_ = b, this.hue_ = null; else throw c = 'Invalid colour: "' + b + '"', a != b && (c += ' (from "' + a + '")'), Error(c);
};
...
Blockly.Block.prototype.interpolate_ = function (a, b, c) {
    var d = Blockly.utils.tokenizeInterpolation(a), e = [], f = 0;
    a = [];
    ...
    a.length && ("string" == typeof a[a.length - 1] || Blockly.utils.startsWith(a[a.length - 1].type, "field_")) && (g = {type: "input_dummy"}, c && (g.align = c), a.push(g));
...
Blockly.ContextMenu.callbackFactory = function (a, b) {
    return function () {
        Blockly.Events.disable();
        try {
            var c = Blockly.Xml.domToBlock(b, a.workspace), d = a.getRelativeToSurfaceXY();
...
Blockly.ContextMenu.blockDeleteOption = function (a) {
    var b = a.getDescendants(!1).length, c = a.getNextBlock();
...
Blockly.ContextMenu.blockDuplicateOption = function (a) {
    ...
    return {
        text: Blockly.Msg.DUPLICATE_BLOCK, enabled: b, callback: function () {
...
Blockly.ContextMenu.commentDuplicateOption = function (a) {
    return {
        text: Blockly.Msg.DUPLICATE_COMMENT, enabled: !0, callback: function () {
            Blockly.duplicate_(a)
        }
    }
};
Blockly.ContextMenu.workspaceCommentOption = function (a, b) {
    var c = {enabled: !goog.userAgent.IE};
    ...
    c.callback = function () {
        ...
        e = new goog.math.Coordinate(b.clientX - e.left, b.clientY - e.top);
        var f = a.getOriginOffsetInPixels();
        e = goog.math.Coordinate.difference(e, f).scale(1 / a.scale);
        c.moveBy(e.x, e.y);
...
Blockly.BlockSvg = function (a, b, c) {
    ...
    this.svgPath_ = Blockly.utils.createSvgElement("path", {"class": "blocklyPath"}, this.svgGroup_);
    this.svgPathLight_ = Blockly.utils.createSvgElement("path", {"class": "blocklyPathLight"}, this.svgGroup_);
...
Blockly.BlockSvg.prototype.snapToGrid = function () {
    if (this.workspace && !this.workspace.isDragging() && !this.getParent() && !this.isInFlyout) {
        ...
        if (a && a.shouldSnap()) {
            var b = a.getSpacing(), c = b / 2, d = this.getRelativeToSurfaceXY();
...
Blockly.BlockSvg.prototype.getBoundingRectangle = function () {
    var a = this.getRelativeToSurfaceXY(this), b = this.outputConnection ? Blockly.BlockSvg.TAB_WIDTH : 0,
    ...
    return {topLeft: d, bottomRight: a}
};
...
Blockly.BlockSvg.prototype.showContextMenu_ = function (a) {
    if (!this.workspace.options.readOnly && this.contextMenu) {
        ...
        if (this.isDeletable() && this.isMovable() && !b.isInFlyout) {
            ...
            if (!this.collapsed_) for (var d = 1; d < this.inputList.length; d++) if (this.inputList[d - 1].type != Blockly.NEXT_STATEMENT && this.inputList[d].type != Blockly.NEXT_STATEMENT) {
                d =
                    {enabled: !0};
            ...
            this.workspace.options.collapse && (this.collapsed_ ? (d = {enabled: !0}, d.text = Blockly.Msg.EXPAND_BLOCK, d.callback = function () {
                b.setCollapsed(!1)
            }, c.push(d)) : (d = {enabled: !0}, d.text = Blockly.Msg.COLLAPSE_BLOCK, d.callback = function () {
                b.setCollapsed(!0)
            }, c.push(d)));
            this.workspace.options.disable && (d = {
                text: this.disabled ? Blockly.Msg.ENABLE_BLOCK :
                    Blockly.Msg.DISABLE_BLOCK, enabled: !this.getInheritedDisabled(), callback: function () {
                    var a = Blockly.Events.getGroup();
                    a || Blockly.Events.setGroup(!0);
...
Blockly.BlockSvg.prototype.setInsertionMarker = function (a) {
    this.isInsertionMarker_ != a && (this.isInsertionMarker_ = a) && (this.setColour(Blockly.INSERTION_MARKER_COLOUR), Blockly.utils.addClass(this.svgGroup_, "blocklyInsertionMarker"))
};
...
Blockly.BlockSvg.prototype.updateColour = function () {
    if (!this.disabled) {
        var a = this.getColour(), b = this.getColourSecondary(), c = this.getColourTertiary(),
            d = goog.color.hexToRgb(a);
        this.isShadow() ? a = this.setShadowColour_(d, b) : this.setBorderColour_(d, c);
        this.svgPath_.setAttribute("fill", a);
        a = this.getIcons();
        for (b = 0; b < a.length; b++) a[b].updateColour();
        for (a = 0; b = this.inputList[a]; a++) for (c = 0; d = b.fieldRow[c]; c++) d.forceRerender()
    }
};
Blockly.BlockSvg.prototype.setBorderColour_ = function (a, b) {
    if (b) this.svgPathLight_.setAttribute("stroke", "none"), this.svgPathDark_.setAttribute("fill", "none"), this.svgPath_.setAttribute("stroke", b); else {
        this.svgPathLight_.style.display = "";
        var c = goog.color.rgbArrayToHex(goog.color.lighten(a, .3)),
            d = goog.color.rgbArrayToHex(goog.color.darken(a, .2));
...
Blockly.BlockSvg.prototype.setShadowColour_ = function (a, b) {
    if (b) {
        ...
        var c = b
    } else a = goog.color.lighten(a, .6), c = goog.color.rgbArrayToHex(a), this.svgPathLight_.style.display = "none", this.svgPathDark_.setAttribute("fill", c);
    return c
};
...
Blockly.BlockSvg.prototype.scheduleSnapAndBump = function () {
    var a = this, b = Blockly.Events.getGroup();
    setTimeout(function () {
...
Blockly.BlockSvg.prototype.getHeightWidth = function () {
    var a = this.height, b = this.width, c = this.getNextBlock();
...
Blockly.BlockSvg.prototype.renderFields_ = function (a, b, c) {
    ...
    for (var d = 0, e; e = a[d]; d++) {
        ...
        if (f) {
            ...
            f.setAttribute("transform", "translate(" + h +
                "," + c + ")" + g);
...
Blockly.BlockSvg.prototype.renderCompute_ = function (a) {
    ...
    for (var d = 0, e = 0, f = !1, g = !1, h = !1, k = void 0, l = this.getInputsInline() && !this.isCollapsed(), n = 0, m; m = b[n]; n++) if (m.isVisible()) {
        if (l && k && k != Blockly.NEXT_STATEMENT && m.type != Blockly.NEXT_STATEMENT) var p = c[c.length - 1]; else k = m.type, p = [], p.type = l &&
...
Blockly.BlockSvg.prototype.renderDraw_ = function (a, b) {
    ...
    if (this.outputConnection) this.squareBottomLeftCorner_ = this.squareTopLeftCorner_ = !0; else {
        ...
        this.previousConnection ? (c = this.previousConnection.targetBlock()) && c.getNextBlock() == this && (this.squareTopLeftCorner_ = !0) : c && (this.startHat_ = this.squareTopLeftCorner_ = !0, this.height += Blockly.BlockSvg.START_HAT_HEIGHT,
...
Blockly.BlockSvg.prototype.renderDrawTop_ = function (a, b) {
    var c = a.steps, d = a.highlightSteps;
...
Blockly.BlockSvg.prototype.renderDrawRight_ = function (a, b, c) {
    for (var d = {x: 0, y: 0}, e = {
        ...
        g.type == Blockly.NEXT_STATEMENT && this.renderStatementInput_(a, g, d, e, b, f), d.y += g.height;
...
Blockly.BlockSvg.prototype.renderInlineRow_ = function (a, b, c, d, e) {
    var f = a.inlineSteps, g = a.highlightInlineSteps, h = a.steps;
    a = a.highlightSteps;
...
Blockly.BlockSvg.prototype.renderStatementInput_ = function (a, b, c, d, e, f) {
    ...
    this.RTL ? (a.push("M", c.x - Blockly.BlockSvg.NOTCH_WIDTH + Blockly.BlockSvg.DISTANCE_45_OUTSIDE + "," + (c.y + Blockly.BlockSvg.DISTANCE_45_OUTSIDE)), a.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER_HIGHLIGHT_RTL), a.push("v", b.height - 2 * Blockly.BlockSvg.CORNER_RADIUS), a.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_RTL)) :
        (a.push("M", c.x - Blockly.BlockSvg.NOTCH_WIDTH + Blockly.BlockSvg.DISTANCE_45_OUTSIDE + "," + (c.y + b.height - Blockly.BlockSvg.DISTANCE_45_OUTSIDE)), a.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_LTR));
    ...
    if (f == e.length - 1 || e[f + 1].type == Blockly.NEXT_STATEMENT) g.push("v", Blockly.BlockSvg.SEP_SPACE_Y),
    this.RTL && a.push("v", Blockly.BlockSvg.SEP_SPACE_Y - 1), c.y += Blockly.BlockSvg.SEP_SPACE_Y
};
...
Blockly.BlockSvg.prototype.highlightForReplacement = function (a) {
    a ? Blockly.utils.addClass(this.svgGroup_, "blocklyReplaceable") : Blockly.utils.removeClass(this.svgGroup_, "blocklyReplaceable")
};/*
...
Blockly.DropDownDiv.createDom = function () {
    if (!Blockly.DropDownDiv.DIV_) {
        ...
        Blockly.DropDownDiv.DIV_.style.transition = "transform " + Blockly.DropDownDiv.ANIMATION_TIME +
            "s, opacity " + Blockly.DropDownDiv.ANIMATION_TIME + "s"
    }
};
...
Blockly.DropDownDiv.showPositionedByBlock = function (a, b, c, d) {
    var e = b.workspace.scale, f = b.width, g = b.height;
    f *= e;
    g *= e;
...
Blockly.DropDownDiv.showPositionedByField = function (a, b, c) {
    var d = a.fieldGroup_.getBoundingClientRect(), e = d.left + d.width / 2, f = d.bottom;
    d = d.top;
    c && (d += c);
    Blockly.DropDownDiv.positionToField_ = !0;
    Blockly.DropDownDiv.setBoundsElement(a.sourceBlock_.workspace.getParentSvg().parentNode);
...
Blockly.DropDownDiv.show = function (a, b, c, d, e, f) {
    ...
    Blockly.DropDownDiv.positionInternal_(a.initialX, a.initialY,
        a.finalX, a.finalY);
    return a.arrowAtTop
};
...
Blockly.DropDownDiv.getPositionMetrics = function (a, b, c, d) {
    var e = Blockly.DropDownDiv.getBoundsInfo_(), f = goog.style.getSize(Blockly.DropDownDiv.DIV_);
    if (b + f.height > e.bottom) if (d - f.height < e.top) {
        c = 0;
        var g = !1;
        var h = !0
    } else a = c, c = d - f.height - Blockly.DropDownDiv.PADDING_Y, g = !0; else c = b + Blockly.DropDownDiv.PADDING_Y, g = !1;
    var k = a;
    a -= f.width / 2;
    a = Blockly.utils.clampNumber(e.left, a, e.right - f.width);
    k -= Blockly.DropDownDiv.ARROW_SIZE / 2;
    k = Blockly.utils.clampNumber(e.left, k, e.right);
    e = Blockly.utils.clampNumber(Blockly.DropDownDiv.ARROW_HORIZONTAL_PADDING,
        k - a, f.width - Blockly.DropDownDiv.ARROW_HORIZONTAL_PADDING - Blockly.DropDownDiv.ARROW_SIZE);
...
Blockly.DropDownDiv.hideWithoutAnimation = function () {
    Blockly.DropDownDiv.isVisible() && (Blockly.DropDownDiv.animateOutTimer_ && window.clearTimeout(Blockly.DropDownDiv.animateOutTimer_), Blockly.DropDownDiv.positionInternal_(), Blockly.DropDownDiv.clearContent(), Blockly.DropDownDiv.owner_ = null, Blockly.DropDownDiv.onHide_ && (Blockly.DropDownDiv.onHide_(), Blockly.DropDownDiv.onHide_ = null))
};
Blockly.DropDownDiv.positionInternal_ = function (a, b, c, d) {
    ...
    d = null == d ? d : Math.floor(d);
    var e = Blockly.DropDownDiv.DIV_;
    e.style.left = null != a ? a + "px" : "";
    e.style.top = null != b ? b + "px" : "";
    null != c ? (e.style.display = "block", e.style.opacity = 1, e.style.transform = "translate(" + (c - a) + "px," + (d - b) + "px)") : (e.style.display = "none", e.style.transform = "")
};
Blockly.DropDownDiv.repositionForWindowResize = function () {
    if (Blockly.DropDownDiv.owner_) {
        var a = Blockly.DropDownDiv.owner_.sourceBlock_, b = a.workspace.scale,
        ...
        c = a.left + c / 2;
        d = Blockly.DropDownDiv.getPositionMetrics(c,
            a.top + d, c, a.top);
...
Blockly.FieldTextInput.prototype.showInlineEditor_ = function (a) {
    ...
    var b = Blockly.WidgetDiv.DIV, c = document.createElement("input");
...
Blockly.FieldTextInput.prototype.onHtmlInputKeyDown_ = function (a) {
    ...
    13 == a.keyCode ? (Blockly.WidgetDiv.hide(), Blockly.DropDownDiv.hideIfOwner(this)) : 27 == a.keyCode ? (b.value = b.defaultValue, Blockly.WidgetDiv.hide(), Blockly.DropDownDiv.hideIfOwner(this)) : 9 == a.keyCode && (Blockly.WidgetDiv.hide(), Blockly.DropDownDiv.hideIfOwner(this), this.sourceBlock_.tab(this, !a.shiftKey), a.preventDefault())
};
Blockly.FieldTextInput.prototype.onHtmlInputChange_ = function (a) {
    a = Blockly.FieldTextInput.htmlInput_;
    var b = a.value;
    b !== a.oldValue_ ? (a.oldValue_ = b, Blockly.Events.setGroup(!0), this.setValue(b), Blockly.Events.setGroup(!1), this.validate_()) : goog.userAgent.WEBKIT && this.sourceBlock_.render();
    this.resizeEditor_();
...
Blockly.FieldTextInput.prototype.resizeEditor_ = function () {
    var a = Blockly.WidgetDiv.DIV, b = this.getScaledBBox_();
...
Blockly.FieldTextInput.prototype.maybeSaveEdit_ = function () {
    var a = Blockly.FieldTextInput.htmlInput_, b = a.value;
    if (this.sourceBlock_) if (b = this.callValidator(b), null === b) b = a.defaultValue; else if (this.onFinishEditing_) this.onFinishEditing_(b);
    this.setText(b);
    this.sourceBlock_.rendered && this.sourceBlock_.render()
};
...
Blockly.FieldAngle.prototype.showEditor_ = function () {
    ...
    var a = Blockly.DropDownDiv.getContentDiv();
    a = Blockly.utils.createSvgElement("svg", {
        xmlns: "http://www.w3.org/2000/svg",
        "xmlns:html": "http://www.w3.org/1999/xhtml",
        "xmlns:xlink": "http://www.w3.org/1999/xlink",
        version: "1.1",
        height: 2 * Blockly.FieldAngle.HALF +
            "px",
    ...
    this.gauge_ = Blockly.utils.createSvgElement("path", {"class": "blocklyAngleGauge"}, a);
    ...
    Blockly.DropDownDiv.setColour(this.sourceBlock_.getColour(), this.sourceBlock_.getColour());
    Blockly.DropDownDiv.showPositionedByField(this);
    this.clickWrapper_ = Blockly.bindEvent_(a, "click", this, this.hide_.bind(this));
    this.moveWrapper1_ = Blockly.bindEvent_(b,
...
Blockly.FieldAngle.prototype.onMouseMove = function (a) {
    ...
    b = Math.atan(-a / c);
    isNaN(b) || (b = Blockly.utils.toDegrees(b), 0 > c ? b += 180 : 0 < a && (b += 360), b = Blockly.FieldAngle.CLOCKWISE ? Blockly.FieldAngle.OFFSET + 360 - b : b - Blockly.FieldAngle.OFFSET, Blockly.FieldAngle.ROUND && (b = Math.round(b / Blockly.FieldAngle.ROUND) * Blockly.FieldAngle.ROUND), b = this.callValidator(b), Blockly.FieldTextInput.htmlInput_.value =
...
Blockly.FieldAngle.prototype.updateGraph_ = function () {
    if (this.gauge_) {
        var a = Number(this.getText()) + Blockly.FieldAngle.OFFSET, b = Blockly.utils.toRadians(a);
        a = ["M ", Blockly.FieldAngle.HALF, ",", Blockly.FieldAngle.HALF];
        var c = Blockly.FieldAngle.HALF, d = Blockly.FieldAngle.HALF;
        if (!isNaN(b)) {
            var e = Blockly.utils.toRadians(Blockly.FieldAngle.OFFSET), f = Math.cos(e) * Blockly.FieldAngle.RADIUS,
...
Blockly.FieldColour.prototype.updateWidth = function () {
    var a = Blockly.FieldColour.DEFAULT_WIDTH;
    this.borderRect_ && this.borderRect_.setAttribute("width", a + Blockly.BlockSvg.SEP_SPACE_X);
    this.size_.width = a
};
...
Blockly.FieldColour.prototype.getText = function () {
    var a = this.colour_, b = a.match(/^#(.)\1(.)\2(.)\3$/);
    b && (a = "#" + b[1] + b[2] + b[3]);
    return a
};
...
Blockly.FieldColour.prototype.showEditor_ = function () {
    ...
    Blockly.DropDownDiv.showPositionedByField(this);
    Blockly.FieldColour.onUpWrapper_ = Blockly.bindEvent_(a, "mouseup", this, this.onClick_)
};
...
Blockly.FieldColour.prototype.createWidget_ = function () {
    var a = this.columns_ || Blockly.FieldColour.COLUMNS, b = this.colours_ || Blockly.FieldColour.COLOURS,
        c = this.titles_ || Blockly.FieldColour.TITLES, d = this.getValue(), e = document.createElement("table");
...
Blockly.FieldColour.widgetDispose_ = function () {
    Blockly.FieldColour.onUpWrapper_ && Blockly.unbindEvent_(Blockly.FieldColour.onUpWrapper_);
    Blockly.Events.setGroup(!1)
};
...
Blockly.FieldDropdown.prototype.positionMenu_ = function (a) {
    var b = Blockly.utils.getViewportBBox(), c = this.getAnchorDimensions_();
...
Blockly.FieldDropdown.prototype.setValue = function (a) {
    if (!(null === a || a === this.value_ && this.text_)) {
        ...
        this.value_ = a;
        for (var b = this.getOptions(), c = 0; c < b.length; c++) if (b[c][1] == a) {
            a = b[c][0];
...
Blockly.FieldDropdown.validateOptions_ = function (a) {
    ...
    for (var b = !1, c = 0; c < a.length; ++c) {
        var d = a[c];
        Array.isArray(d) ? "string" != typeof d[1] ? (b = !0, console.error("Invalid option[" + c + "]: Each FieldDropdown option id must be a string. Found " + d[1] + " in: ", d)) : "string" != typeof d[0] && "string" != typeof d[0].src && (b = !0, console.error("Invalid option[" + c + "]: Each FieldDropdown option must have a string label or image description. Found" +
            d[0] + " in: ", d)) : (b = !0, console.error("Invalid option[" + c + "]: Each FieldDropdown option must be an array. Found: ", d))
    }
...
Blockly.FieldImage.fromJson = function (a) {
    var b = Blockly.utils.replaceMessageReferences(a.src), c = Number(Blockly.utils.replaceMessageReferences(a.width)),
        d = Number(Blockly.utils.replaceMessageReferences(a.height)), e = Blockly.utils.replaceMessageReferences(a.alt);
...
Blockly.FieldImage.prototype.init = function () {
    ...
    }, this.fieldGroup_), this.setValue(this.src_), this.setText(this.text_), this.sourceBlock_.getSvgRoot().appendChild(this.fieldGroup_), this.tooltip_ ? this.imageElement_.tooltip = this.tooltip_ : this.setTooltip(this.sourceBlock_),
        Blockly.Tooltip.bindMouseEvents(this.imageElement_), this.maybeAddClickHandler_())
};
...
Blockly.FieldImage.prototype.maybeAddClickHandler_ = function () {
    this.clickHandler_ && (this.mouseDownWrapper_ = Blockly.bindEventWithChecks_(this.fieldGroup_, "mousedown", this, this.clickHandler_))
};
Blockly.FieldImage.prototype.setTooltip = function (a) {
    this.tooltip_ = a;
    this.imageElement_ && (this.imageElement_.tooltip = a)
};
...
Blockly.FieldVariable.dropdownCreate = function () {
    ...
    var a = this.getText(), b = null;
    this.sourceBlock_ && (b = this.sourceBlock_.workspace);
    var c = [];
    if (b) for (var d = this.getVariableTypes_(), e = 0; e < d.length; e++) {
        var f = b.getVariablesOfType(d[e]);
        c = c.concat(f)
    }
    c.sort(Blockly.VariableModel.compareByName);
    b = [];
    for (e = 0; e < c.length; e++) b[e] = [c[e].name, c[e].getId()];
    b.push([Blockly.Msg.RENAME_VARIABLE, Blockly.RENAME_VARIABLE_ID]);
    Blockly.Msg.DELETE_VARIABLE && b.push([Blockly.Msg.DELETE_VARIABLE.replace("%1", a), Blockly.DELETE_VARIABLE_ID]);
    return b
};
...
Blockly.Generator.prototype.blockToCode = function (a, b) {
    if (!a) return "";
    if (a.disabled) return b ? "" : this.blockToCode(a.getNextBlock());
    var c = this[a.type];
    ...
    if ("string" == typeof c) {
        ...
        (c = this.STATEMENT_PREFIX.replace(/%1/g, "'" + d + "'") + c);
        return this.scrub_(a, c, b)
    }
    if (null === c) return "";
...
Blockly.Generator.prototype.valueToCode = function (a, b, c) {
    ...
    if (e <= f && (e != f || 0 != e && 99 != e)) for (d = !0, e = 0; e < this.ORDER_OVERRIDES.length; e++) if (this.ORDER_OVERRIDES[e][0] ==
...
Blockly.Procedures.rename = function (a) {
    ...
    var b = Blockly.Procedures.findLegalName(a, this.sourceBlock_), c = this.text_;
    if (c != a && c != b) {
        a = this.sourceBlock_.workspace.getAllBlocks(!1);
...
Blockly.Procedures.flyoutCategory = function (a) {
    function b(a, b) {
        for (var d = 0; d < a.length; d++) {
            var e = a[d][0], f = a[d][1], g = Blockly.Xml.utils.createElement("block");
            g.setAttribute("type", b);
            g.setAttribute("gap", 16);
            var m = Blockly.Xml.utils.createElement("mutation");
            m.setAttribute("name", e);
            g.appendChild(m);
            for (e = 0; e < f.length; e++) {
                var p = Blockly.Xml.utils.createElement("arg");
    ...
    if (Blockly.Blocks.procedures_defnoreturn) {
        ...
        var e = Blockly.Xml.utils.createElement("field");
        e.setAttribute("name", "NAME");
        e.appendChild(Blockly.Xml.utils.createTextNode(Blockly.Msg.PROCEDURES_DEFNORETURN_PROCEDURE));
        d.appendChild(e);
        c.push(d)
    }
    Blockly.Blocks.procedures_defreturn && (d = Blockly.Xml.utils.createElement("block"), d.setAttribute("type", "procedures_defreturn"), d.setAttribute("gap", 16), e = Blockly.Xml.utils.createElement("field"), e.setAttribute("name", "NAME"), e.appendChild(Blockly.Xml.utils.createTextNode(Blockly.Msg.PROCEDURES_DEFRETURN_PROCEDURE)),
        d.appendChild(e), c.push(d));
    Blockly.Blocks.procedures_ifreturn && (d = Blockly.Xml.utils.createElement("block"), d.setAttribute("type", "procedures_ifreturn"), d.setAttribute("gap", 16), c.push(d));
...
Blockly.Procedures.mutateCallers = function (a) {
    var b = Blockly.Events.recordUndo, c = a.getProcedureDef()[0], d = a.mutationToDom(!0);
...
Blockly.FlyoutButton.prototype.createDom = function () {
    ...
    this.svgGroup_ = Blockly.utils.createSvgElement("g", {"class": a}, this.workspace_.getCanvas());
...
Blockly.Flyout.prototype.createDom = function (a) {
    this.svgGroup_ = Blockly.utils.createSvgElement(a, {"class": "blocklyFlyout", style: "display: none"}, null);
...
Blockly.Flyout.prototype.show = function (a) {
    ...
    for (var b = [], c = [], d = this.permanentlyDisabled_.length =
        0, e; e = a[d]; d++) if (e.tagName) {
        var f = e.tagName.toUpperCase(), g = this.horizontalLayout_ ? this.GAP_X : this.GAP_Y;
        if ("BLOCK" == f) f = Blockly.Xml.domToBlock(e, this.workspace_), f.disabled && this.permanentlyDisabled_.push(f), b.push({
            type: "block",
            block: f
        }), e = parseInt(e.getAttribute("gap"), 10), c.push(isNaN(e) ? g : e); else if ("SEP" == e.tagName.toUpperCase()) e = parseInt(e.getAttribute("gap"), 10), !isNaN(e) && 0 < c.length ? c[c.length - 1] = e : c.push(g); else if ("BUTTON" == f || "LABEL" == f) e = new Blockly.FlyoutButton(this.workspace_, this.targetWorkspace_,
            e, "LABEL" == f), b.push({type: "button", button: e}), c.push(g)
    }
    this.layout_(b, c);
...
Blockly.Flyout.prototype.clearOldBlocks_ = function () {
    ...
    for (b = 0; b < this.mats_.length; b++) (a = this.mats_[b]) && Blockly.utils.removeNode(a);
...
Blockly.Flyout.prototype.createRect_ = function (a, b, c, d, e) {
    b = Blockly.utils.createSvgElement("rect", {"fill-opacity": 0, x: b, y: c, height: d.height, width: d.width}, null);
    b.tooltip = a;
...
Blockly.Flyout.prototype.filterForCapacity_ = function () {
    for (var a = this.workspace_.getTopBlocks(!1), b = 0, c; c = a[b]; b++) if (-1 == this.permanentlyDisabled_.indexOf(c)) for (var d = !this.targetWorkspace_.isCapacityAvailable(Blockly.utils.getBlockTypeCounts(c)); c;) c.setDisabled(d), c = c.getNextBlock()
};
...
Blockly.Flyout.prototype.placeNewBlock_ = function (a) {
    ...
    var d = b.getOriginOffsetInPixels(), e = this.workspace_.getOriginOffsetInPixels();
...
Blockly.HorizontalFlyout.prototype.getMetrics_ = function () {
    ...
    var b = this.SCROLLBAR_PADDING, c = this.SCROLLBAR_PADDING;
...
Blockly.HorizontalFlyout.prototype.setBackgroundPath_ = function (a, b) {
    var c = this.toolboxPosition_ == Blockly.TOOLBOX_AT_TOP, d = ["M 0," + (c ? 0 : this.CORNER_RADIUS)];
...
Blockly.HorizontalFlyout.prototype.wheel_ = function (a) {
    var b = Blockly.utils.getScrollDeltaPixels(a), c = b.x || b.y;
...
Blockly.HorizontalFlyout.prototype.layout_ = function (a, b) {
    ...
    var c = this.MARGIN, d = this.RTL ? c : c + Blockly.BlockSvg.TAB_WIDTH;
...
Blockly.VerticalFlyout.prototype.getMetrics_ = function () {
    ...
    var b = this.SCROLLBAR_PADDING, c = this.height_ - 2 * this.SCROLLBAR_PADDING, d = this.width_;
...
Blockly.VerticalFlyout.prototype.setBackgroundPath_ = function (a, b) {
    var c = this.toolboxPosition_ == Blockly.TOOLBOX_AT_RIGHT, d = a + this.CORNER_RADIUS;
    d = ["M " + (c ? d : 0) + ",0"];
    d.push("h", c ? -a : a);
...
Blockly.VerticalFlyout.prototype.getClientRect = function () {
    ...
    a = a.width;
    if (this.toolboxPosition_ == Blockly.TOOLBOX_AT_LEFT) return new goog.math.Rect(b - 1E9, -1E9, 1E9 + a, 2E9);
    if (goog.userAgent.GECKO && this.targetWorkspace_ && this.targetWorkspace_.isMutator) {
        var c = this.targetWorkspace_.svgGroup_.getBoundingClientRect().x;
        10 > Math.abs(c - b) && (b += this.leftEdge_ * this.targetWorkspace_.options.parentWorkspace.scale)
    }
    return new goog.math.Rect(b,
        -1E9, 1E9 + a, 2E9)
};
...
Blockly.Toolbox.prototype.init = function () {
    var a = this.workspace_, b = this.workspace_.getParentSvg();
...
Blockly.Toolbox.prototype.syncTrees_ = function (a, b, c) {
    for (var d = null, e = null, f = 0, g; g = a.childNodes[f]; f++) if (g.tagName) switch (g.tagName.toUpperCase()) {
        case "CATEGORY":
            ...
            l && k ? (h.hexColour = "", console.warn('Toolbox category "' + e + '" can not have both a style and a colour')) :
                k ? this.setColourFromStyle_(k, h, e) : this.setColour_(l, h, e);
...
Blockly.Toolbox.prototype.getClientRect = function () {
    ...
    var a = this.HtmlDiv.getBoundingClientRect(), b = a.left, c = a.top, d = a.width;
    a = a.height;
...
Blockly.Toolbox.TreeNode.prototype.onKeyDown = function (a) {
    if (this.tree.toolbox_.horizontalLayout_) {
        var b = {}, c = goog.events.KeyCodes.DOWN, d = goog.events.KeyCodes.UP;
...
Blockly.inject = function (a, b) {
    ...
    if (!Blockly.utils.containsNode(document, a)) throw Error("Error: container is not in current document.");
    var c = new Blockly.Options(b || {}), d = document.createElement("div");
...
Blockly.createMainWorkspace_ = function (a, b, c, d) {
    ...
    !b.hasCategories && b.languageTree && (c = e.addFlyout_("svg"), Blockly.utils.insertAfter(c, a));
    ...
    b.readOnly || e.isMovable() || e.addChangeListener(function (a) {
        if (!e.isDragging() && !e.isMovable() &&
            -1 != Blockly.Events.BUMP_EVENTS.indexOf(a.type)) {
            var b = Object.create(null), c = e.getMetrics(), d = e.scale;
            b.viewLeft = c.viewLeft / d;
            b.viewTop = c.viewTop / d;
            b.viewRight = (c.viewLeft + c.viewWidth) / d;
            b.viewBottom = (c.viewTop + c.viewHeight) / d;
            e.isContentBounded() ? (c = e.getBlocksBoundingBox(), b.contentLeft = c.x, b.contentTop = c.y, b.contentRight = c.x + c.width, b.contentBottom = c.y + c.height) : (b.contentLeft = c.contentLeft / d, b.contentTop = c.contentTop / d, b.contentRight = (c.contentLeft + c.contentWidth) / d, b.contentBottom = (c.contentTop +
                c.contentHeight) / d);
            if (b.contentTop < b.viewTop || b.contentBottom > b.viewBottom || b.contentLeft < b.viewLeft || b.contentRight > b.viewRight) {
                ...
                if (f) {
                    ...
                    var n = b.viewTop - d.topLeft.y;
                    0 < n && f.moveBy(0, n);
                    n = b.viewBottom - d.bottomRight.y;
                    0 > n && f.moveBy(0, n);
                    n = b.viewLeft - d.topLeft.x;
                    0 < n && f.moveBy(n, 0);
                    b = b.viewRight - d.bottomRight.x;
                    0 > b && f.moveBy(b, 0)
                }
...
Blockly.inject.bindDocumentEvents_ = function () {
    ...
    }), Blockly.bindEventWithChecks_(document, "keydown", null, Blockly.onKeyDown_), Blockly.bindEvent_(document, "touchend", null, Blockly.longStop_), Blockly.bindEvent_(document, "touchcancel", null, Blockly.longStop_), goog.userAgent.IPAD && Blockly.bindEventWithChecks_(window,
        "orientationchange", document, function () {
...
Blockly.svgResize = function (a) {
    ...
    var b = a.getParentSvg(), c = b.parentNode;
    if (c) {
        var d = c.offsetWidth;
        c = c.offsetHeight;
...
Blockly.onKeyDown_ = function (a) {
    ...
    if (!(b.options.readOnly || Blockly.utils.isTargetInput(a) || b.rendered && !b.isVisible())) {
        ...
        if (27 == a.keyCode) Blockly.hideChaff(); else if (8 == a.keyCode || 46 == a.keyCode) {
            ...
            if (Blockly.Gesture.inProgress()) return;
            Blockly.selected && Blockly.selected.isDeletable() && Blockly.selected.isMovable() &&
            (67 == a.keyCode ? (Blockly.hideChaff(), Blockly.copy_(Blockly.selected)) : 88 != a.keyCode || Blockly.selected.workspace.isFlyout || (Blockly.copy_(Blockly.selected), c = !0));
            86 == a.keyCode ? Blockly.clipboardXml_ && (b = Blockly.clipboardSource_, b.isFlyout && (b = b.targetWorkspace), Blockly.clipboardTypeCounts_ && b.isCapacityAvailable(Blockly.clipboardTypeCounts_) && (Blockly.Events.setGroup(!0), b.paste(Blockly.clipboardXml_), Blockly.Events.setGroup(!1))) : 90 == a.keyCode && (Blockly.hideChaff(), b.undo(a.shiftKey))
        }
        c && !Blockly.selected.workspace.isFlyout &&
        (Blockly.Events.setGroup(!0), Blockly.hideChaff(), Blockly.selected.dispose(!0, !0), Blockly.Events.setGroup(!1))
    }
};
Blockly.copy_ = function (a) {
    if (a.isComment) var b = a.toXmlWithXY(); else {
        b = Blockly.Xml.blockToDom(a);
...
Blockly.bindEventWithChecks_ = function (a, b, c, d, e, f) {
    ...
    if (goog.global.PointerEvent && b in Blockly.Touch.TOUCH_MAP) for (var l = 0, n; n = Blockly.Touch.TOUCH_MAP[b][l]; l++) a.addEventListener(n, h, !1), k.push([a, n, h]); else if (a.addEventListener(b, h, !1), k.push([a, b, h]), b in Blockly.Touch.TOUCH_MAP) {
        var m = function (a) {
            h(a);
            var b = !f;
...
Blockly.bindEvent_ = function (a, b, c, d) {
    var e = function (a) {
        c ? d.call(c, a) : d(a)
    }, f = [], g = goog.global.window;
    if (g && g.PointerEvent && b in Blockly.Touch.TOUCH_MAP) {
        g = 0;
        for (var h; h = Blockly.Touch.TOUCH_MAP[b][g]; g++) a.addEventListener(h, e, !1), f.push([a, h, e])
...
Blockly.checkBlockColourConstants = function () {
    ...
    Blockly.checkBlockColourConstant_("VARIABLES_HUE",
...
Blockly.setTheme = function (a) {
    this.theme_ = a;
    (a = Blockly.getMainWorkspace()) && this.refreshTheme_(a)
};
Blockly.refreshTheme_ = function (a) {
    this.updateBlockStyles_(a.getAllBlocks().filter(function (a) {
        return void 0 !== a.getStyleName()
    }));
    !a.toolbox_ && a.flyout_ && a.flyout_.workspace_ ? this.updateBlockStyles_(a.flyout_.workspace_.getAllBlocks()) : a.refreshToolboxSelection();
